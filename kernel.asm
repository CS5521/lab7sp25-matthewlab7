...
8010003a:	c7 44 24 04 5c 85 10 	movl   $0x8010855c,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 1c 50 00 00       	call   8010506a <initlock>
...
80100087:	c7 44 24 04 63 85 10 	movl   $0x80108563,0x4(%esp)
8010008e:	80 
8010008f:	89 04 24             	mov    %eax,(%esp)
80100092:	e8 70 4e 00 00       	call   80104f07 <initsleeplock>
...
801000c9:	e8 bd 4f 00 00       	call   8010508b <acquire>
...
80100104:	e8 ea 4f 00 00       	call   801050f3 <release>
      acquiresleep(&b->lock);
80100109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010010c:	83 c0 0c             	add    $0xc,%eax
8010010f:	89 04 24             	mov    %eax,(%esp)
80100112:	e8 2a 4e 00 00       	call   80104f41 <acquiresleep>
      return b;
...
8010017d:	e8 71 4f 00 00       	call   801050f3 <release>
      acquiresleep(&b->lock);
80100182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100185:	83 c0 0c             	add    $0xc,%eax
80100188:	89 04 24             	mov    %eax,(%esp)
8010018b:	e8 b1 4d 00 00       	call   80104f41 <acquiresleep>
      return b;
...
801001a7:	c7 04 24 6a 85 10 80 	movl   $0x8010856a,(%esp)
...
801001fb:	e8 de 4d 00 00       	call   80104fde <holdingsleep>
80100200:	85 c0                	test   %eax,%eax
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 7b 85 10 80 	movl   $0x8010857b,(%esp)
...
8010023b:	e8 9e 4d 00 00       	call   80104fde <holdingsleep>
80100240:	85 c0                	test   %eax,%eax
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 82 85 10 80 	movl   $0x80108582,(%esp)
...
80100259:	e8 3e 4d 00 00       	call   80104f9c <releasesleep>

  acquire(&bcache.lock);
8010025e:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100265:	e8 21 4e 00 00       	call   8010508b <acquire>
  b->refcnt--;
...
801002d1:	e8 1d 4e 00 00       	call   801050f3 <release>
}
801002d6:	c9                   	leave  
801002d7:	c3                   	ret    
...
801003e3:	e8 a3 4c 00 00       	call   8010508b <acquire>
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 89 85 10 80 	movl   $0x80108589,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 92 85 10 80 	movl   $0x80108592,-0x14(%ebp)
      for(; *s; s++)
...
8010055b:	e8 93 4b 00 00       	call   801050f3 <release>
}
80100560:	c9                   	leave  
80100561:	c3                   	ret    
...
80100580:	c7 04 24 99 85 10 80 	movl   $0x80108599,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 ad 85 10 80 	movl   $0x801085ad,(%esp)
...
801005b0:	e8 89 4b 00 00       	call   8010513e <getcallerpcs>
  for(i=0; i<10; i++)
...
801005c9:	c7 04 24 af 85 10 80 	movl   $0x801085af,(%esp)
...
801006ba:	c7 04 24 b3 85 10 80 	movl   $0x801085b3,(%esp)
...
801006ee:	e8 d9 4c 00 00       	call   801053cc <memmove>
    pos -= 80;
...
8010071d:	e8 db 4b 00 00       	call   801052fd <memset>
  }
...
801007fd:	e8 89 48 00 00       	call   8010508b <acquire>
  while((c = getc()) >= 0){
...
80100938:	e8 4a 42 00 00       	call   80104b87 <wakeup>
        }
      }
      break;
...
80100959:	e8 95 47 00 00       	call   801050f3 <release>
  if(doprocdump) {
8010095e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80100962:	74 05                	je     80100969 <consoleintr+0x180>
    procdump();  // now call procdump() wo. cons.lock held
80100964:	e8 c4 42 00 00       	call   80104c2d <procdump>
  }
}
80100969:	c9                   	leave  
8010096a:	c3                   	ret    
...
80100989:	e8 fd 46 00 00       	call   8010508b <acquire>
  while(n > 0){
...
801009a8:	e8 46 47 00 00       	call   801050f3 <release>
        ilock(ip);
...
801009d1:	e8 da 40 00 00       	call   80104ab0 <sleep>
    while(input.r == input.w){
...
80100a4d:	e8 a1 46 00 00       	call   801050f3 <release>
  ilock(ip);
...
80100a81:	e8 05 46 00 00       	call   8010508b <acquire>
  for(i = 0; i < n; i++)
...
80100abb:	e8 33 46 00 00       	call   801050f3 <release>
  ilock(ip);
...
80100ad6:	c7 44 24 04 c6 85 10 	movl   $0x801085c6,0x4(%esp)
80100add:	80 
80100ade:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100ae5:	e8 80 45 00 00       	call   8010506a <initlock>
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 ce 85 10 80 	movl   $0x801085ce,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 e9 70 00 00       	call   80107ca4 <setupkvm>
...
80100c74:	e8 01 74 00 00       	call   8010807a <allocuvm>
...
80100cc6:	e8 cc 72 00 00       	call   80107f97 <loaduvm>
...
80100d34:	e8 41 73 00 00       	call   8010807a <allocuvm>
...
80100d59:	e8 8f 75 00 00       	call   801082ed <clearpteu>
  sp = sz;
...
80100d8f:	e8 d3 47 00 00       	call   80105567 <strlen>
...
80100db8:	e8 aa 47 00 00       	call   80105567 <strlen>
...
80100de8:	e8 c3 76 00 00       	call   801084b0 <copyout>
...
80100e8f:	e8 1c 76 00 00       	call   801084b0 <copyout>
...
80100ee4:	e8 34 46 00 00       	call   8010551d <safestrcpy>
...
80100f24:	e8 55 6e 00 00       	call   80107d7e <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 22 73 00 00       	call   80108256 <freevm>
  return 0;
...
80100f47:	e8 0a 73 00 00       	call   80108256 <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 da 85 10 	movl   $0x801085da,0x4(%esp)
80100f76:	80 
80100f77:	c7 04 24 60 10 11 80 	movl   $0x80111060,(%esp)
80100f7e:	e8 e7 40 00 00       	call   8010506a <initlock>
}
80100f83:	c9                   	leave  
80100f84:	c3                   	ret    
...
80100f92:	e8 f4 40 00 00       	call   8010508b <acquire>
...
80100fbb:	e8 33 41 00 00       	call   801050f3 <release>
      return f;
...
80100fd9:	e8 15 41 00 00       	call   801050f3 <release>
  return 0;
...
80100ff2:	e8 94 40 00 00       	call   8010508b <acquire>
  if(f->ref < 1)
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 e1 85 10 80 	movl   $0x801085e1,(%esp)
...
80101023:	e8 cb 40 00 00       	call   801050f3 <release>
  return f;
...
8010103a:	e8 4c 40 00 00       	call   8010508b <acquire>
  if(f->ref < 1)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 e9 85 10 80 	movl   $0x801085e9,(%esp)
...
80101075:	e8 79 40 00 00       	call   801050f3 <release>
...
801010bf:	e8 2f 40 00 00       	call   801050f3 <release>
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 f3 85 10 80 	movl   $0x801085f3,(%esp)
...
8010130c:	c7 04 24 fc 85 10 80 	movl   $0x801085fc,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 0c 86 10 80 	movl   $0x8010860c,(%esp)
...
80101384:	e8 43 40 00 00       	call   801053cc <memmove>
  brelse(bp);
...
801013ca:	e8 2e 3f 00 00       	call   801052fd <memset>
  log_write(bp);
...
80101517:	c7 04 24 18 86 10 80 	movl   $0x80108618,(%esp)
...
801015a6:	c7 04 24 2e 86 10 80 	movl   $0x8010862e,(%esp)
...
80101600:	c7 44 24 04 41 86 10 	movl   $0x80108641,0x4(%esp)
80101607:	80 
80101608:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
8010160f:	e8 56 3a 00 00       	call   8010506a <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101635:	c7 44 24 04 48 86 10 	movl   $0x80108648,0x4(%esp)
8010163c:	80 
8010163d:	89 04 24             	mov    %eax,(%esp)
80101640:	e8 c2 38 00 00       	call   80104f07 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801016af:	c7 04 24 50 86 10 80 	movl   $0x80108650,(%esp)
...
80101732:	e8 c6 3b 00 00       	call   801052fd <memset>
      dip->type = type;
...
8010178a:	c7 04 24 a3 86 10 80 	movl   $0x801086a3,(%esp)
...
80101839:	e8 8e 3b 00 00       	call   801053cc <memmove>
  log_write(bp);
...
80101863:	e8 23 38 00 00       	call   8010508b <acquire>
...
801018ad:	e8 41 38 00 00       	call   801050f3 <release>
      return ip;
...
801018e3:	c7 04 24 b5 86 10 80 	movl   $0x801086b5,(%esp)
...
80101921:	e8 cd 37 00 00       	call   801050f3 <release>
...
80101938:	e8 4e 37 00 00       	call   8010508b <acquire>
  ip->ref++;
...
80101953:	e8 9b 37 00 00       	call   801050f3 <release>
  return ip;
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 c5 86 10 80 	movl   $0x801086c5,(%esp)
...
80101988:	e8 b4 35 00 00       	call   80104f41 <acquiresleep>
...
80101a36:	e8 91 39 00 00       	call   801053cc <memmove>
    brelse(bp);
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 cb 86 10 80 	movl   $0x801086cb,(%esp)
...
80101a7f:	e8 5a 35 00 00       	call   80104fde <holdingsleep>
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 da 86 10 80 	movl   $0x801086da,(%esp)
...
80101aa7:	e8 f0 34 00 00       	call   80104f9c <releasesleep>
}
80101aac:	c9                   	leave  
80101aad:	c3                   	ret    
...
80101abd:	e8 7f 34 00 00       	call   80104f41 <acquiresleep>
...
80101adf:	e8 a7 35 00 00       	call   8010508b <acquire>
    int r = ip->ref;
...
80101af4:	e8 fa 35 00 00       	call   801050f3 <release>
    if(r == 1){
...
80101b31:	e8 66 34 00 00       	call   80104f9c <releasesleep>

  acquire(&icache.lock);
80101b36:	c7 04 24 80 1a 11 80 	movl   $0x80111a80,(%esp)
80101b3d:	e8 49 35 00 00       	call   8010508b <acquire>
  ip->ref--;
...
80101b58:	e8 96 35 00 00       	call   801050f3 <release>
}
80101b5d:	c9                   	leave  
80101b5e:	c3                   	ret    
...
80101c7e:	c7 04 24 e2 86 10 80 	movl   $0x801086e2,(%esp)
...
80101f2b:	e8 9c 34 00 00       	call   801053cc <memmove>
    brelse(bp);
...
8010208a:	e8 3d 33 00 00       	call   801053cc <memmove>
    log_write(bp);
...
80102108:	e8 62 33 00 00       	call   8010546f <strncmp>
}
8010210d:	c9                   	leave  
8010210e:	c3                   	ret    
...
80102122:	c7 04 24 f5 86 10 80 	movl   $0x801086f5,(%esp)
...
80102160:	c7 04 24 07 87 10 80 	movl   $0x80108707,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 16 87 10 80 	movl   $0x80108716,(%esp)
...
8010228a:	e8 36 32 00 00       	call   801054c5 <strncpy>
  de.inum = inum;
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 23 87 10 80 	movl   $0x80108723,(%esp)
...
80102341:	e8 86 30 00 00       	call   801053cc <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010235c:	e8 6b 30 00 00       	call   801053cc <memmove>
    name[len] = 0;
...
801025aa:	c7 44 24 04 2b 87 10 	movl   $0x8010872b,0x4(%esp)
801025b1:	80 
801025b2:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
801025b9:	e8 ac 2a 00 00       	call   8010506a <initlock>
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 2f 87 10 80 	movl   $0x8010872f,(%esp)
...
80102663:	c7 04 24 38 87 10 80 	movl   $0x80108738,(%esp)
...
801026b5:	c7 04 24 2f 87 10 80 	movl   $0x8010872f,(%esp)
...
801027d5:	e8 b1 28 00 00       	call   8010508b <acquire>
...
801027ef:	e8 ff 28 00 00       	call   801050f3 <release>
    return;
...
80102862:	e8 20 23 00 00       	call   80104b87 <wakeup>
...
80102884:	e8 6a 28 00 00       	call   801050f3 <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
...
8010289a:	e8 3f 27 00 00       	call   80104fde <holdingsleep>
8010289f:	85 c0                	test   %eax,%eax
801028a1:	75 0c                	jne    801028af <iderw+0x24>
    panic("iderw: buf not locked");
801028a3:	c7 04 24 4a 87 10 80 	movl   $0x8010874a,(%esp)
...
801028bc:	c7 04 24 60 87 10 80 	movl   $0x80108760,(%esp)
...
80102949:	e8 62 21 00 00       	call   80104ab0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102962:	e8 8c 27 00 00       	call   801050f3 <release>
}
80102967:	c9                   	leave  
80102968:	c3                   	ret    
...
801029e2:	c7 04 24 94 87 10 80 	movl   $0x80108794,(%esp)
...
80102a84:	c7 44 24 04 c6 87 10 	movl   $0x801087c6,0x4(%esp)
80102a8b:	80 
80102a8c:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80102a93:	e8 d2 25 00 00       	call   8010506a <initlock>
  kmem.use_lock = 0;
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 cb 87 10 80 	movl   $0x801087cb,(%esp)
...
80102b5f:	e8 99 27 00 00       	call   801052fd <memset>
...
80102b74:	e8 12 25 00 00       	call   8010508b <acquire>
  r = (struct run*)v;
...
80102ba2:	e8 4c 25 00 00       	call   801050f3 <release>
}
80102ba7:	c9                   	leave  
80102ba8:	c3                   	ret    
...
80102bbf:	e8 c7 24 00 00       	call   8010508b <acquire>
  r = kmem.freelist;
...
80102bec:	e8 02 25 00 00       	call   801050f3 <release>
  return (char*)r;
...
80103189:	e8 e6 21 00 00       	call   80105374 <memcmp>
...
80103289:	c7 44 24 04 d1 87 10 	movl   $0x801087d1,0x4(%esp)
80103290:	80 
80103291:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103298:	e8 cd 1d 00 00       	call   8010506a <initlock>
  readsb(dev, &sb);
...
80103342:	e8 85 20 00 00       	call   801053cc <memmove>
...
80103494:	e8 f2 1b 00 00       	call   8010508b <acquire>
  while(1){
    if(log.committing){
...
801034b1:	e8 fa 15 00 00       	call   80104ab0 <sleep>
...
801034e5:	e8 c6 15 00 00       	call   80104ab0 <sleep>
...
80103500:	e8 ee 1b 00 00       	call   801050f3 <release>
      break;
...
8010351f:	e8 67 1b 00 00       	call   8010508b <acquire>
  log.outstanding -= 1;
...
8010353a:	c7 04 24 d5 87 10 80 	movl   $0x801087d5,(%esp)
...
80103569:	e8 19 16 00 00       	call   80104b87 <wakeup>
  }
  release(&log.lock);
8010356e:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103575:	e8 79 1b 00 00       	call   801050f3 <release>
...
80103629:	e8 9e 1d 00 00       	call   801053cc <memmove>
...
801036b4:	c7 04 24 e4 87 10 80 	movl   $0x801087e4,(%esp)
...
801036c9:	c7 04 24 fa 87 10 80 	movl   $0x801087fa,(%esp)
801036d0:	e8 8d ce ff ff       	call   80100562 <panic>

  acquire(&log.lock);
801036d5:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
801036dc:	e8 aa 19 00 00       	call   8010508b <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103753:	e8 9b 19 00 00       	call   801050f3 <release>
}
80103758:	c9                   	leave  
80103759:	c3                   	ret    
...
801037b4:	e8 ea 33 00 00       	call   80106ba3 <uartinit>
  pinit();         // process table
801037b9:	e8 14 09 00 00       	call   801040d2 <pinit>
  tvinit();        // trap vectors
801037be:	e8 a9 2f 00 00       	call   8010676c <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 64 45 00 00       	call   80107d64 <switchkvm>
  seginit();
80103800:	e8 14 40 00 00       	call   80107819 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 15 88 10 80 	movl   $0x80108815,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 a5 30 00 00       	call   801068e0 <idtinit>
...
80103855:	e8 f4 0f 00 00       	call   8010484e <scheduler>
...
8010387e:	e8 49 1b 00 00       	call   801053cc <memmove>
...
801039bb:	00 
801039bc:	c7 44 24 04 2c 88 10 	movl   $0x8010882c,0x4(%esp)
801039c3:	80 
801039c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039c7:	89 04 24             	mov    %eax,(%esp)
801039ca:	e8 a5 19 00 00       	call   80105374 <memcmp>
...
80103af9:	00 
80103afa:	c7 44 24 04 31 88 10 	movl   $0x80108831,0x4(%esp)
80103b01:	80 
80103b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b05:	89 04 24             	mov    %eax,(%esp)
80103b08:	e8 67 18 00 00       	call   80105374 <memcmp>
...
80103b80:	c7 04 24 36 88 10 80 	movl   $0x80108836,(%esp)
...
80103bc9:	8b 04 85 70 88 10 80 	mov    -0x7fef7790(,%eax,4),%eax
...
80103c48:	c7 04 24 50 88 10 80 	movl   $0x80108850,(%esp)
...
80103d7d:	c7 44 24 04 84 88 10 	movl   $0x80108884,0x4(%esp)
80103d84:	80 
80103d85:	89 04 24             	mov    %eax,(%esp)
80103d88:	e8 dd 12 00 00       	call   8010506a <initlock>
  (*f0)->type = FD_PIPE;
...
80103e34:	e8 52 12 00 00       	call   8010508b <acquire>
  if(writable){
...
80103e57:	e8 2b 0d 00 00       	call   80104b87 <wakeup>
...
80103e76:	e8 0c 0d 00 00       	call   80104b87 <wakeup>
  }
...
80103e9b:	e8 53 12 00 00       	call   801050f3 <release>
    kfree((char*)p);
...
80103eb3:	e8 3b 12 00 00       	call   801050f3 <release>
}
80103eb8:	c9                   	leave  
80103eb9:	c3                   	ret    
...
80103ec6:	e8 c0 11 00 00       	call   8010508b <acquire>
  for(i = 0; i < n; i++){
...
80103ef8:	e8 f6 11 00 00       	call   801050f3 <release>
        return -1;
...
80103f12:	e8 70 0c 00 00       	call   80104b87 <wakeup>
...
80103f2a:	e8 81 0b 00 00       	call   80104ab0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103f93:	e8 ef 0b 00 00       	call   80104b87 <wakeup>
  release(&p->lock);
80103f98:	8b 45 08             	mov    0x8(%ebp),%eax
80103f9b:	89 04 24             	mov    %eax,(%esp)
80103f9e:	e8 50 11 00 00       	call   801050f3 <release>
  return n;
...
80103fb5:	e8 d1 10 00 00       	call   8010508b <acquire>
...
80103fce:	e8 20 11 00 00       	call   801050f3 <release>
      return -1;
...
80103ff0:	e8 bb 0a 00 00       	call   80104ab0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010407f:	e8 03 0b 00 00       	call   80104b87 <wakeup>
  release(&p->lock);
80104084:	8b 45 08             	mov    0x8(%ebp),%eax
80104087:	89 04 24             	mov    %eax,(%esp)
8010408a:	e8 64 10 00 00       	call   801050f3 <release>
  return i;
...
801040d8:	c7 44 24 04 8c 88 10 	movl   $0x8010888c,0x4(%esp)
801040df:	80 
801040e0:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801040e7:	e8 7e 0f 00 00       	call   8010506a <initlock>
}
801040ec:	c9                   	leave  
801040ed:	c3                   	ret    
...
80104123:	c7 04 24 94 88 10 80 	movl   $0x80108894,(%esp)
...
80104177:	c7 04 24 ba 88 10 80 	movl   $0x801088ba,(%esp)
...
80104188:	83 ec 18             	sub    $0x18,%esp
  ...
  struct proc *p;
  pushcli();
8010418b:	e8 68 10 00 00       	call   801051f8 <pushcli>
  c = mycpu();
...
801041a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  popcli();
801041a4:	e8 9b 10 00 00       	call   80105244 <popcli>
  return p;
...
801041bb:	e8 cb 0e 00 00       	call   8010508b <acquire>
...
801041f9:	e8 f5 0e 00 00       	call   801050f3 <release>
...
8010422c:	e8 c2 0e 00 00       	call   801050f3 <release>
  return 0;
...
80104268:	ba 27 67 10 80       	mov    $0x80106727,%edx
...
80104298:	e8 60 10 00 00       	call   801052fd <memset>
  p->context->eip = (uint)forkret;
8010429d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042a0:	8b 40 1c             	mov    0x1c(%eax),%eax
801042a3:	ba 71 4a 10 80       	mov    $0x80104a71,%edx
...
801042c6:	e8 d9 39 00 00       	call   80107ca4 <setupkvm>
...
801042db:	c7 04 24 ca 88 10 80 	movl   $0x801088ca,(%esp)
...
80104301:	e8 09 3c 00 00       	call   80107f0f <inituvm>
  p->sz = PGSIZE;
...
80104328:	e8 d0 0f 00 00       	call   801052fd <memset>
...
801043a1:	00 
801043a2:	c7 44 24 04 e3 88 10 	movl   $0x801088e3,0x4(%esp)
801043a9:	80 
801043aa:	89 04 24             	mov    %eax,(%esp)
801043ad:	e8 6b 11 00 00       	call   8010551d <safestrcpy>
  p->cwd = namei("/");
801043b2:	c7 04 24 ec 88 10 80 	movl   $0x801088ec,(%esp)
...
801043e2:	e8 a4 0c 00 00       	call   8010508b <acquire>
...
801043f8:	e8 f6 0c 00 00       	call   801050f3 <release>
}
801043fd:	c9                   	leave  
801043fe:	c3                   	ret    
...
80104437:	e8 3e 3c 00 00       	call   8010807a <allocuvm>
...
8010446e:	e8 1d 3d 00 00       	call   80108190 <deallocuvm>
...
80104491:	e8 e8 38 00 00       	call   80107d7e <switchuvm>
  return 0;
...
801044c1:	e9 64 01 00 00       	jmp    8010462a <fork+0x18d>
  }
...
801044d8:	e8 56 3e 00 00       	call   80108333 <copyuvm>
...
80104514:	e9 11 01 00 00       	jmp    8010462a <fork+0x18d>
  }
  np->sz = curproc->sz;
...
801045c9:	e8 4f 0f 00 00       	call   8010551d <safestrcpy>
...
801045e7:	c7 40 7c 0a 00 00 00 	movl   $0xa,0x7c(%eax)
  if (curproc->tickets > 10) {
801045ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045f1:	8b 40 7c             	mov    0x7c(%eax),%eax
801045f4:	83 f8 0a             	cmp    $0xa,%eax
801045f7:	7e 0c                	jle    80104605 <fork+0x168>
    np->tickets = curproc->tickets;
801045f9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045fc:	8b 50 7c             	mov    0x7c(%eax),%edx
801045ff:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104602:	89 50 7c             	mov    %edx,0x7c(%eax)
  }

  acquire(&ptable.lock);
80104605:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
8010460c:	e8 7a 0a 00 00       	call   8010508b <acquire>
...
80104614:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
8010461b:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104622:	e8 cc 0a 00 00       	call   801050f3 <release>

  return pid;
80104627:	8b 45 d8             	mov    -0x28(%ebp),%eax
}
...
80104635:	83 ec 28             	sub    $0x28,%esp
  struct proc *curproc = myproc();
80104638:	e8 48 fb ff ff       	call   80104185 <myproc>
8010463d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  struct proc *p;
  int fd;

  if(curproc == initproc)
80104640:	a1 40 b6 10 80       	mov    0x8010b640,%eax
80104645:	39 45 ec             	cmp    %eax,-0x14(%ebp)
80104648:	75 0c                	jne    80104656 <exit+0x24>
    panic("init exiting");
8010464a:	c7 04 24 ee 88 10 80 	movl   $0x801088ee,(%esp)
80104651:	e8 0c bf ff ff       	call   80100562 <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104656:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010465d:	eb 3b                	jmp    8010469a <exit+0x68>
    if(curproc->ofile[fd]){
8010465f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104662:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104665:	83 c2 08             	add    $0x8,%edx
80104668:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010466c:	85 c0                	test   %eax,%eax
8010466e:	74 26                	je     80104696 <exit+0x64>
...
80104680:	e8 a8 c9 ff ff       	call   8010102d <fileclose>
      curproc->ofile[fd] = 0;
80104685:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104688:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010468b:	83 c2 08             	add    $0x8,%edx
8010468e:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104695:	00 
  for(fd = 0; fd < NOFILE; fd++){
80104696:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
8010469a:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
8010469e:	7e bf                	jle    8010465f <exit+0x2d>
    }
  }

  begin_op();
801046a0:	e8 e2 ed ff ff       	call   80103487 <begin_op>
  iput(curproc->cwd);
801046a5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801046a8:	8b 40 68             	mov    0x68(%eax),%eax
801046ab:	89 04 24             	mov    %eax,(%esp)
801046ae:	e8 fb d3 ff ff       	call   80101aae <iput>
  end_op();
801046b3:	e8 53 ee ff ff       	call   8010350b <end_op>
  curproc->cwd = 0;
801046b8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801046bb:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801046c2:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801046c9:	e8 bd 09 00 00       	call   8010508b <acquire>

  // Parent might be sleeping in wait().
  wakeup1(curproc->parent);
801046ce:	8b 45 ec             	mov    -0x14(%ebp),%eax
801046d1:	8b 40 14             	mov    0x14(%eax),%eax
801046d4:	89 04 24             	mov    %eax,(%esp)
801046d7:	e8 6a 04 00 00       	call   80104b46 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046dc:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
801046e3:	eb 36                	jmp    8010471b <exit+0xe9>
    if(p->parent == curproc){
801046e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046e8:	8b 40 14             	mov    0x14(%eax),%eax
801046eb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
801046ee:	75 24                	jne    80104714 <exit+0xe2>
      p->parent = initproc;
801046f0:	8b 15 40 b6 10 80    	mov    0x8010b640,%edx
...
80104705:	75 0d                	jne    80104714 <exit+0xe2>
        wakeup1(initproc);
80104707:	a1 40 b6 10 80       	mov    0x8010b640,%eax
8010470c:	89 04 24             	mov    %eax,(%esp)
8010470f:	e8 32 04 00 00       	call   80104b46 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104714:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010471b:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
80104722:	72 c1                	jb     801046e5 <exit+0xb3>
    }
  }
...
80104727:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010472e:	e8 5e 02 00 00       	call   80104991 <sched>
  panic("zombie exit");
80104733:	c7 04 24 fb 88 10 80 	movl   $0x801088fb,(%esp)
8010473a:	e8 23 be ff ff       	call   80100562 <panic>
...
80104742:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
80104745:	e8 3b fa ff ff       	call   80104185 <myproc>
8010474a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  
  acquire(&ptable.lock);
8010474d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104754:	e8 32 09 00 00       	call   8010508b <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80104759:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104760:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104767:	e9 98 00 00 00       	jmp    80104804 <wait+0xc5>
      if(p->parent != curproc)
8010476c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010476f:	8b 40 14             	mov    0x14(%eax),%eax
80104772:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80104775:	74 05                	je     8010477c <wait+0x3d>
        continue;
80104777:	e9 81 00 00 00       	jmp    801047fd <wait+0xbe>
      havekids = 1;
8010477c:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104783:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104786:	8b 40 0c             	mov    0xc(%eax),%eax
80104789:	83 f8 05             	cmp    $0x5,%eax
8010478c:	75 6f                	jne    801047fd <wait+0xbe>
        // Found one.
        pid = p->pid;
8010478e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104791:	8b 40 10             	mov    0x10(%eax),%eax
80104794:	89 45 e8             	mov    %eax,-0x18(%ebp)
        kfree(p->kstack);
80104797:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010479a:	8b 40 08             	mov    0x8(%eax),%eax
8010479d:	89 04 24             	mov    %eax,(%esp)
801047a0:	e8 6e e3 ff ff       	call   80102b13 <kfree>
        p->kstack = 0;
801047a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047a8:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
801047af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047b2:	8b 40 04             	mov    0x4(%eax),%eax
801047b5:	89 04 24             	mov    %eax,(%esp)
801047b8:	e8 99 3a 00 00       	call   80108256 <freevm>
        p->pid = 0;
801047bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047c0:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801047c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047ca:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801047d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047d4:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
801047d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047db:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        p->state = UNUSED;
801047e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047e5:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        release(&ptable.lock);
801047ec:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801047f3:	e8 fb 08 00 00       	call   801050f3 <release>
        return pid;
801047f8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801047fb:	eb 4f                	jmp    8010484c <wait+0x10d>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047fd:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104804:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
8010480b:	0f 82 5b ff ff ff    	jb     8010476c <wait+0x2d>
      }
    }
...
80104815:	74 0a                	je     80104821 <wait+0xe2>
80104817:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010481a:	8b 40 24             	mov    0x24(%eax),%eax
8010481d:	85 c0                	test   %eax,%eax
8010481f:	74 13                	je     80104834 <wait+0xf5>
      release(&ptable.lock);
80104821:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104828:	e8 c6 08 00 00       	call   801050f3 <release>
      return -1;
8010482d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104832:	eb 18                	jmp    8010484c <wait+0x10d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104834:	c7 44 24 04 c0 3d 11 	movl   $0x80113dc0,0x4(%esp)
8010483b:	80 
8010483c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010483f:	89 04 24             	mov    %eax,(%esp)
80104842:	e8 69 02 00 00       	call   80104ab0 <sleep>
  }
80104847:	e9 0d ff ff ff       	jmp    80104759 <wait+0x1a>
}
8010484c:	c9                   	leave  
8010484d:	c3                   	ret    
...
80104851:	83 ec 38             	sub    $0x38,%esp
  struct proc *p;
  struct cpu *c = mycpu();
80104854:	e8 b6 f8 ff ff       	call   8010410f <mycpu>
80104859:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  c->proc = 0;
...
80104866:	00 00 00 
  ...
  for(;;){
    ...
    sti();
80104869:	e8 3a f8 ff ff       	call   801040a8 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
8010486e:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104875:	e8 11 08 00 00       	call   8010508b <acquire>
    int totalTickets = 0;
8010487a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104881:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104888:	eb 1b                	jmp    801048a5 <scheduler+0x57>
      if(p->state == RUNNABLE)
8010488a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010488d:	8b 40 0c             	mov    0xc(%eax),%eax
80104890:	83 f8 03             	cmp    $0x3,%eax
80104893:	75 09                	jne    8010489e <scheduler+0x50>
      {
        totalTickets += p->tickets;
80104895:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104898:	8b 40 7c             	mov    0x7c(%eax),%eax
8010489b:	01 45 f0             	add    %eax,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010489e:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
801048a5:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
801048ac:	72 dc                	jb     8010488a <scheduler+0x3c>
      }
      
    }

    if(totalTickets == 0)
801048ae:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801048b2:	75 0f                	jne    801048c3 <scheduler+0x75>
    {
      release(&ptable.lock);
801048b4:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801048bb:	e8 33 08 00 00       	call   801050f3 <release>
      continue;
801048c0:	90                   	nop
...
801048c1:	eb a6                	jmp    80104869 <scheduler+0x1b>
    int winner = random() % totalTickets;
801048c3:	e8 e6 f7 ff ff       	call   801040ae <random>
801048c8:	99                   	cltd   
801048c9:	f7 7d f0             	idivl  -0x10(%ebp)
801048cc:	89 55 e0             	mov    %edx,-0x20(%ebp)
    int ticket_count = 0;
801048cf:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    struct proc *winner_proc = 0;
801048d6:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801048dd:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
801048e4:	eb 2b                	jmp    80104911 <scheduler+0xc3>
      if (p->state == RUNNABLE)
801048e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048e9:	8b 40 0c             	mov    0xc(%eax),%eax
801048ec:	83 f8 03             	cmp    $0x3,%eax
801048ef:	75 09                	jne    801048fa <scheduler+0xac>
...
801048fd:	3b 45 e0             	cmp    -0x20(%ebp),%eax
80104900:	7c 08                	jl     8010490a <scheduler+0xbc>
        winner_proc = p;
80104902:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104905:	89 45 e8             	mov    %eax,-0x18(%ebp)
        break;
80104908:	eb 10                	jmp    8010491a <scheduler+0xcc>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010490a:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104911:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
80104918:	72 cc                	jb     801048e6 <scheduler+0x98>
    if (winner_proc)
8010491a:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010491e:	74 60                	je     80104980 <scheduler+0x132>
      c->proc = winner_proc;
80104920:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104923:	8b 55 e8             	mov    -0x18(%ebp),%edx
80104926:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
      switchuvm(winner_proc);
8010492c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010492f:	89 04 24             	mov    %eax,(%esp)
80104932:	e8 47 34 00 00       	call   80107d7e <switchuvm>
      winner_proc->state = RUNNING;
80104937:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010493a:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      winner_proc->ticks++;
80104941:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104944:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010494a:	8d 50 01             	lea    0x1(%eax),%edx
8010494d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104950:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
      swtch(&(c->scheduler), winner_proc->context);
80104956:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104959:	8b 40 1c             	mov    0x1c(%eax),%eax
8010495c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010495f:	83 c2 04             	add    $0x4,%edx
80104962:	89 44 24 04          	mov    %eax,0x4(%esp)
80104966:	89 14 24             	mov    %edx,(%esp)
80104969:	e8 20 0c 00 00       	call   8010558e <swtch>
      switchkvm();
8010496e:	e8 f1 33 00 00       	call   80107d64 <switchkvm>
      c->proc = 0;
80104973:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104976:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010497d:	00 00 00 
    release(&ptable.lock);
80104980:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104987:	e8 67 07 00 00       	call   801050f3 <release>
  }
8010498c:	e9 d8 fe ff ff       	jmp    80104869 <scheduler+0x1b>
...
80104994:	83 ec 28             	sub    $0x28,%esp
  int intena;
  struct proc *p = myproc();
80104997:	e8 e9 f7 ff ff       	call   80104185 <myproc>
8010499c:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(!holding(&ptable.lock))
8010499f:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801049a6:	e8 0c 08 00 00       	call   801051b7 <holding>
801049ab:	85 c0                	test   %eax,%eax
801049ad:	75 0c                	jne    801049bb <sched+0x2a>
    panic("sched ptable.lock");
801049af:	c7 04 24 07 89 10 80 	movl   $0x80108907,(%esp)
801049b6:	e8 a7 bb ff ff       	call   80100562 <panic>
  if(mycpu()->ncli != 1)
801049bb:	e8 4f f7 ff ff       	call   8010410f <mycpu>
801049c0:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801049c6:	83 f8 01             	cmp    $0x1,%eax
801049c9:	74 0c                	je     801049d7 <sched+0x46>
    panic("sched locks");
801049cb:	c7 04 24 19 89 10 80 	movl   $0x80108919,(%esp)
801049d2:	e8 8b bb ff ff       	call   80100562 <panic>
  if(p->state == RUNNING)
801049d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049da:	8b 40 0c             	mov    0xc(%eax),%eax
801049dd:	83 f8 04             	cmp    $0x4,%eax
801049e0:	75 0c                	jne    801049ee <sched+0x5d>
    panic("sched running");
801049e2:	c7 04 24 25 89 10 80 	movl   $0x80108925,(%esp)
801049e9:	e8 74 bb ff ff       	call   80100562 <panic>
  if(readeflags()&FL_IF)
801049ee:	e8 a5 f6 ff ff       	call   80104098 <readeflags>
801049f3:	25 00 02 00 00       	and    $0x200,%eax
801049f8:	85 c0                	test   %eax,%eax
801049fa:	74 0c                	je     80104a08 <sched+0x77>
    panic("sched interruptible");
801049fc:	c7 04 24 33 89 10 80 	movl   $0x80108933,(%esp)
80104a03:	e8 5a bb ff ff       	call   80100562 <panic>
  intena = mycpu()->intena;
80104a08:	e8 02 f7 ff ff       	call   8010410f <mycpu>
80104a0d:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80104a13:	89 45 f0             	mov    %eax,-0x10(%ebp)
  swtch(&p->context, mycpu()->scheduler);
80104a16:	e8 f4 f6 ff ff       	call   8010410f <mycpu>
80104a1b:	8b 40 04             	mov    0x4(%eax),%eax
...
80104a2b:	e8 5e 0b 00 00       	call   8010558e <swtch>
  mycpu()->intena = intena;
80104a30:	e8 da f6 ff ff       	call   8010410f <mycpu>
80104a35:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a38:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
}
80104a3e:	c9                   	leave  
80104a3f:	c3                   	ret    
...
80104a46:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a4d:	e8 39 06 00 00       	call   8010508b <acquire>
  myproc()->state = RUNNABLE;
80104a52:	e8 2e f7 ff ff       	call   80104185 <myproc>
80104a57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a5e:	e8 2e ff ff ff       	call   80104991 <sched>
  release(&ptable.lock);
80104a63:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a6a:	e8 84 06 00 00       	call   801050f3 <release>
}
80104a6f:	c9                   	leave  
80104a70:	c3                   	ret    
...
80104a74:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a77:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104a7e:	e8 70 06 00 00       	call   801050f3 <release>

  if (first) {
80104a83:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104a88:	85 c0                	test   %eax,%eax
80104a8a:	74 22                	je     80104aae <forkret+0x3d>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot
    // be run from main().
    first = 0;
80104a8c:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104a93:	00 00 00 
    iinit(ROOTDEV);
80104a96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104a9d:	e8 4e cb ff ff       	call   801015f0 <iinit>
    initlog(ROOTDEV);
80104aa2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104aa9:	e8 d5 e7 ff ff       	call   80103283 <initlog>
  }
...
80104ab3:	83 ec 28             	sub    $0x28,%esp
  struct proc *p = myproc();
80104ab6:	e8 ca f6 ff ff       	call   80104185 <myproc>
80104abb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  if(p == 0)
80104abe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104ac2:	75 0c                	jne    80104ad0 <sleep+0x20>
    panic("sleep");
80104ac4:	c7 04 24 47 89 10 80 	movl   $0x80108947,(%esp)
80104acb:	e8 92 ba ff ff       	call   80100562 <panic>

  if(lk == 0)
80104ad0:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104ad4:	75 0c                	jne    80104ae2 <sleep+0x32>
    panic("sleep without lk");
80104ad6:	c7 04 24 4d 89 10 80 	movl   $0x8010894d,(%esp)
80104add:	e8 80 ba ff ff       	call   80100562 <panic>
...
80104ae2:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
80104ae9:	74 17                	je     80104b02 <sleep+0x52>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104aeb:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104af2:	e8 94 05 00 00       	call   8010508b <acquire>
    release(lk);
80104af7:	8b 45 0c             	mov    0xc(%ebp),%eax
80104afa:	89 04 24             	mov    %eax,(%esp)
80104afd:	e8 f1 05 00 00       	call   801050f3 <release>
  }
  // Go to sleep.
  p->chan = chan;
80104b02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b05:	8b 55 08             	mov    0x8(%ebp),%edx
80104b08:	89 50 20             	mov    %edx,0x20(%eax)
  p->state = SLEEPING;
80104b0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b0e:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)

  sched();
80104b15:	e8 77 fe ff ff       	call   80104991 <sched>
...
80104b24:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
80104b2b:	74 17                	je     80104b44 <sleep+0x94>
    release(&ptable.lock);
80104b2d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104b34:	e8 ba 05 00 00       	call   801050f3 <release>
    acquire(lk);
80104b39:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b3c:	89 04 24             	mov    %eax,(%esp)
80104b3f:	e8 47 05 00 00       	call   8010508b <acquire>
  }
}
80104b44:	c9                   	leave  
80104b45:	c3                   	ret    
...
80104b49:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b4c:	c7 45 fc f4 3d 11 80 	movl   $0x80113df4,-0x4(%ebp)
80104b53:	eb 27                	jmp    80104b7c <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104b55:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b58:	8b 40 0c             	mov    0xc(%eax),%eax
80104b5b:	83 f8 02             	cmp    $0x2,%eax
80104b5e:	75 15                	jne    80104b75 <wakeup1+0x2f>
80104b60:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b63:	8b 40 20             	mov    0x20(%eax),%eax
80104b66:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b69:	75 0a                	jne    80104b75 <wakeup1+0x2f>
      p->state = RUNNABLE;
80104b6b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b6e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b75:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
80104b7c:	81 7d fc f4 5e 11 80 	cmpl   $0x80115ef4,-0x4(%ebp)
80104b83:	72 d0                	jb     80104b55 <wakeup1+0xf>
}
80104b85:	c9                   	leave  
80104b86:	c3                   	ret    
...
80104b8a:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b8d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104b94:	e8 f2 04 00 00       	call   8010508b <acquire>
  wakeup1(chan);
80104b99:	8b 45 08             	mov    0x8(%ebp),%eax
80104b9c:	89 04 24             	mov    %eax,(%esp)
80104b9f:	e8 a2 ff ff ff       	call   80104b46 <wakeup1>
  release(&ptable.lock);
80104ba4:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104bab:	e8 43 05 00 00       	call   801050f3 <release>
}
80104bb0:	c9                   	leave  
80104bb1:	c3                   	ret    
...
80104bb5:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104bb8:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104bbf:	e8 c7 04 00 00       	call   8010508b <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bc4:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
80104bcb:	eb 44                	jmp    80104c11 <kill+0x5f>
    if(p->pid == pid){
80104bcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bd0:	8b 40 10             	mov    0x10(%eax),%eax
80104bd3:	3b 45 08             	cmp    0x8(%ebp),%eax
80104bd6:	75 32                	jne    80104c0a <kill+0x58>
      p->killed = 1;
80104bd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bdb:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104be2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104be5:	8b 40 0c             	mov    0xc(%eax),%eax
80104be8:	83 f8 02             	cmp    $0x2,%eax
80104beb:	75 0a                	jne    80104bf7 <kill+0x45>
        p->state = RUNNABLE;
80104bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bf0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104bf7:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104bfe:	e8 f0 04 00 00       	call   801050f3 <release>
      return 0;
80104c03:	b8 00 00 00 00       	mov    $0x0,%eax
80104c08:	eb 21                	jmp    80104c2b <kill+0x79>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c0a:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104c11:	81 7d f4 f4 5e 11 80 	cmpl   $0x80115ef4,-0xc(%ebp)
80104c18:	72 b3                	jb     80104bcd <kill+0x1b>
    }
  }
  release(&ptable.lock);
80104c1a:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104c21:	e8 cd 04 00 00       	call   801050f3 <release>
  return -1;
...
80104c30:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c33:	c7 45 f0 f4 3d 11 80 	movl   $0x80113df4,-0x10(%ebp)
80104c3a:	e9 d9 00 00 00       	jmp    80104d18 <procdump+0xeb>
    if(p->state == UNUSED)
80104c3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c42:	8b 40 0c             	mov    0xc(%eax),%eax
80104c45:	85 c0                	test   %eax,%eax
80104c47:	75 05                	jne    80104c4e <procdump+0x21>
      continue;
80104c49:	e9 c3 00 00 00       	jmp    80104d11 <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104c4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c51:	8b 40 0c             	mov    0xc(%eax),%eax
80104c54:	83 f8 05             	cmp    $0x5,%eax
80104c57:	77 23                	ja     80104c7c <procdump+0x4f>
80104c59:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c5c:	8b 40 0c             	mov    0xc(%eax),%eax
80104c5f:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c66:	85 c0                	test   %eax,%eax
80104c68:	74 12                	je     80104c7c <procdump+0x4f>
      state = states[p->state];
80104c6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c6d:	8b 40 0c             	mov    0xc(%eax),%eax
80104c70:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c77:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104c7a:	eb 07                	jmp    80104c83 <procdump+0x56>
    else
      state = "???";
80104c7c:	c7 45 ec 5e 89 10 80 	movl   $0x8010895e,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104c83:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c86:	8d 50 6c             	lea    0x6c(%eax),%edx
80104c89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c8c:	8b 40 10             	mov    0x10(%eax),%eax
80104c8f:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104c93:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104c96:	89 54 24 08          	mov    %edx,0x8(%esp)
80104c9a:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c9e:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80104ca5:	e8 1e b7 ff ff       	call   801003c8 <cprintf>
    if(p->state == SLEEPING){
80104caa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cad:	8b 40 0c             	mov    0xc(%eax),%eax
80104cb0:	83 f8 02             	cmp    $0x2,%eax
80104cb3:	75 50                	jne    80104d05 <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104cb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb8:	8b 40 1c             	mov    0x1c(%eax),%eax
80104cbb:	8b 40 0c             	mov    0xc(%eax),%eax
80104cbe:	83 c0 08             	add    $0x8,%eax
80104cc1:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104cc4:	89 54 24 04          	mov    %edx,0x4(%esp)
80104cc8:	89 04 24             	mov    %eax,(%esp)
80104ccb:	e8 6e 04 00 00       	call   8010513e <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cd0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104cd7:	eb 1b                	jmp    80104cf4 <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104cd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cdc:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104ce0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ce4:	c7 04 24 6b 89 10 80 	movl   $0x8010896b,(%esp)
80104ceb:	e8 d8 b6 ff ff       	call   801003c8 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cf0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104cf4:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104cf8:	7f 0b                	jg     80104d05 <procdump+0xd8>
80104cfa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cfd:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d01:	85 c0                	test   %eax,%eax
80104d03:	75 d4                	jne    80104cd9 <procdump+0xac>
    }
    cprintf("\n");
80104d05:	c7 04 24 6f 89 10 80 	movl   $0x8010896f,(%esp)
80104d0c:	e8 b7 b6 ff ff       	call   801003c8 <cprintf>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d11:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104d18:	81 7d f0 f4 5e 11 80 	cmpl   $0x80115ef4,-0x10(%ebp)
80104d1f:	0f 82 1a ff ff ff    	jb     80104c3f <procdump+0x12>
  }
}
80104d25:	c9                   	leave  
80104d26:	c3                   	ret    
...
80104d2b:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;
  int i = 0;
80104d2e:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
  for(; i < NPROC; i++)
80104d35:	e9 bd 01 00 00       	jmp    80104ef7 <fillTable+0x1d0>
  {
    p = &ptable.proc[i];
80104d3a:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104d3d:	c1 e0 02             	shl    $0x2,%eax
80104d40:	89 c2                	mov    %eax,%edx
80104d42:	c1 e2 05             	shl    $0x5,%edx
80104d45:	01 d0                	add    %edx,%eax
80104d47:	83 c0 30             	add    $0x30,%eax
80104d4a:	05 c0 3d 11 80       	add    $0x80113dc0,%eax
80104d4f:	83 c0 04             	add    $0x4,%eax
80104d52:	89 45 ec             	mov    %eax,-0x14(%ebp)
    switch (p->state) {
80104d55:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104d58:	8b 40 0c             	mov    0xc(%eax),%eax
80104d5b:	83 f8 05             	cmp    $0x5,%eax
80104d5e:	0f 87 a7 00 00 00    	ja     80104e0b <fillTable+0xe4>
80104d64:	8b 04 85 74 89 10 80 	mov    -0x7fef768c(,%eax,4),%eax
80104d6b:	ff e0                	jmp    *%eax
      case EMBRYO:   (*table)[i].state = 'E'; break;
80104d6d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d70:	8b 55 f8             	mov    -0x8(%ebp),%edx
...
80104d7f:	83 c0 20             	add    $0x20,%eax
80104d82:	c6 00 45             	movb   $0x45,(%eax)
80104d85:	e9 81 00 00 00       	jmp    80104e0b <fillTable+0xe4>
      case RUNNING:  (*table)[i].state = 'R'; break;
80104d8a:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d8d:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104d90:	89 d0                	mov    %edx,%eax
80104d92:	c1 e0 03             	shl    $0x3,%eax
80104d95:	01 d0                	add    %edx,%eax
80104d97:	c1 e0 02             	shl    $0x2,%eax
80104d9a:	01 c8                	add    %ecx,%eax
80104d9c:	83 c0 20             	add    $0x20,%eax
80104d9f:	c6 00 52             	movb   $0x52,(%eax)
80104da2:	eb 67                	jmp    80104e0b <fillTable+0xe4>
      case RUNNABLE: (*table)[i].state = 'A'; break;
80104da4:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104da7:	8b 55 f8             	mov    -0x8(%ebp),%edx
...
80104db9:	c6 00 41             	movb   $0x41,(%eax)
80104dbc:	eb 4d                	jmp    80104e0b <fillTable+0xe4>
...
80104dd3:	c6 00 53             	movb   $0x53,(%eax)
80104dd6:	eb 33                	jmp    80104e0b <fillTable+0xe4>
      case ZOMBIE:   (*table)[i].state = 'Z'; break;
80104dd8:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ddb:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104dde:	89 d0                	mov    %edx,%eax
80104de0:	c1 e0 03             	shl    $0x3,%eax
80104de3:	01 d0                	add    %edx,%eax
80104de5:	c1 e0 02             	shl    $0x2,%eax
80104de8:	01 c8                	add    %ecx,%eax
80104dea:	83 c0 20             	add    $0x20,%eax
80104ded:	c6 00 5a             	movb   $0x5a,(%eax)
80104df0:	eb 19                	jmp    80104e0b <fillTable+0xe4>
      case UNUSED:  (*table)[i].state = 'U'; break;
80104df2:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104df5:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104df8:	89 d0                	mov    %edx,%eax
80104dfa:	c1 e0 03             	shl    $0x3,%eax
80104dfd:	01 d0                	add    %edx,%eax
80104dff:	c1 e0 02             	shl    $0x2,%eax
80104e02:	01 c8                	add    %ecx,%eax
80104e04:	83 c0 20             	add    $0x20,%eax
80104e07:	c6 00 55             	movb   $0x55,(%eax)
80104e0a:	90                   	nop
    }
    (*table)[i].inuse = 1;
80104e0b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e0e:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104e11:	89 d0                	mov    %edx,%eax
80104e13:	c1 e0 03             	shl    $0x3,%eax
80104e16:	01 d0                	add    %edx,%eax
80104e18:	c1 e0 02             	shl    $0x2,%eax
80104e1b:	01 c8                	add    %ecx,%eax
80104e1d:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    (*table)[i].tickets = p->tickets;
80104e23:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e26:	8b 48 7c             	mov    0x7c(%eax),%ecx
80104e29:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104e2c:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104e2f:	89 d0                	mov    %edx,%eax
80104e31:	c1 e0 03             	shl    $0x3,%eax
80104e34:	01 d0                	add    %edx,%eax
80104e36:	c1 e0 02             	shl    $0x2,%eax
80104e39:	01 d8                	add    %ebx,%eax
80104e3b:	83 c0 04             	add    $0x4,%eax
80104e3e:	89 08                	mov    %ecx,(%eax)
    (*table)[i].pid = p->pid;
80104e40:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e43:	8b 48 10             	mov    0x10(%eax),%ecx
80104e46:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104e49:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104e4c:	89 d0                	mov    %edx,%eax
80104e4e:	c1 e0 03             	shl    $0x3,%eax
80104e51:	01 d0                	add    %edx,%eax
80104e53:	c1 e0 02             	shl    $0x2,%eax
80104e56:	01 d8                	add    %ebx,%eax
80104e58:	83 c0 08             	add    $0x8,%eax
80104e5b:	89 08                	mov    %ecx,(%eax)
    (*table)[i].ticks = p->ticks;
80104e5d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e60:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80104e66:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104e69:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104e6c:	89 d0                	mov    %edx,%eax
80104e6e:	c1 e0 03             	shl    $0x3,%eax
80104e71:	01 d0                	add    %edx,%eax
80104e73:	c1 e0 02             	shl    $0x2,%eax
80104e76:	01 d8                	add    %ebx,%eax
80104e78:	83 c0 0c             	add    $0xc,%eax
80104e7b:	89 08                	mov    %ecx,(%eax)
    int k = 0;
80104e7d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    char c;
    for(c = p->name[k]; c != '\0'; c = p->name[k])
80104e84:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104e87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e8a:	01 d0                	add    %edx,%eax
80104e8c:	83 c0 60             	add    $0x60,%eax
80104e8f:	0f b6 40 0c          	movzbl 0xc(%eax),%eax
80104e93:	88 45 f3             	mov    %al,-0xd(%ebp)
80104e96:	eb 37                	jmp    80104ecf <fillTable+0x1a8>
    {
      (*table)[i].name[k] = c;
80104e98:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e9b:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104e9e:	89 d0                	mov    %edx,%eax
80104ea0:	c1 e0 03             	shl    $0x3,%eax
80104ea3:	01 d0                	add    %edx,%eax
80104ea5:	c1 e0 02             	shl    $0x2,%eax
80104ea8:	8d 14 01             	lea    (%ecx,%eax,1),%edx
80104eab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eae:	01 d0                	add    %edx,%eax
80104eb0:	8d 50 10             	lea    0x10(%eax),%edx
80104eb3:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
80104eb7:	88 02                	mov    %al,(%edx)
      k++;
80104eb9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    for(c = p->name[k]; c != '\0'; c = p->name[k])
80104ebd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104ec0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ec3:	01 d0                	add    %edx,%eax
80104ec5:	83 c0 60             	add    $0x60,%eax
80104ec8:	0f b6 40 0c          	movzbl 0xc(%eax),%eax
80104ecc:	88 45 f3             	mov    %al,-0xd(%ebp)
80104ecf:	80 7d f3 00          	cmpb   $0x0,-0xd(%ebp)
80104ed3:	75 c3                	jne    80104e98 <fillTable+0x171>
    }
    (*table)[i].name[k] = '\0';
80104ed5:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ed8:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104edb:	89 d0                	mov    %edx,%eax
80104edd:	c1 e0 03             	shl    $0x3,%eax
80104ee0:	01 d0                	add    %edx,%eax
80104ee2:	c1 e0 02             	shl    $0x2,%eax
80104ee5:	8d 14 01             	lea    (%ecx,%eax,1),%edx
80104ee8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eeb:	01 d0                	add    %edx,%eax
80104eed:	83 c0 10             	add    $0x10,%eax
80104ef0:	c6 00 00             	movb   $0x0,(%eax)
  for(; i < NPROC; i++)
80104ef3:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104ef7:	83 7d f8 3f          	cmpl   $0x3f,-0x8(%ebp)
80104efb:	0f 8e 39 fe ff ff    	jle    80104d3a <fillTable+0x13>
  }
...
80104f13:	c7 44 24 04 b6 89 10 	movl   $0x801089b6,0x4(%esp)
80104f1a:	80 
80104f1b:	89 04 24             	mov    %eax,(%esp)
80104f1e:	e8 47 01 00 00       	call   8010506a <initlock>
  lk->name = name;
80104f23:	8b 45 08             	mov    0x8(%ebp),%eax
80104f26:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f29:	89 50 38             	mov    %edx,0x38(%eax)
  lk->locked = 0;
80104f2c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f2f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->pid = 0;
80104f35:	8b 45 08             	mov    0x8(%ebp),%eax
80104f38:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
}
80104f3f:	c9                   	leave  
80104f40:	c3                   	ret    
...
80104f44:	83 ec 18             	sub    $0x18,%esp
  acquire(&lk->lk);
80104f47:	8b 45 08             	mov    0x8(%ebp),%eax
80104f4a:	83 c0 04             	add    $0x4,%eax
80104f4d:	89 04 24             	mov    %eax,(%esp)
80104f50:	e8 36 01 00 00       	call   8010508b <acquire>
  while (lk->locked) {
80104f55:	eb 15                	jmp    80104f6c <acquiresleep+0x2b>
    sleep(lk, &lk->lk);
...
80104f67:	e8 44 fb ff ff       	call   80104ab0 <sleep>
  while (lk->locked) {
80104f6c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f6f:	8b 00                	mov    (%eax),%eax
80104f71:	85 c0                	test   %eax,%eax
80104f73:	75 e2                	jne    80104f57 <acquiresleep+0x16>
  }
  lk->locked = 1;
80104f75:	8b 45 08             	mov    0x8(%ebp),%eax
80104f78:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  lk->pid = myproc()->pid;
80104f7e:	e8 02 f2 ff ff       	call   80104185 <myproc>
80104f83:	8b 50 10             	mov    0x10(%eax),%edx
80104f86:	8b 45 08             	mov    0x8(%ebp),%eax
80104f89:	89 50 3c             	mov    %edx,0x3c(%eax)
  release(&lk->lk);
80104f8c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f8f:	83 c0 04             	add    $0x4,%eax
80104f92:	89 04 24             	mov    %eax,(%esp)
80104f95:	e8 59 01 00 00       	call   801050f3 <release>
}
80104f9a:	c9                   	leave  
80104f9b:	c3                   	ret    

80104f9c <releasesleep>:
...
80104fab:	e8 db 00 00 00       	call   8010508b <acquire>
  lk->locked = 0;
80104fb0:	8b 45 08             	mov    0x8(%ebp),%eax
80104fb3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->pid = 0;
80104fb9:	8b 45 08             	mov    0x8(%ebp),%eax
80104fbc:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
  wakeup(lk);
80104fc3:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc6:	89 04 24             	mov    %eax,(%esp)
80104fc9:	e8 b9 fb ff ff       	call   80104b87 <wakeup>
  release(&lk->lk);
80104fce:	8b 45 08             	mov    0x8(%ebp),%eax
80104fd1:	83 c0 04             	add    $0x4,%eax
80104fd4:	89 04 24             	mov    %eax,(%esp)
80104fd7:	e8 17 01 00 00       	call   801050f3 <release>
}
80104fdc:	c9                   	leave  
80104fdd:	c3                   	ret    

80104fde <holdingsleep>:
...
80104fe2:	83 ec 24             	sub    $0x24,%esp
  int r;
...
80104fee:	e8 98 00 00 00       	call   8010508b <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104ff3:	8b 45 08             	mov    0x8(%ebp),%eax
80104ff6:	8b 00                	mov    (%eax),%eax
80104ff8:	85 c0                	test   %eax,%eax
80104ffa:	74 19                	je     80105015 <holdingsleep+0x37>
80104ffc:	8b 45 08             	mov    0x8(%ebp),%eax
80104fff:	8b 58 3c             	mov    0x3c(%eax),%ebx
80105002:	e8 7e f1 ff ff       	call   80104185 <myproc>
80105007:	8b 40 10             	mov    0x10(%eax),%eax
8010500a:	39 c3                	cmp    %eax,%ebx
8010500c:	75 07                	jne    80105015 <holdingsleep+0x37>
8010500e:	b8 01 00 00 00       	mov    $0x1,%eax
80105013:	eb 05                	jmp    8010501a <holdingsleep+0x3c>
80105015:	b8 00 00 00 00       	mov    $0x0,%eax
8010501a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&lk->lk);
8010501d:	8b 45 08             	mov    0x8(%ebp),%eax
80105020:	83 c0 04             	add    $0x4,%eax
80105023:	89 04 24             	mov    %eax,(%esp)
80105026:	e8 c8 00 00 00       	call   801050f3 <release>
  return r;
8010502b:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
8010502e:	83 c4 24             	add    $0x24,%esp
80105031:	5b                   	pop    %ebx
80105032:	5d                   	pop    %ebp
80105033:	c3                   	ret    
...
80105053:	83 ec 10             	sub    $0x10,%esp
  asm volatile("lock; xchgl %0, %1" :
80105056:	8b 55 08             	mov    0x8(%ebp),%edx
80105059:	8b 45 0c             	mov    0xc(%ebp),%eax
8010505c:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010505f:	f0 87 02             	lock xchg %eax,(%edx)
...
80105070:	8b 55 0c             	mov    0xc(%ebp),%edx
80105073:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
...
8010508f:	83 ec 14             	sub    $0x14,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80105092:	e8 61 01 00 00       	call   801051f8 <pushcli>
  if(holding(lk))
80105097:	8b 45 08             	mov    0x8(%ebp),%eax
8010509a:	89 04 24             	mov    %eax,(%esp)
8010509d:	e8 15 01 00 00       	call   801051b7 <holding>
801050a2:	85 c0                	test   %eax,%eax
801050a4:	74 0c                	je     801050b2 <acquire+0x27>
    panic("acquire");
801050a6:	c7 04 24 c1 89 10 80 	movl   $0x801089c1,(%esp)
801050ad:	e8 b0 b4 ff ff       	call   80100562 <panic>

  // The xchg is atomic.
  while(xchg(&lk->locked, 1) != 0)
801050b2:	90                   	nop
801050b3:	8b 45 08             	mov    0x8(%ebp),%eax
801050b6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801050bd:	00 
801050be:	89 04 24             	mov    %eax,(%esp)
801050c1:	e8 8a ff ff ff       	call   80105050 <xchg>
801050c6:	85 c0                	test   %eax,%eax
801050c8:	75 e9                	jne    801050b3 <acquire+0x28>
    ;
  ...
  __sync_synchronize();
801050ca:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
801050cd:	8b 5d 08             	mov    0x8(%ebp),%ebx
801050d0:	e8 3a f0 ff ff       	call   8010410f <mycpu>
801050d5:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801050d8:	8b 45 08             	mov    0x8(%ebp),%eax
801050db:	83 c0 0c             	add    $0xc,%eax
801050de:	89 44 24 04          	mov    %eax,0x4(%esp)
801050e2:	8d 45 08             	lea    0x8(%ebp),%eax
801050e5:	89 04 24             	mov    %eax,(%esp)
801050e8:	e8 51 00 00 00       	call   8010513e <getcallerpcs>
}
801050ed:	83 c4 14             	add    $0x14,%esp
801050f0:	5b                   	pop    %ebx
801050f1:	5d                   	pop    %ebp
801050f2:	c3                   	ret    
...
801050ff:	e8 b3 00 00 00       	call   801051b7 <holding>
80105104:	85 c0                	test   %eax,%eax
80105106:	75 0c                	jne    80105114 <release+0x21>
    panic("release");
80105108:	c7 04 24 c9 89 10 80 	movl   $0x801089c9,(%esp)
8010510f:	e8 4e b4 ff ff       	call   80100562 <panic>
...
80105131:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

  popcli();
80105137:	e8 08 01 00 00       	call   80105244 <popcli>
}
8010513c:	c9                   	leave  
8010513d:	c3                   	ret    

8010513e <getcallerpcs>:
...
80105147:	83 e8 08             	sub    $0x8,%eax
8010514a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010514d:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105154:	eb 38                	jmp    8010518e <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105156:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010515a:	74 38                	je     80105194 <getcallerpcs+0x56>
8010515c:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105163:	76 2f                	jbe    80105194 <getcallerpcs+0x56>
80105165:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105169:	74 29                	je     80105194 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010516b:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010516e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105175:	8b 45 0c             	mov    0xc(%ebp),%eax
80105178:	01 c2                	add    %eax,%edx
8010517a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010517d:	8b 40 04             	mov    0x4(%eax),%eax
80105180:	89 02                	mov    %eax,(%edx)
...
80105192:	7e c2                	jle    80105156 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
80105194:	eb 19                	jmp    801051af <getcallerpcs+0x71>
    pcs[i] = 0;
80105196:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105199:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801051a0:	8b 45 0c             	mov    0xc(%ebp),%eax
801051a3:	01 d0                	add    %edx,%eax
801051a5:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801051ab:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801051af:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801051b3:	7e e1                	jle    80105196 <getcallerpcs+0x58>
}
801051b5:	c9                   	leave  
801051b6:	c3                   	ret    
...
801051bb:	83 ec 14             	sub    $0x14,%esp
  int r;
  pushcli();
801051be:	e8 35 00 00 00       	call   801051f8 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801051c3:	8b 45 08             	mov    0x8(%ebp),%eax
801051c6:	8b 00                	mov    (%eax),%eax
801051c8:	85 c0                	test   %eax,%eax
801051ca:	74 16                	je     801051e2 <holding+0x2b>
801051cc:	8b 45 08             	mov    0x8(%ebp),%eax
801051cf:	8b 58 08             	mov    0x8(%eax),%ebx
801051d2:	e8 38 ef ff ff       	call   8010410f <mycpu>
801051d7:	39 c3                	cmp    %eax,%ebx
801051d9:	75 07                	jne    801051e2 <holding+0x2b>
801051db:	b8 01 00 00 00       	mov    $0x1,%eax
801051e0:	eb 05                	jmp    801051e7 <holding+0x30>
801051e2:	b8 00 00 00 00       	mov    $0x0,%eax
801051e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  popcli();
801051ea:	e8 55 00 00 00       	call   80105244 <popcli>
  return r;
...
801051fb:	83 ec 18             	sub    $0x18,%esp
  ...
  eflags = readeflags();
801051fe:	e8 31 fe ff ff       	call   80105034 <readeflags>
80105203:	89 45 f4             	mov    %eax,-0xc(%ebp)
  cli();
80105206:	e8 39 fe ff ff       	call   80105044 <cli>
  if(mycpu()->ncli == 0)
8010520b:	e8 ff ee ff ff       	call   8010410f <mycpu>
80105210:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105216:	85 c0                	test   %eax,%eax
80105218:	75 14                	jne    8010522e <pushcli+0x36>
    mycpu()->intena = eflags & FL_IF;
8010521a:	e8 f0 ee ff ff       	call   8010410f <mycpu>
8010521f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105222:	81 e2 00 02 00 00    	and    $0x200,%edx
80105228:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
  mycpu()->ncli += 1;
8010522e:	e8 dc ee ff ff       	call   8010410f <mycpu>
80105233:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105239:	83 c2 01             	add    $0x1,%edx
8010523c:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
}
80105242:	c9                   	leave  
80105243:	c3                   	ret    
...
80105247:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010524a:	e8 e5 fd ff ff       	call   80105034 <readeflags>
8010524f:	25 00 02 00 00       	and    $0x200,%eax
80105254:	85 c0                	test   %eax,%eax
80105256:	74 0c                	je     80105264 <popcli+0x20>
    panic("popcli - interruptible");
80105258:	c7 04 24 d1 89 10 80 	movl   $0x801089d1,(%esp)
8010525f:	e8 fe b2 ff ff       	call   80100562 <panic>
  if(--mycpu()->ncli < 0)
80105264:	e8 a6 ee ff ff       	call   8010410f <mycpu>
80105269:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010526f:	83 ea 01             	sub    $0x1,%edx
80105272:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80105278:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
8010527e:	85 c0                	test   %eax,%eax
80105280:	79 0c                	jns    8010528e <popcli+0x4a>
    panic("popcli");
80105282:	c7 04 24 e8 89 10 80 	movl   $0x801089e8,(%esp)
80105289:	e8 d4 b2 ff ff       	call   80100562 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010528e:	e8 7c ee ff ff       	call   8010410f <mycpu>
80105293:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105299:	85 c0                	test   %eax,%eax
8010529b:	75 14                	jne    801052b1 <popcli+0x6d>
8010529d:	e8 6d ee ff ff       	call   8010410f <mycpu>
801052a2:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801052a8:	85 c0                	test   %eax,%eax
801052aa:	74 05                	je     801052b1 <popcli+0x6d>
    sti();
801052ac:	e8 99 fd ff ff       	call   8010504a <sti>
}
801052b1:	c9                   	leave  
801052b2:	c3                   	ret    
...
801052c7:	fc                   	cld    
801052c8:	f3 aa                	rep stos %al,%es:(%edi)
...
801052dd:	8b 4d 08             	mov    0x8(%ebp),%ecx
801052e0:	8b 55 10             	mov    0x10(%ebp),%edx
801052e3:	8b 45 0c             	mov    0xc(%ebp),%eax
801052e6:	89 cb                	mov    %ecx,%ebx
801052e8:	89 df                	mov    %ebx,%edi
801052ea:	89 d1                	mov    %edx,%ecx
801052ec:	fc                   	cld    
801052ed:	f3 ab                	rep stos %eax,%es:(%edi)
801052ef:	89 ca                	mov    %ecx,%edx
801052f1:	89 fb                	mov    %edi,%ebx
801052f3:	89 5d 08             	mov    %ebx,0x8(%ebp)
801052f6:	89 55 10             	mov    %edx,0x10(%ebp)
}
801052f9:	5b                   	pop    %ebx
801052fa:	5f                   	pop    %edi
801052fb:	5d                   	pop    %ebp
...
80105306:	83 e0 03             	and    $0x3,%eax
80105309:	85 c0                	test   %eax,%eax
8010530b:	75 49                	jne    80105356 <memset+0x59>
8010530d:	8b 45 10             	mov    0x10(%ebp),%eax
80105310:	83 e0 03             	and    $0x3,%eax
80105313:	85 c0                	test   %eax,%eax
80105315:	75 3f                	jne    80105356 <memset+0x59>
    c &= 0xFF;
80105317:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010531e:	8b 45 10             	mov    0x10(%ebp),%eax
80105321:	c1 e8 02             	shr    $0x2,%eax
80105324:	89 c2                	mov    %eax,%edx
80105326:	8b 45 0c             	mov    0xc(%ebp),%eax
80105329:	c1 e0 18             	shl    $0x18,%eax
8010532c:	89 c1                	mov    %eax,%ecx
8010532e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105331:	c1 e0 10             	shl    $0x10,%eax
80105334:	09 c1                	or     %eax,%ecx
80105336:	8b 45 0c             	mov    0xc(%ebp),%eax
80105339:	c1 e0 08             	shl    $0x8,%eax
8010533c:	09 c8                	or     %ecx,%eax
8010533e:	0b 45 0c             	or     0xc(%ebp),%eax
80105341:	89 54 24 08          	mov    %edx,0x8(%esp)
80105345:	89 44 24 04          	mov    %eax,0x4(%esp)
80105349:	8b 45 08             	mov    0x8(%ebp),%eax
8010534c:	89 04 24             	mov    %eax,(%esp)
8010534f:	e8 84 ff ff ff       	call   801052d8 <stosl>
80105354:	eb 19                	jmp    8010536f <memset+0x72>
  } else
    stosb(dst, c, n);
80105356:	8b 45 10             	mov    0x10(%ebp),%eax
80105359:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010536a:	e8 44 ff ff ff       	call   801052b3 <stosb>
  return dst;
...
80105383:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105386:	eb 30                	jmp    801053b8 <memcmp+0x44>
    if(*s1 != *s2)
80105388:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010538b:	0f b6 10             	movzbl (%eax),%edx
8010538e:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105391:	0f b6 00             	movzbl (%eax),%eax
80105394:	38 c2                	cmp    %al,%dl
80105396:	74 18                	je     801053b0 <memcmp+0x3c>
      return *s1 - *s2;
80105398:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010539b:	0f b6 00             	movzbl (%eax),%eax
8010539e:	0f b6 d0             	movzbl %al,%edx
801053a1:	8b 45 f8             	mov    -0x8(%ebp),%eax
801053a4:	0f b6 00             	movzbl (%eax),%eax
801053a7:	0f b6 c0             	movzbl %al,%eax
801053aa:	29 c2                	sub    %eax,%edx
801053ac:	89 d0                	mov    %edx,%eax
801053ae:	eb 1a                	jmp    801053ca <memcmp+0x56>
    s1++, s2++;
801053b0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801053b4:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
  while(n-- > 0){
801053b8:	8b 45 10             	mov    0x10(%ebp),%eax
801053bb:	8d 50 ff             	lea    -0x1(%eax),%edx
801053be:	89 55 10             	mov    %edx,0x10(%ebp)
801053c1:	85 c0                	test   %eax,%eax
801053c3:	75 c3                	jne    80105388 <memcmp+0x14>
  }
...
801053db:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801053de:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053e1:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053e4:	73 3d                	jae    80105423 <memmove+0x57>
801053e6:	8b 45 10             	mov    0x10(%ebp),%eax
801053e9:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053ec:	01 d0                	add    %edx,%eax
801053ee:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053f1:	76 30                	jbe    80105423 <memmove+0x57>
    s += n;
801053f3:	8b 45 10             	mov    0x10(%ebp),%eax
801053f6:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801053f9:	8b 45 10             	mov    0x10(%ebp),%eax
801053fc:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801053ff:	eb 13                	jmp    80105414 <memmove+0x48>
      *--d = *--s;
80105401:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105405:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105409:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010540c:	0f b6 10             	movzbl (%eax),%edx
8010540f:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105412:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
80105414:	8b 45 10             	mov    0x10(%ebp),%eax
80105417:	8d 50 ff             	lea    -0x1(%eax),%edx
8010541a:	89 55 10             	mov    %edx,0x10(%ebp)
8010541d:	85 c0                	test   %eax,%eax
8010541f:	75 e0                	jne    80105401 <memmove+0x35>
  if(s < d && s + n > d){
80105421:	eb 26                	jmp    80105449 <memmove+0x7d>
  } else
    while(n-- > 0)
80105423:	eb 17                	jmp    8010543c <memmove+0x70>
      *d++ = *s++;
80105425:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105428:	8d 50 01             	lea    0x1(%eax),%edx
8010542b:	89 55 f8             	mov    %edx,-0x8(%ebp)
8010542e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105431:	8d 4a 01             	lea    0x1(%edx),%ecx
80105434:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105437:	0f b6 12             	movzbl (%edx),%edx
8010543a:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
8010543c:	8b 45 10             	mov    0x10(%ebp),%eax
8010543f:	8d 50 ff             	lea    -0x1(%eax),%edx
80105442:	89 55 10             	mov    %edx,0x10(%ebp)
80105445:	85 c0                	test   %eax,%eax
80105447:	75 dc                	jne    80105425 <memmove+0x59>
...
80105457:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105468:	e8 5f ff ff ff       	call   801053cc <memmove>
}
8010546d:	c9                   	leave  
8010546e:	c3                   	ret    
...
80105470:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105472:	eb 0c                	jmp    80105480 <strncmp+0x11>
    n--, p++, q++;
80105474:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105478:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010547c:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(n > 0 && *p && *p == *q)
80105480:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105484:	74 1a                	je     801054a0 <strncmp+0x31>
80105486:	8b 45 08             	mov    0x8(%ebp),%eax
80105489:	0f b6 00             	movzbl (%eax),%eax
8010548c:	84 c0                	test   %al,%al
8010548e:	74 10                	je     801054a0 <strncmp+0x31>
80105490:	8b 45 08             	mov    0x8(%ebp),%eax
80105493:	0f b6 10             	movzbl (%eax),%edx
80105496:	8b 45 0c             	mov    0xc(%ebp),%eax
80105499:	0f b6 00             	movzbl (%eax),%eax
8010549c:	38 c2                	cmp    %al,%dl
8010549e:	74 d4                	je     80105474 <strncmp+0x5>
  if(n == 0)
801054a0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801054a4:	75 07                	jne    801054ad <strncmp+0x3e>
    return 0;
801054a6:	b8 00 00 00 00       	mov    $0x0,%eax
801054ab:	eb 16                	jmp    801054c3 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
801054ad:	8b 45 08             	mov    0x8(%ebp),%eax
801054b0:	0f b6 00             	movzbl (%eax),%eax
801054b3:	0f b6 d0             	movzbl %al,%edx
801054b6:	8b 45 0c             	mov    0xc(%ebp),%eax
801054b9:	0f b6 00             	movzbl (%eax),%eax
801054bc:	0f b6 c0             	movzbl %al,%eax
801054bf:	29 c2                	sub    %eax,%edx
...
801054dd:	7e 1e                	jle    801054fd <strncpy+0x38>
801054df:	8b 45 08             	mov    0x8(%ebp),%eax
801054e2:	8d 50 01             	lea    0x1(%eax),%edx
801054e5:	89 55 08             	mov    %edx,0x8(%ebp)
801054e8:	8b 55 0c             	mov    0xc(%ebp),%edx
801054eb:	8d 4a 01             	lea    0x1(%edx),%ecx
801054ee:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801054f1:	0f b6 12             	movzbl (%edx),%edx
801054f4:	88 10                	mov    %dl,(%eax)
801054f6:	0f b6 00             	movzbl (%eax),%eax
801054f9:	84 c0                	test   %al,%al
801054fb:	75 d5                	jne    801054d2 <strncpy+0xd>
    ;
  while(n-- > 0)
801054fd:	eb 0c                	jmp    8010550b <strncpy+0x46>
    *s++ = 0;
801054ff:	8b 45 08             	mov    0x8(%ebp),%eax
80105502:	8d 50 01             	lea    0x1(%eax),%edx
80105505:	89 55 08             	mov    %edx,0x8(%ebp)
80105508:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
...
80105516:	7f e7                	jg     801054ff <strncpy+0x3a>
  return os;
...
80105526:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105529:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010552d:	7f 05                	jg     80105534 <safestrcpy+0x17>
    return os;
8010552f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105532:	eb 31                	jmp    80105565 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105534:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105538:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010553c:	7e 1e                	jle    8010555c <safestrcpy+0x3f>
...
8010555a:	75 d8                	jne    80105534 <safestrcpy+0x17>
    ;
  *s = 0;
...
80105580:	01 d0                	add    %edx,%eax
80105582:	0f b6 00             	movzbl (%eax),%eax
80105585:	84 c0                	test   %al,%al
80105587:	75 ed                	jne    80105576 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010558e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105592:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105599:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010559a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010559c:	89 d4                	mov    %edx,%esp
...
801055a6:	83 ec 18             	sub    $0x18,%esp
  struct proc *curproc = myproc();
801055a9:	e8 d7 eb ff ff       	call   80104185 <myproc>
801055ae:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801055b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055b4:	8b 00                	mov    (%eax),%eax
801055b6:	3b 45 08             	cmp    0x8(%ebp),%eax
801055b9:	76 0f                	jbe    801055ca <fetchint+0x27>
...
801055c8:	76 07                	jbe    801055d1 <fetchint+0x2e>
    return -1;
801055ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055cf:	eb 0f                	jmp    801055e0 <fetchint+0x3d>
  *ip = *(int*)(addr);
...
801055e5:	83 ec 18             	sub    $0x18,%esp
  char *s, *ep;
  struct proc *curproc = myproc();
801055e8:	e8 98 eb ff ff       	call   80104185 <myproc>
801055ed:	89 45 f0             	mov    %eax,-0x10(%ebp)

  if(addr >= curproc->sz)
801055f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f3:	8b 00                	mov    (%eax),%eax
801055f5:	3b 45 08             	cmp    0x8(%ebp),%eax
801055f8:	77 07                	ja     80105601 <fetchstr+0x1f>
    return -1;
801055fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ff:	eb 43                	jmp    80105644 <fetchstr+0x62>
  *pp = (char*)addr;
80105601:	8b 55 08             	mov    0x8(%ebp),%edx
80105604:	8b 45 0c             	mov    0xc(%ebp),%eax
80105607:	89 10                	mov    %edx,(%eax)
  ep = (char*)curproc->sz;
80105609:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010560c:	8b 00                	mov    (%eax),%eax
8010560e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  for(s = *pp; s < ep; s++){
80105611:	8b 45 0c             	mov    0xc(%ebp),%eax
80105614:	8b 00                	mov    (%eax),%eax
80105616:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105619:	eb 1c                	jmp    80105637 <fetchstr+0x55>
    if(*s == 0)
8010561b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010561e:	0f b6 00             	movzbl (%eax),%eax
80105621:	84 c0                	test   %al,%al
80105623:	75 0e                	jne    80105633 <fetchstr+0x51>
      return s - *pp;
80105625:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105628:	8b 45 0c             	mov    0xc(%ebp),%eax
8010562b:	8b 00                	mov    (%eax),%eax
8010562d:	29 c2                	sub    %eax,%edx
8010562f:	89 d0                	mov    %edx,%eax
80105631:	eb 11                	jmp    80105644 <fetchstr+0x62>
  for(s = *pp; s < ep; s++){
80105633:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105637:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010563a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
8010563d:	72 dc                	jb     8010561b <fetchstr+0x39>
  }
  return -1;
...
8010564c:	e8 34 eb ff ff       	call   80104185 <myproc>
80105651:	8b 40 18             	mov    0x18(%eax),%eax
80105654:	8b 50 44             	mov    0x44(%eax),%edx
80105657:	8b 45 08             	mov    0x8(%ebp),%eax
8010565a:	c1 e0 02             	shl    $0x2,%eax
...
80105669:	89 14 24             	mov    %edx,(%esp)
8010566c:	e8 32 ff ff ff       	call   801055a3 <fetchint>
}
80105671:	c9                   	leave  
80105672:	c3                   	ret    
...
80105676:	83 ec 28             	sub    $0x28,%esp
  int i;
  struct proc *curproc = myproc();
80105679:	e8 07 eb ff ff       	call   80104185 <myproc>
8010567e:	89 45 f4             	mov    %eax,-0xc(%ebp)
 
  if(argint(n, &i) < 0)
80105681:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105684:	89 44 24 04          	mov    %eax,0x4(%esp)
80105688:	8b 45 08             	mov    0x8(%ebp),%eax
8010568b:	89 04 24             	mov    %eax,(%esp)
8010568e:	e8 b3 ff ff ff       	call   80105646 <argint>
80105693:	85 c0                	test   %eax,%eax
80105695:	79 07                	jns    8010569e <argptr+0x2b>
    return -1;
80105697:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569c:	eb 3d                	jmp    801056db <argptr+0x68>
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
8010569e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801056a2:	78 21                	js     801056c5 <argptr+0x52>
...
801056b0:	73 13                	jae    801056c5 <argptr+0x52>
...
801056c3:	76 07                	jbe    801056cc <argptr+0x59>
    return -1;
801056c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056ca:	eb 0f                	jmp    801056db <argptr+0x68>
  *pp = (char*)i;
801056cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056cf:	89 c2                	mov    %eax,%edx
...
801056f0:	e8 51 ff ff ff       	call   80105646 <argint>
801056f5:	85 c0                	test   %eax,%eax
801056f7:	79 07                	jns    80105700 <argstr+0x23>
    return -1;
801056f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056fe:	eb 12                	jmp    80105712 <argstr+0x35>
  return fetchstr(addr, pp);
80105700:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105703:	8b 55 0c             	mov    0xc(%ebp),%edx
80105706:	89 54 24 04          	mov    %edx,0x4(%esp)
8010570a:	89 04 24             	mov    %eax,(%esp)
8010570d:	e8 d0 fe ff ff       	call   801055e2 <fetchstr>
}
80105712:	c9                   	leave  
80105713:	c3                   	ret    
...
80105718:	83 ec 24             	sub    $0x24,%esp
  int num;
  struct proc *curproc = myproc();
8010571b:	e8 65 ea ff ff       	call   80104185 <myproc>
...
80105760:	eb 34                	jmp    80105796 <syscall+0x82>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80105762:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105765:	8d 48 6c             	lea    0x6c(%eax),%ecx
    cprintf("%d %s: unknown sys call %d\n",
80105768:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010576b:	8b 40 10             	mov    0x10(%eax),%eax
8010576e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105771:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105775:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105779:	89 44 24 04          	mov    %eax,0x4(%esp)
8010577d:	c7 04 24 ef 89 10 80 	movl   $0x801089ef,(%esp)
80105784:	e8 3f ac ff ff       	call   801003c8 <cprintf>
    curproc->tf->eax = -1;
80105789:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010578c:	8b 40 18             	mov    0x18(%eax),%eax
8010578f:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105796:	83 c4 24             	add    $0x24,%esp
80105799:	5b                   	pop    %ebx
8010579a:	5d                   	pop    %ebp
8010579b:	c3                   	ret    
...
801057e4:	75 07                	jne    801057ed <argfd+0x51>
    return -1;
801057e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057eb:	eb 21                	jmp    8010580e <argfd+0x72>
  if(pfd)
801057ed:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801057f1:	74 08                	je     801057fb <argfd+0x5f>
    *pfd = fd;
801057f3:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057f6:	8b 45 0c             	mov    0xc(%ebp),%eax
801057f9:	89 10                	mov    %edx,(%eax)
  if(pf)
801057fb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801057ff:	74 08                	je     80105809 <argfd+0x6d>
    *pf = f;
...
80105813:	83 ec 18             	sub    $0x18,%esp
  int fd;
  struct proc *curproc = myproc();
80105816:	e8 6a e9 ff ff       	call   80104185 <myproc>
8010581b:	89 45 f0             	mov    %eax,-0x10(%ebp)

  for(fd = 0; fd < NOFILE; fd++){
8010581e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105825:	eb 2a                	jmp    80105851 <fdalloc+0x41>
    if(curproc->ofile[fd] == 0){
80105827:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010582a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010582d:	83 c2 08             	add    $0x8,%edx
80105830:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105834:	85 c0                	test   %eax,%eax
80105836:	75 15                	jne    8010584d <fdalloc+0x3d>
      curproc->ofile[fd] = f;
80105838:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010583b:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
8010584b:	eb 0f                	jmp    8010585c <fdalloc+0x4c>
  for(fd = 0; fd < NOFILE; fd++){
8010584d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105851:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105855:	7e d0                	jle    80105827 <fdalloc+0x17>
    }
  }
  return -1;
...
80105861:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;

  if(argfd(0, 0, &f) < 0)
80105864:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105867:	89 44 24 08          	mov    %eax,0x8(%esp)
8010586b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105872:	00 
80105873:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010587a:	e8 1d ff ff ff       	call   8010579c <argfd>
8010587f:	85 c0                	test   %eax,%eax
80105881:	79 07                	jns    8010588a <sys_dup+0x2c>
    return -1;
80105883:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105888:	eb 29                	jmp    801058b3 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
8010588a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010588d:	89 04 24             	mov    %eax,(%esp)
80105890:	e8 7b ff ff ff       	call   80105810 <fdalloc>
80105895:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105898:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010589c:	79 07                	jns    801058a5 <sys_dup+0x47>
    return -1;
8010589e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058a3:	eb 0e                	jmp    801058b3 <sys_dup+0x55>
  filedup(f);
801058a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058a8:	89 04 24             	mov    %eax,(%esp)
801058ab:	e8 35 b7 ff ff       	call   80100fe5 <filedup>
  return fd;
...
801058d1:	e8 c6 fe ff ff       	call   8010579c <argfd>
801058d6:	85 c0                	test   %eax,%eax
801058d8:	78 35                	js     8010590f <sys_read+0x5a>
801058da:	8d 45 f0             	lea    -0x10(%ebp),%eax
801058dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801058e1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801058e8:	e8 59 fd ff ff       	call   80105646 <argint>
801058ed:	85 c0                	test   %eax,%eax
801058ef:	78 1e                	js     8010590f <sys_read+0x5a>
801058f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058f4:	89 44 24 08          	mov    %eax,0x8(%esp)
801058f8:	8d 45 ec             	lea    -0x14(%ebp),%eax
801058fb:	89 44 24 04          	mov    %eax,0x4(%esp)
801058ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105906:	e8 68 fd ff ff       	call   80105673 <argptr>
8010590b:	85 c0                	test   %eax,%eax
8010590d:	79 07                	jns    80105916 <sys_read+0x61>
    return -1;
8010590f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105914:	eb 19                	jmp    8010592f <sys_read+0x7a>
  return fileread(f, p, n);
80105916:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105919:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010591c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010591f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105923:	89 54 24 04          	mov    %edx,0x4(%esp)
80105927:	89 04 24             	mov    %eax,(%esp)
8010592a:	e8 23 b8 ff ff       	call   80101152 <fileread>
}
8010592f:	c9                   	leave  
80105930:	c3                   	ret    
...
8010594d:	e8 4a fe ff ff       	call   8010579c <argfd>
80105952:	85 c0                	test   %eax,%eax
80105954:	78 35                	js     8010598b <sys_write+0x5a>
80105956:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105959:	89 44 24 04          	mov    %eax,0x4(%esp)
8010595d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105964:	e8 dd fc ff ff       	call   80105646 <argint>
80105969:	85 c0                	test   %eax,%eax
8010596b:	78 1e                	js     8010598b <sys_write+0x5a>
8010596d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105970:	89 44 24 08          	mov    %eax,0x8(%esp)
80105974:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105977:	89 44 24 04          	mov    %eax,0x4(%esp)
8010597b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105982:	e8 ec fc ff ff       	call   80105673 <argptr>
80105987:	85 c0                	test   %eax,%eax
80105989:	79 07                	jns    80105992 <sys_write+0x61>
    return -1;
8010598b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105990:	eb 19                	jmp    801059ab <sys_write+0x7a>
  return filewrite(f, p, n);
80105992:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105995:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105998:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010599b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010599f:	89 54 24 04          	mov    %edx,0x4(%esp)
801059a3:	89 04 24             	mov    %eax,(%esp)
801059a6:	e8 63 b8 ff ff       	call   8010120e <filewrite>
}
801059ab:	c9                   	leave  
801059ac:	c3                   	ret    
...
801059c8:	e8 cf fd ff ff       	call   8010579c <argfd>
801059cd:	85 c0                	test   %eax,%eax
801059cf:	79 07                	jns    801059d8 <sys_close+0x2b>
    return -1;
801059d1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059d6:	eb 23                	jmp    801059fb <sys_close+0x4e>
  myproc()->ofile[fd] = 0;
801059d8:	e8 a8 e7 ff ff       	call   80104185 <myproc>
801059dd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059e0:	83 c2 08             	add    $0x8,%edx
801059e3:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801059ea:	00 
  fileclose(f);
801059eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059ee:	89 04 24             	mov    %eax,(%esp)
801059f1:	e8 37 b6 ff ff       	call   8010102d <fileclose>
  return 0;
801059f6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801059fb:	c9                   	leave  
801059fc:	c3                   	ret    
...
80105a03:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a06:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a0a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a11:	00 
80105a12:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a19:	e8 7e fd ff ff       	call   8010579c <argfd>
80105a1e:	85 c0                	test   %eax,%eax
80105a20:	78 1f                	js     80105a41 <sys_fstat+0x44>
80105a22:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105a29:	00 
80105a2a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105a2d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a38:	e8 36 fc ff ff       	call   80105673 <argptr>
80105a3d:	85 c0                	test   %eax,%eax
80105a3f:	79 07                	jns    80105a48 <sys_fstat+0x4b>
    return -1;
80105a41:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a46:	eb 12                	jmp    80105a5a <sys_fstat+0x5d>
  return filestat(f, st);
80105a48:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a4e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a52:	89 04 24             	mov    %eax,(%esp)
80105a55:	e8 a9 b6 ff ff       	call   80101103 <filestat>
}
80105a5a:	c9                   	leave  
80105a5b:	c3                   	ret    
...
80105a5f:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105a62:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105a65:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a69:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a70:	e8 68 fc ff ff       	call   801056dd <argstr>
80105a75:	85 c0                	test   %eax,%eax
80105a77:	78 17                	js     80105a90 <sys_link+0x34>
80105a79:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105a7c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a80:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a87:	e8 51 fc ff ff       	call   801056dd <argstr>
80105a8c:	85 c0                	test   %eax,%eax
80105a8e:	79 0a                	jns    80105a9a <sys_link+0x3e>
    return -1;
80105a90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a95:	e9 42 01 00 00       	jmp    80105bdc <sys_link+0x180>

  begin_op();
80105a9a:	e8 e8 d9 ff ff       	call   80103487 <begin_op>
  if((ip = namei(old)) == 0){
80105a9f:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105aa2:	89 04 24             	mov    %eax,(%esp)
80105aa5:	e8 ed c9 ff ff       	call   80102497 <namei>
80105aaa:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105aad:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ab1:	75 0f                	jne    80105ac2 <sys_link+0x66>
    end_op();
80105ab3:	e8 53 da ff ff       	call   8010350b <end_op>
    return -1;
80105ab8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abd:	e9 1a 01 00 00       	jmp    80105bdc <sys_link+0x180>
  }
...
80105ad0:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105ad4:	66 83 f8 01          	cmp    $0x1,%ax
80105ad8:	75 1a                	jne    80105af4 <sys_link+0x98>
    iunlockput(ip);
80105ada:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105add:	89 04 24             	mov    %eax,(%esp)
80105ae0:	e8 7a c0 ff ff       	call   80101b5f <iunlockput>
    end_op();
80105ae5:	e8 21 da ff ff       	call   8010350b <end_op>
    return -1;
80105aea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aef:	e9 e8 00 00 00       	jmp    80105bdc <sys_link+0x180>
  }

  ip->nlink++;
80105af4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105af7:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105afb:	8d 50 01             	lea    0x1(%eax),%edx
...
80105b16:	e8 4f bf ff ff       	call   80101a6a <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105b1b:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b1e:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105b21:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b25:	89 04 24             	mov    %eax,(%esp)
80105b28:	e8 8c c9 ff ff       	call   801024b9 <nameiparent>
80105b2d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b30:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b34:	75 02                	jne    80105b38 <sys_link+0xdc>
    goto bad;
80105b36:	eb 68                	jmp    80105ba0 <sys_link+0x144>
  ilock(dp);
80105b38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3b:	89 04 24             	mov    %eax,(%esp)
80105b3e:	e8 1a be ff ff       	call   8010195d <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105b43:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b46:	8b 10                	mov    (%eax),%edx
80105b48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b4b:	8b 00                	mov    (%eax),%eax
80105b4d:	39 c2                	cmp    %eax,%edx
80105b4f:	75 20                	jne    80105b71 <sys_link+0x115>
80105b51:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b54:	8b 40 04             	mov    0x4(%eax),%eax
80105b57:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b5b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105b5e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b62:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b65:	89 04 24             	mov    %eax,(%esp)
80105b68:	e8 6b c6 ff ff       	call   801021d8 <dirlink>
80105b6d:	85 c0                	test   %eax,%eax
80105b6f:	79 0d                	jns    80105b7e <sys_link+0x122>
    iunlockput(dp);
80105b71:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b74:	89 04 24             	mov    %eax,(%esp)
80105b77:	e8 e3 bf ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105b7c:	eb 22                	jmp    80105ba0 <sys_link+0x144>
  }
  iunlockput(dp);
80105b7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b81:	89 04 24             	mov    %eax,(%esp)
80105b84:	e8 d6 bf ff ff       	call   80101b5f <iunlockput>
  iput(ip);
80105b89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b8c:	89 04 24             	mov    %eax,(%esp)
80105b8f:	e8 1a bf ff ff       	call   80101aae <iput>

  end_op();
80105b94:	e8 72 d9 ff ff       	call   8010350b <end_op>

  return 0;
80105b99:	b8 00 00 00 00       	mov    $0x0,%eax
80105b9e:	eb 3c                	jmp    80105bdc <sys_link+0x180>

bad:
  ilock(ip);
80105ba0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ba3:	89 04 24             	mov    %eax,(%esp)
80105ba6:	e8 b2 bd ff ff       	call   8010195d <ilock>
  ip->nlink--;
80105bab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bae:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105bb2:	8d 50 ff             	lea    -0x1(%eax),%edx
80105bb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bb8:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105bbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bbf:	89 04 24             	mov    %eax,(%esp)
80105bc2:	e8 d1 bb ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
80105bc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bca:	89 04 24             	mov    %eax,(%esp)
80105bcd:	e8 8d bf ff ff       	call   80101b5f <iunlockput>
  end_op();
80105bd2:	e8 34 d9 ff ff       	call   8010350b <end_op>
  return -1;
...
80105be1:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105be4:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105beb:	eb 4b                	jmp    80105c38 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf0:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105bf7:	00 
80105bf8:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105c09:	e8 ec c1 ff ff       	call   80101dfa <readi>
80105c0e:	83 f8 10             	cmp    $0x10,%eax
80105c11:	74 0c                	je     80105c1f <isdirempty+0x41>
      panic("isdirempty: readi");
80105c13:	c7 04 24 0b 8a 10 80 	movl   $0x80108a0b,(%esp)
80105c1a:	e8 43 a9 ff ff       	call   80100562 <panic>
    if(de.inum != 0)
80105c1f:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105c23:	66 85 c0             	test   %ax,%ax
80105c26:	74 07                	je     80105c2f <isdirempty+0x51>
      return 0;
80105c28:	b8 00 00 00 00       	mov    $0x0,%eax
80105c2d:	eb 1b                	jmp    80105c4a <isdirempty+0x6c>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105c2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c32:	83 c0 10             	add    $0x10,%eax
80105c35:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c38:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c3b:	8b 45 08             	mov    0x8(%ebp),%eax
80105c3e:	8b 40 58             	mov    0x58(%eax),%eax
80105c41:	39 c2                	cmp    %eax,%edx
80105c43:	72 a8                	jb     80105bed <isdirempty+0xf>
  }
  return 1;
...
80105c4f:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105c52:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105c55:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c59:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c60:	e8 78 fa ff ff       	call   801056dd <argstr>
80105c65:	85 c0                	test   %eax,%eax
80105c67:	79 0a                	jns    80105c73 <sys_unlink+0x27>
    return -1;
80105c69:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c6e:	e9 af 01 00 00       	jmp    80105e22 <sys_unlink+0x1d6>

  begin_op();
80105c73:	e8 0f d8 ff ff       	call   80103487 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105c78:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105c7b:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105c7e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c82:	89 04 24             	mov    %eax,(%esp)
80105c85:	e8 2f c8 ff ff       	call   801024b9 <nameiparent>
80105c8a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c8d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c91:	75 0f                	jne    80105ca2 <sys_unlink+0x56>
    end_op();
80105c93:	e8 73 d8 ff ff       	call   8010350b <end_op>
    return -1;
80105c98:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c9d:	e9 80 01 00 00       	jmp    80105e22 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105ca2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ca5:	89 04 24             	mov    %eax,(%esp)
80105ca8:	e8 b0 bc ff ff       	call   8010195d <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105cad:	c7 44 24 04 1d 8a 10 	movl   $0x80108a1d,0x4(%esp)
80105cb4:	80 
80105cb5:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105cb8:	89 04 24             	mov    %eax,(%esp)
80105cbb:	e8 2d c4 ff ff       	call   801020ed <namecmp>
80105cc0:	85 c0                	test   %eax,%eax
80105cc2:	0f 84 45 01 00 00    	je     80105e0d <sys_unlink+0x1c1>
80105cc8:	c7 44 24 04 1f 8a 10 	movl   $0x80108a1f,0x4(%esp)
80105ccf:	80 
80105cd0:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105cd3:	89 04 24             	mov    %eax,(%esp)
80105cd6:	e8 12 c4 ff ff       	call   801020ed <namecmp>
80105cdb:	85 c0                	test   %eax,%eax
80105cdd:	0f 84 2a 01 00 00    	je     80105e0d <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105ce3:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105ce6:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cea:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ced:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cf1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf4:	89 04 24             	mov    %eax,(%esp)
80105cf7:	e8 13 c4 ff ff       	call   8010210f <dirlookup>
80105cfc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d03:	75 05                	jne    80105d0a <sys_unlink+0xbe>
    goto bad;
80105d05:	e9 03 01 00 00       	jmp    80105e0d <sys_unlink+0x1c1>
  ilock(ip);
80105d0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0d:	89 04 24             	mov    %eax,(%esp)
80105d10:	e8 48 bc ff ff       	call   8010195d <ilock>

  if(ip->nlink < 1)
80105d15:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d18:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105d1c:	66 85 c0             	test   %ax,%ax
80105d1f:	7f 0c                	jg     80105d2d <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105d21:	c7 04 24 22 8a 10 80 	movl   $0x80108a22,(%esp)
80105d28:	e8 35 a8 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105d2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d30:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105d34:	66 83 f8 01          	cmp    $0x1,%ax
80105d38:	75 1f                	jne    80105d59 <sys_unlink+0x10d>
80105d3a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d3d:	89 04 24             	mov    %eax,(%esp)
80105d40:	e8 99 fe ff ff       	call   80105bde <isdirempty>
80105d45:	85 c0                	test   %eax,%eax
80105d47:	75 10                	jne    80105d59 <sys_unlink+0x10d>
    iunlockput(ip);
80105d49:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4c:	89 04 24             	mov    %eax,(%esp)
80105d4f:	e8 0b be ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105d54:	e9 b4 00 00 00       	jmp    80105e0d <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105d59:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105d60:	00 
80105d61:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d68:	00 
80105d69:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105d6c:	89 04 24             	mov    %eax,(%esp)
80105d6f:	e8 89 f5 ff ff       	call   801052fd <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105d74:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105d77:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105d7e:	00 
...
80105d90:	e8 c9 c1 ff ff       	call   80101f5e <writei>
80105d95:	83 f8 10             	cmp    $0x10,%eax
80105d98:	74 0c                	je     80105da6 <sys_unlink+0x15a>
    panic("unlink: writei");
80105d9a:	c7 04 24 34 8a 10 80 	movl   $0x80108a34,(%esp)
80105da1:	e8 bc a7 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR){
80105da6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105da9:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105dad:	66 83 f8 01          	cmp    $0x1,%ax
80105db1:	75 1c                	jne    80105dcf <sys_unlink+0x183>
    dp->nlink--;
80105db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105db6:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105dba:	8d 50 ff             	lea    -0x1(%eax),%edx
80105dbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc0:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105dc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc7:	89 04 24             	mov    %eax,(%esp)
80105dca:	e8 c9 b9 ff ff       	call   80101798 <iupdate>
  }
  iunlockput(dp);
80105dcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dd2:	89 04 24             	mov    %eax,(%esp)
80105dd5:	e8 85 bd ff ff       	call   80101b5f <iunlockput>

  ip->nlink--;
80105dda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ddd:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105de1:	8d 50 ff             	lea    -0x1(%eax),%edx
80105de4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de7:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105deb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dee:	89 04 24             	mov    %eax,(%esp)
80105df1:	e8 a2 b9 ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
...
80105dfc:	e8 5e bd ff ff       	call   80101b5f <iunlockput>
  ...
  end_op();
80105e01:	e8 05 d7 ff ff       	call   8010350b <end_op>

  return 0;
80105e06:	b8 00 00 00 00       	mov    $0x0,%eax
80105e0b:	eb 15                	jmp    80105e22 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105e0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e10:	89 04 24             	mov    %eax,(%esp)
80105e13:	e8 47 bd ff ff       	call   80101b5f <iunlockput>
  end_op();
80105e18:	e8 ee d6 ff ff       	call   8010350b <end_op>
  return -1;
...
80105e27:	83 ec 48             	sub    $0x48,%esp
...
80105e4c:	e8 68 c6 ff ff       	call   801024b9 <nameiparent>
...
80105e5f:	e9 7e 01 00 00       	jmp    80105fe2 <create+0x1be>
  ilock(dp);
80105e64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e67:	89 04 24             	mov    %eax,(%esp)
80105e6a:	e8 ee ba ff ff       	call   8010195d <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105e6f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e72:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e76:	8d 45 de             	lea    -0x22(%ebp),%eax
80105e79:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e80:	89 04 24             	mov    %eax,(%esp)
80105e83:	e8 87 c2 ff ff       	call   8010210f <dirlookup>
80105e88:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e8b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e8f:	74 47                	je     80105ed8 <create+0xb4>
    iunlockput(dp);
80105e91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e94:	89 04 24             	mov    %eax,(%esp)
80105e97:	e8 c3 bc ff ff       	call   80101b5f <iunlockput>
    ilock(ip);
80105e9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e9f:	89 04 24             	mov    %eax,(%esp)
80105ea2:	e8 b6 ba ff ff       	call   8010195d <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105ea7:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105eac:	75 15                	jne    80105ec3 <create+0x9f>
80105eae:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eb1:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105eb5:	66 83 f8 02          	cmp    $0x2,%ax
80105eb9:	75 08                	jne    80105ec3 <create+0x9f>
      return ip;
80105ebb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ebe:	e9 1f 01 00 00       	jmp    80105fe2 <create+0x1be>
    iunlockput(ip);
80105ec3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec6:	89 04 24             	mov    %eax,(%esp)
80105ec9:	e8 91 bc ff ff       	call   80101b5f <iunlockput>
    return 0;
80105ece:	b8 00 00 00 00       	mov    $0x0,%eax
80105ed3:	e9 0a 01 00 00       	jmp    80105fe2 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105ed8:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105edc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105edf:	8b 00                	mov    (%eax),%eax
80105ee1:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ee5:	89 04 24             	mov    %eax,(%esp)
80105ee8:	e8 d6 b7 ff ff       	call   801016c3 <ialloc>
80105eed:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ef0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ef4:	75 0c                	jne    80105f02 <create+0xde>
    panic("create: ialloc");
80105ef6:	c7 04 24 43 8a 10 80 	movl   $0x80108a43,(%esp)
80105efd:	e8 60 a6 ff ff       	call   80100562 <panic>

  ilock(ip);
80105f02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f05:	89 04 24             	mov    %eax,(%esp)
80105f08:	e8 50 ba ff ff       	call   8010195d <ilock>
  ip->major = major;
80105f0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f10:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105f14:	66 89 50 52          	mov    %dx,0x52(%eax)
  ip->minor = minor;
80105f18:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f1b:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105f1f:	66 89 50 54          	mov    %dx,0x54(%eax)
  ip->nlink = 1;
80105f23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f26:	66 c7 40 56 01 00    	movw   $0x1,0x56(%eax)
  iupdate(ip);
80105f2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2f:	89 04 24             	mov    %eax,(%esp)
80105f32:	e8 61 b8 ff ff       	call   80101798 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105f37:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105f3c:	75 6a                	jne    80105fa8 <create+0x184>
    dp->nlink++;  // for ".."
80105f3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f41:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105f45:	8d 50 01             	lea    0x1(%eax),%edx
80105f48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4b:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105f4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f52:	89 04 24             	mov    %eax,(%esp)
80105f55:	e8 3e b8 ff ff       	call   80101798 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105f5a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f5d:	8b 40 04             	mov    0x4(%eax),%eax
80105f60:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f64:	c7 44 24 04 1d 8a 10 	movl   $0x80108a1d,0x4(%esp)
80105f6b:	80 
80105f6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f6f:	89 04 24             	mov    %eax,(%esp)
80105f72:	e8 61 c2 ff ff       	call   801021d8 <dirlink>
80105f77:	85 c0                	test   %eax,%eax
80105f79:	78 21                	js     80105f9c <create+0x178>
80105f7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f7e:	8b 40 04             	mov    0x4(%eax),%eax
80105f81:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f85:	c7 44 24 04 1f 8a 10 	movl   $0x80108a1f,0x4(%esp)
80105f8c:	80 
80105f8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f90:	89 04 24             	mov    %eax,(%esp)
80105f93:	e8 40 c2 ff ff       	call   801021d8 <dirlink>
80105f98:	85 c0                	test   %eax,%eax
80105f9a:	79 0c                	jns    80105fa8 <create+0x184>
      panic("create dots");
80105f9c:	c7 04 24 52 8a 10 80 	movl   $0x80108a52,(%esp)
80105fa3:	e8 ba a5 ff ff       	call   80100562 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105fa8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fab:	8b 40 04             	mov    0x4(%eax),%eax
80105fae:	89 44 24 08          	mov    %eax,0x8(%esp)
80105fb2:	8d 45 de             	lea    -0x22(%ebp),%eax
80105fb5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fbc:	89 04 24             	mov    %eax,(%esp)
80105fbf:	e8 14 c2 ff ff       	call   801021d8 <dirlink>
80105fc4:	85 c0                	test   %eax,%eax
80105fc6:	79 0c                	jns    80105fd4 <create+0x1b0>
    panic("create: dirlink");
80105fc8:	c7 04 24 5e 8a 10 80 	movl   $0x80108a5e,(%esp)
80105fcf:	e8 8e a5 ff ff       	call   80100562 <panic>

  iunlockput(dp);
80105fd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd7:	89 04 24             	mov    %eax,(%esp)
80105fda:	e8 80 bb ff ff       	call   80101b5f <iunlockput>
...
80105fe7:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105fea:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105fed:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ff1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ff8:	e8 e0 f6 ff ff       	call   801056dd <argstr>
80105ffd:	85 c0                	test   %eax,%eax
80105fff:	78 17                	js     80106018 <sys_open+0x34>
80106001:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106004:	89 44 24 04          	mov    %eax,0x4(%esp)
80106008:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010600f:	e8 32 f6 ff ff       	call   80105646 <argint>
80106014:	85 c0                	test   %eax,%eax
80106016:	79 0a                	jns    80106022 <sys_open+0x3e>
    return -1;
80106018:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010601d:	e9 5c 01 00 00       	jmp    8010617e <sys_open+0x19a>

  begin_op();
80106022:	e8 60 d4 ff ff       	call   80103487 <begin_op>

  if(omode & O_CREATE){
80106027:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010602a:	25 00 02 00 00       	and    $0x200,%eax
8010602f:	85 c0                	test   %eax,%eax
80106031:	74 3b                	je     8010606e <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80106033:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106036:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010603d:	00 
8010603e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106045:	00 
80106046:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010604d:	00 
8010604e:	89 04 24             	mov    %eax,(%esp)
80106051:	e8 ce fd ff ff       	call   80105e24 <create>
80106056:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106059:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010605d:	75 6b                	jne    801060ca <sys_open+0xe6>
      end_op();
8010605f:	e8 a7 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106064:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106069:	e9 10 01 00 00       	jmp    8010617e <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
8010606e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106071:	89 04 24             	mov    %eax,(%esp)
80106074:	e8 1e c4 ff ff       	call   80102497 <namei>
80106079:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010607c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106080:	75 0f                	jne    80106091 <sys_open+0xad>
      end_op();
80106082:	e8 84 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106087:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010608c:	e9 ed 00 00 00       	jmp    8010617e <sys_open+0x19a>
    }
    ilock(ip);
80106091:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106094:	89 04 24             	mov    %eax,(%esp)
80106097:	e8 c1 b8 ff ff       	call   8010195d <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010609c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010609f:	0f b7 40 50          	movzwl 0x50(%eax),%eax
801060a3:	66 83 f8 01          	cmp    $0x1,%ax
801060a7:	75 21                	jne    801060ca <sys_open+0xe6>
801060a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801060ac:	85 c0                	test   %eax,%eax
801060ae:	74 1a                	je     801060ca <sys_open+0xe6>
      iunlockput(ip);
801060b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060b3:	89 04 24             	mov    %eax,(%esp)
801060b6:	e8 a4 ba ff ff       	call   80101b5f <iunlockput>
      end_op();
801060bb:	e8 4b d4 ff ff       	call   8010350b <end_op>
      return -1;
801060c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060c5:	e9 b4 00 00 00       	jmp    8010617e <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
801060ca:	e8 b6 ae ff ff       	call   80100f85 <filealloc>
801060cf:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060d2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060d6:	74 14                	je     801060ec <sys_open+0x108>
801060d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060db:	89 04 24             	mov    %eax,(%esp)
801060de:	e8 2d f7 ff ff       	call   80105810 <fdalloc>
801060e3:	89 45 ec             	mov    %eax,-0x14(%ebp)
801060e6:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801060ea:	79 28                	jns    80106114 <sys_open+0x130>
    if(f)
801060ec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060f0:	74 0b                	je     801060fd <sys_open+0x119>
      fileclose(f);
801060f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f5:	89 04 24             	mov    %eax,(%esp)
801060f8:	e8 30 af ff ff       	call   8010102d <fileclose>
    iunlockput(ip);
801060fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106100:	89 04 24             	mov    %eax,(%esp)
80106103:	e8 57 ba ff ff       	call   80101b5f <iunlockput>
    end_op();
80106108:	e8 fe d3 ff ff       	call   8010350b <end_op>
    return -1;
8010610d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106112:	eb 6a                	jmp    8010617e <sys_open+0x19a>
  }
  iunlock(ip);
80106114:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106117:	89 04 24             	mov    %eax,(%esp)
8010611a:	e8 4b b9 ff ff       	call   80101a6a <iunlock>
  end_op();
8010611f:	e8 e7 d3 ff ff       	call   8010350b <end_op>

  f->type = FD_INODE;
80106124:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106127:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010612d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106130:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106133:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106136:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106139:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106140:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106143:	83 e0 01             	and    $0x1,%eax
80106146:	85 c0                	test   %eax,%eax
80106148:	0f 94 c0             	sete   %al
8010614b:	89 c2                	mov    %eax,%edx
8010614d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106150:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106153:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106156:	83 e0 01             	and    $0x1,%eax
80106159:	85 c0                	test   %eax,%eax
8010615b:	75 0a                	jne    80106167 <sys_open+0x183>
8010615d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106160:	83 e0 02             	and    $0x2,%eax
80106163:	85 c0                	test   %eax,%eax
80106165:	74 07                	je     8010616e <sys_open+0x18a>
80106167:	b8 01 00 00 00       	mov    $0x1,%eax
8010616c:	eb 05                	jmp    80106173 <sys_open+0x18f>
8010616e:	b8 00 00 00 00       	mov    $0x0,%eax
80106173:	89 c2                	mov    %eax,%edx
80106175:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106178:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80106183:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106186:	e8 fc d2 ff ff       	call   80103487 <begin_op>
...
80106199:	e8 3f f5 ff ff       	call   801056dd <argstr>
8010619e:	85 c0                	test   %eax,%eax
801061a0:	78 2c                	js     801061ce <sys_mkdir+0x4e>
801061a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801061ac:	00 
801061ad:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801061b4:	00 
801061b5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801061bc:	00 
801061bd:	89 04 24             	mov    %eax,(%esp)
801061c0:	e8 5f fc ff ff       	call   80105e24 <create>
801061c5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061c8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061cc:	75 0c                	jne    801061da <sys_mkdir+0x5a>
    end_op();
801061ce:	e8 38 d3 ff ff       	call   8010350b <end_op>
    return -1;
801061d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061d8:	eb 15                	jmp    801061ef <sys_mkdir+0x6f>
  }
  iunlockput(ip);
801061da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061dd:	89 04 24             	mov    %eax,(%esp)
801061e0:	e8 7a b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
801061e5:	e8 21 d3 ff ff       	call   8010350b <end_op>
  return 0;
...
801061f4:	83 ec 28             	sub    $0x28,%esp
  struct inode *ip;
  char *path;
  int major, minor;
...
801061f7:	e8 8b d2 ff ff       	call   80103487 <begin_op>
  if((argstr(0, &path)) < 0 ||
801061fc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801061ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106203:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010620a:	e8 ce f4 ff ff       	call   801056dd <argstr>
8010620f:	85 c0                	test   %eax,%eax
80106211:	78 5e                	js     80106271 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80106213:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106216:	89 44 24 04          	mov    %eax,0x4(%esp)
8010621a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106221:	e8 20 f4 ff ff       	call   80105646 <argint>
  if((argstr(0, &path)) < 0 ||
80106226:	85 c0                	test   %eax,%eax
80106228:	78 47                	js     80106271 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
8010622a:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010622d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106231:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106238:	e8 09 f4 ff ff       	call   80105646 <argint>
     argint(1, &major) < 0 ||
8010623d:	85 c0                	test   %eax,%eax
8010623f:	78 30                	js     80106271 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106241:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106244:	0f bf c8             	movswl %ax,%ecx
80106247:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010624a:	0f bf d0             	movswl %ax,%edx
8010624d:	8b 45 f0             	mov    -0x10(%ebp),%eax
     argint(2, &minor) < 0 ||
80106250:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106254:	89 54 24 08          	mov    %edx,0x8(%esp)
80106258:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010625f:	00 
80106260:	89 04 24             	mov    %eax,(%esp)
80106263:	e8 bc fb ff ff       	call   80105e24 <create>
80106268:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010626b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010626f:	75 0c                	jne    8010627d <sys_mknod+0x8c>
    end_op();
80106271:	e8 95 d2 ff ff       	call   8010350b <end_op>
    return -1;
80106276:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010627b:	eb 15                	jmp    80106292 <sys_mknod+0xa1>
  }
  iunlockput(ip);
8010627d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106280:	89 04 24             	mov    %eax,(%esp)
80106283:	e8 d7 b8 ff ff       	call   80101b5f <iunlockput>
  end_op();
80106288:	e8 7e d2 ff ff       	call   8010350b <end_op>
  return 0;
...
80106352:	e8 86 f3 ff ff       	call   801056dd <argstr>
...
8010636c:	e8 d5 f2 ff ff       	call   80105646 <argint>
...
80106398:	e8 60 ef ff ff       	call   801052fd <memset>
  for(i=0;; i++){
...
801063d3:	e8 cb f1 ff ff       	call   801055a3 <fetchint>
...
8010640c:	e8 0d a7 ff ff       	call   80100b1e <exec>
...
8010642e:	e8 af f1 ff ff       	call   801055e2 <fetchstr>
...
801064a2:	e8 69 f3 ff ff       	call   80105810 <fdalloc>
...
801064b6:	e8 55 f3 ff ff       	call   80105810 <fdalloc>
801064bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064be:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064c2:	79 36                	jns    801064fa <sys_pipe+0xb1>
    if(fd0 >= 0)
801064c4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064c8:	78 13                	js     801064dd <sys_pipe+0x94>
      myproc()->ofile[fd0] = 0;
801064ca:	e8 b6 dc ff ff       	call   80104185 <myproc>
801064cf:	8b 55 f4             	mov    -0xc(%ebp),%edx
801064d2:	83 c2 08             	add    $0x8,%edx
801064d5:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801064dc:	00 
    fileclose(rf);
801064dd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064e0:	89 04 24             	mov    %eax,(%esp)
801064e3:	e8 45 ab ff ff       	call   8010102d <fileclose>
    fileclose(wf);
801064e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064eb:	89 04 24             	mov    %eax,(%esp)
801064ee:	e8 3a ab ff ff       	call   8010102d <fileclose>
    return -1;
801064f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064f8:	eb 18                	jmp    80106512 <sys_pipe+0xc9>
  }
  fd[0] = fd0;
801064fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
801064fd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106500:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106502:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106505:	8d 50 04             	lea    0x4(%eax),%edx
80106508:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010650b:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106517:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010651a:	e8 7e df ff ff       	call   8010449d <fork>
}
8010651f:	c9                   	leave  
80106520:	c3                   	ret    
...
80106524:	83 ec 08             	sub    $0x8,%esp
  exit();
80106527:	e8 06 e1 ff ff       	call   80104632 <exit>
...
80106536:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106539:	e8 01 e2 ff ff       	call   8010473f <wait>
}
8010653e:	c9                   	leave  
8010653f:	c3                   	ret    
...
80106543:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0)
80106546:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106549:	89 44 24 04          	mov    %eax,0x4(%esp)
8010654d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106554:	e8 ed f0 ff ff       	call   80105646 <argint>
80106559:	85 c0                	test   %eax,%eax
8010655b:	79 07                	jns    80106564 <sys_kill+0x24>
    return -1;
8010655d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106562:	eb 0b                	jmp    8010656f <sys_kill+0x2f>
  return kill(pid);
80106564:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106567:	89 04 24             	mov    %eax,(%esp)
8010656a:	e8 43 e6 ff ff       	call   80104bb2 <kill>
}
8010656f:	c9                   	leave  
80106570:	c3                   	ret    
...
80106574:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106577:	e8 09 dc ff ff       	call   80104185 <myproc>
8010657c:	8b 40 10             	mov    0x10(%eax),%eax
}
8010657f:	c9                   	leave  
80106580:	c3                   	ret    
...
80106595:	e8 ac f0 ff ff       	call   80105646 <argint>
8010659a:	85 c0                	test   %eax,%eax
8010659c:	79 07                	jns    801065a5 <sys_sbrk+0x24>
    return -1;
8010659e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065a3:	eb 23                	jmp    801065c8 <sys_sbrk+0x47>
  addr = myproc()->sz;
801065a5:	e8 db db ff ff       	call   80104185 <myproc>
...
801065b5:	e8 45 de ff ff       	call   801043ff <growproc>
801065ba:	85 c0                	test   %eax,%eax
801065bc:	79 07                	jns    801065c5 <sys_sbrk+0x44>
    return -1;
801065be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065c3:	eb 03                	jmp    801065c8 <sys_sbrk+0x47>
  return addr;
...
801065de:	e8 63 f0 ff ff       	call   80105646 <argint>
801065e3:	85 c0                	test   %eax,%eax
801065e5:	79 07                	jns    801065ee <sys_sleep+0x24>
    return -1;
801065e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065ec:	eb 6b                	jmp    80106659 <sys_sleep+0x8f>
  acquire(&tickslock);
801065ee:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
801065f5:	e8 91 ea ff ff       	call   8010508b <acquire>
  ticks0 = ticks;
801065fa:	a1 40 67 11 80       	mov    0x80116740,%eax
801065ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106602:	eb 33                	jmp    80106637 <sys_sleep+0x6d>
    if(myproc()->killed){
80106604:	e8 7c db ff ff       	call   80104185 <myproc>
80106609:	8b 40 24             	mov    0x24(%eax),%eax
8010660c:	85 c0                	test   %eax,%eax
8010660e:	74 13                	je     80106623 <sys_sleep+0x59>
      release(&tickslock);
80106610:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106617:	e8 d7 ea ff ff       	call   801050f3 <release>
      return -1;
8010661c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106621:	eb 36                	jmp    80106659 <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
80106623:	c7 44 24 04 00 5f 11 	movl   $0x80115f00,0x4(%esp)
8010662a:	80 
8010662b:	c7 04 24 40 67 11 80 	movl   $0x80116740,(%esp)
80106632:	e8 79 e4 ff ff       	call   80104ab0 <sleep>
  while(ticks - ticks0 < n){
80106637:	a1 40 67 11 80       	mov    0x80116740,%eax
8010663c:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010663f:	89 c2                	mov    %eax,%edx
80106641:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106644:	39 c2                	cmp    %eax,%edx
80106646:	72 bc                	jb     80106604 <sys_sleep+0x3a>
  }
  release(&tickslock);
80106648:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
8010664f:	e8 9f ea ff ff       	call   801050f3 <release>
  return 0;
...
8010665e:	83 ec 28             	sub    $0x28,%esp
  uint xticks;

  acquire(&tickslock);
80106661:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106668:	e8 1e ea ff ff       	call   8010508b <acquire>
  xticks = ticks;
8010666d:	a1 40 67 11 80       	mov    0x80116740,%eax
80106672:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106675:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
8010667c:	e8 72 ea ff ff       	call   801050f3 <release>
  return xticks;
...
8010668c:	c7 44 24 08 00 09 00 	movl   $0x900,0x8(%esp)
80106693:	00 
80106694:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106697:	89 44 24 04          	mov    %eax,0x4(%esp)
8010669b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066a2:	e8 cc ef ff ff       	call   80105673 <argptr>
801066a7:	85 c0                	test   %eax,%eax
801066a9:	79 07                	jns    801066b2 <sys_getpinfo+0x2c>
    return -1;
801066ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b0:	eb 10                	jmp    801066c2 <sys_getpinfo+0x3c>
  fillTable(temp);
801066b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b5:	89 04 24             	mov    %eax,(%esp)
801066b8:	e8 6a e6 ff ff       	call   80104d27 <fillTable>
...
801066d8:	e8 69 ef ff ff       	call   80105646 <argint>
801066dd:	85 c0                	test   %eax,%eax
801066df:	79 07                	jns    801066e8 <sys_settickets+0x24>
    return -1;
801066e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066e6:	eb 25                	jmp    8010670d <sys_settickets+0x49>
  if(tickets < 10)
801066e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801066eb:	83 f8 09             	cmp    $0x9,%eax
801066ee:	7f 07                	jg     801066f7 <sys_settickets+0x33>
    return -1;
801066f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066f5:	eb 16                	jmp    8010670d <sys_settickets+0x49>
  struct proc *p = myproc();
801066f7:	e8 89 da ff ff       	call   80104185 <myproc>
801066fc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  p->tickets = tickets;
801066ff:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106702:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106705:	89 50 7c             	mov    %edx,0x7c(%eax)
  return 0;
...
80106710:	06                   	push   %es
  pushl %fs
80106711:	0f a0                	push   %fs
  pushl %gs
80106713:	0f a8                	push   %gs
  pushal
80106715:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80106716:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010671a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010671c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010671e:	54                   	push   %esp
  call trap
8010671f:	e8 d8 01 00 00       	call   801068fc <trap>
  addl $4, %esp
80106724:	83 c4 04             	add    $0x4,%esp
...
80106727:	61                   	popa   
  popl %gs
80106728:	0f a9                	pop    %gs
  popl %fs
8010672a:	0f a1                	pop    %fs
  popl %es
8010672c:	07                   	pop    %es
  popl %ds
8010672d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010672e:	83 c4 08             	add    $0x8,%esp
  iret
80106731:	cf                   	iret   
...
8010673b:	83 e8 01             	sub    $0x1,%eax
8010673e:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106742:	8b 45 08             	mov    0x8(%ebp),%eax
80106745:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106749:	8b 45 08             	mov    0x8(%ebp),%eax
8010674c:	c1 e8 10             	shr    $0x10,%eax
8010674f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106753:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106756:	0f 01 18             	lidtl  (%eax)
}
80106759:	c9                   	leave  
8010675a:	c3                   	ret    
...
8010678d:	66 89 14 c5 40 5f 11 	mov    %dx,-0x7feea0c0(,%eax,8)
80106794:	80 
80106795:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106798:	66 c7 04 c5 42 5f 11 	movw   $0x8,-0x7feea0be(,%eax,8)
8010679f:	80 08 00 
801067a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067a5:	0f b6 14 c5 44 5f 11 	movzbl -0x7feea0bc(,%eax,8),%edx
801067ac:	80 
801067ad:	83 e2 e0             	and    $0xffffffe0,%edx
801067b0:	88 14 c5 44 5f 11 80 	mov    %dl,-0x7feea0bc(,%eax,8)
801067b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067ba:	0f b6 14 c5 44 5f 11 	movzbl -0x7feea0bc(,%eax,8),%edx
801067c1:	80 
801067c2:	83 e2 1f             	and    $0x1f,%edx
801067c5:	88 14 c5 44 5f 11 80 	mov    %dl,-0x7feea0bc(,%eax,8)
801067cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067cf:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
801067d6:	80 
801067d7:	83 e2 f0             	and    $0xfffffff0,%edx
801067da:	83 ca 0e             	or     $0xe,%edx
801067dd:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
801067e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067e7:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
801067ee:	80 
801067ef:	83 e2 ef             	and    $0xffffffef,%edx
801067f2:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
801067f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067fc:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
80106803:	80 
80106804:	83 e2 9f             	and    $0xffffff9f,%edx
80106807:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
8010680e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106811:	0f b6 14 c5 45 5f 11 	movzbl -0x7feea0bb(,%eax,8),%edx
80106818:	80 
80106819:	83 ca 80             	or     $0xffffff80,%edx
8010681c:	88 14 c5 45 5f 11 80 	mov    %dl,-0x7feea0bb(,%eax,8)
...
80106835:	66 89 14 c5 46 5f 11 	mov    %dx,-0x7feea0ba(,%eax,8)
8010683c:	80 
  for(i = 0; i < 256; i++)
...
80106853:	66 a3 40 61 11 80    	mov    %ax,0x80116140
80106859:	66 c7 05 42 61 11 80 	movw   $0x8,0x80116142
80106860:	08 00 
80106862:	0f b6 05 44 61 11 80 	movzbl 0x80116144,%eax
80106869:	83 e0 e0             	and    $0xffffffe0,%eax
8010686c:	a2 44 61 11 80       	mov    %al,0x80116144
80106871:	0f b6 05 44 61 11 80 	movzbl 0x80116144,%eax
80106878:	83 e0 1f             	and    $0x1f,%eax
8010687b:	a2 44 61 11 80       	mov    %al,0x80116144
80106880:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106887:	83 c8 0f             	or     $0xf,%eax
8010688a:	a2 45 61 11 80       	mov    %al,0x80116145
8010688f:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
80106896:	83 e0 ef             	and    $0xffffffef,%eax
80106899:	a2 45 61 11 80       	mov    %al,0x80116145
8010689e:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
801068a5:	83 c8 60             	or     $0x60,%eax
801068a8:	a2 45 61 11 80       	mov    %al,0x80116145
801068ad:	0f b6 05 45 61 11 80 	movzbl 0x80116145,%eax
801068b4:	83 c8 80             	or     $0xffffff80,%eax
801068b7:	a2 45 61 11 80       	mov    %al,0x80116145
801068bc:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
801068c1:	c1 e8 10             	shr    $0x10,%eax
801068c4:	66 a3 46 61 11 80    	mov    %ax,0x80116146

  initlock(&tickslock, "time");
801068ca:	c7 44 24 04 70 8a 10 	movl   $0x80108a70,0x4(%esp)
801068d1:	80 
801068d2:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
801068d9:	e8 8c e7 ff ff       	call   8010506a <initlock>
}
801068de:	c9                   	leave  
801068df:	c3                   	ret    
...
801068e3:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801068e6:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801068ed:	00 
801068ee:	c7 04 24 40 5f 11 80 	movl   $0x80115f40,(%esp)
801068f5:	e8 38 fe ff ff       	call   80106732 <lidt>
}
801068fa:	c9                   	leave  
801068fb:	c3                   	ret    
...
80106902:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106905:	8b 45 08             	mov    0x8(%ebp),%eax
80106908:	8b 40 30             	mov    0x30(%eax),%eax
8010690b:	83 f8 40             	cmp    $0x40,%eax
8010690e:	75 3c                	jne    8010694c <trap+0x50>
    if(myproc()->killed)
80106910:	e8 70 d8 ff ff       	call   80104185 <myproc>
80106915:	8b 40 24             	mov    0x24(%eax),%eax
80106918:	85 c0                	test   %eax,%eax
8010691a:	74 05                	je     80106921 <trap+0x25>
      exit();
8010691c:	e8 11 dd ff ff       	call   80104632 <exit>
    myproc()->tf = tf;
80106921:	e8 5f d8 ff ff       	call   80104185 <myproc>
80106926:	8b 55 08             	mov    0x8(%ebp),%edx
80106929:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010692c:	e8 e3 ed ff ff       	call   80105714 <syscall>
    if(myproc()->killed)
80106931:	e8 4f d8 ff ff       	call   80104185 <myproc>
80106936:	8b 40 24             	mov    0x24(%eax),%eax
80106939:	85 c0                	test   %eax,%eax
8010693b:	74 0a                	je     80106947 <trap+0x4b>
      exit();
8010693d:	e8 f0 dc ff ff       	call   80104632 <exit>
    return;
80106942:	e9 19 02 00 00       	jmp    80106b60 <trap+0x264>
80106947:	e9 14 02 00 00       	jmp    80106b60 <trap+0x264>
  }
...
80106958:	0f 87 b1 00 00 00    	ja     80106a0f <trap+0x113>
8010695e:	8b 04 85 18 8b 10 80 	mov    -0x7fef74e8(,%eax,4),%eax
80106965:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106967:	e8 82 d7 ff ff       	call   801040ee <cpuid>
8010696c:	85 c0                	test   %eax,%eax
8010696e:	75 31                	jne    801069a1 <trap+0xa5>
      acquire(&tickslock);
80106970:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
80106977:	e8 0f e7 ff ff       	call   8010508b <acquire>
      ticks++;
8010697c:	a1 40 67 11 80       	mov    0x80116740,%eax
80106981:	83 c0 01             	add    $0x1,%eax
80106984:	a3 40 67 11 80       	mov    %eax,0x80116740
      wakeup(&ticks);
80106989:	c7 04 24 40 67 11 80 	movl   $0x80116740,(%esp)
80106990:	e8 f2 e1 ff ff       	call   80104b87 <wakeup>
      release(&tickslock);
80106995:	c7 04 24 00 5f 11 80 	movl   $0x80115f00,(%esp)
8010699c:	e8 52 e7 ff ff       	call   801050f3 <release>
    }
    lapiceoi();
801069a1:	e8 ab c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069a6:	e9 37 01 00 00       	jmp    80106ae2 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801069ab:	e8 18 be ff ff       	call   801027c8 <ideintr>
    lapiceoi();
801069b0:	e8 9c c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069b5:	e9 28 01 00 00       	jmp    80106ae2 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801069ba:	e8 a7 c3 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
801069bf:	e8 8d c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069c4:	e9 19 01 00 00       	jmp    80106ae2 <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801069c9:	e8 7b 03 00 00       	call   80106d49 <uartintr>
    lapiceoi();
801069ce:	e8 7e c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069d3:	e9 0a 01 00 00       	jmp    80106ae2 <trap+0x1e6>
  case T_IRQ0 + 7:
...
801069e1:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801069e5:	0f b7 d8             	movzwl %ax,%ebx
801069e8:	e8 01 d7 ff ff       	call   801040ee <cpuid>
801069ed:	89 74 24 0c          	mov    %esi,0xc(%esp)
801069f1:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801069f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f9:	c7 04 24 78 8a 10 80 	movl   $0x80108a78,(%esp)
80106a00:	e8 c3 99 ff ff       	call   801003c8 <cprintf>
    lapiceoi();
80106a05:	e8 47 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106a0a:	e9 d3 00 00 00       	jmp    80106ae2 <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
80106a0f:	e8 71 d7 ff ff       	call   80104185 <myproc>
80106a14:	85 c0                	test   %eax,%eax
80106a16:	74 11                	je     80106a29 <trap+0x12d>
...
80106a27:	75 40                	jne    80106a69 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106a29:	e8 2d fd ff ff       	call   8010675b <rcr2>
80106a2e:	89 c3                	mov    %eax,%ebx
80106a30:	8b 45 08             	mov    0x8(%ebp),%eax
80106a33:	8b 70 38             	mov    0x38(%eax),%esi
80106a36:	e8 b3 d6 ff ff       	call   801040ee <cpuid>
80106a3b:	8b 55 08             	mov    0x8(%ebp),%edx
80106a3e:	8b 52 30             	mov    0x30(%edx),%edx
80106a41:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106a45:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106a49:	89 44 24 08          	mov    %eax,0x8(%esp)
80106a4d:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a51:	c7 04 24 9c 8a 10 80 	movl   $0x80108a9c,(%esp)
80106a58:	e8 6b 99 ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106a5d:	c7 04 24 ce 8a 10 80 	movl   $0x80108ace,(%esp)
80106a64:	e8 f9 9a ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a69:	e8 ed fc ff ff       	call   8010675b <rcr2>
80106a6e:	89 c6                	mov    %eax,%esi
80106a70:	8b 45 08             	mov    0x8(%ebp),%eax
80106a73:	8b 40 38             	mov    0x38(%eax),%eax
80106a76:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a79:	e8 70 d6 ff ff       	call   801040ee <cpuid>
80106a7e:	89 c3                	mov    %eax,%ebx
80106a80:	8b 45 08             	mov    0x8(%ebp),%eax
80106a83:	8b 78 34             	mov    0x34(%eax),%edi
80106a86:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106a89:	8b 45 08             	mov    0x8(%ebp),%eax
80106a8c:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a8f:	e8 f1 d6 ff ff       	call   80104185 <myproc>
80106a94:	8d 50 6c             	lea    0x6c(%eax),%edx
80106a97:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106a9a:	e8 e6 d6 ff ff       	call   80104185 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a9f:	8b 40 10             	mov    0x10(%eax),%eax
80106aa2:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106aa6:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106aa9:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106aad:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106ab1:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106ab4:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106ab8:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106abc:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106abf:	89 54 24 08          	mov    %edx,0x8(%esp)
80106ac3:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ac7:	c7 04 24 d4 8a 10 80 	movl   $0x80108ad4,(%esp)
80106ace:	e8 f5 98 ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80106ad3:	e8 ad d6 ff ff       	call   80104185 <myproc>
80106ad8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106adf:	eb 01                	jmp    80106ae2 <trap+0x1e6>
    break;
80106ae1:	90                   	nop
  }
...
80106ae2:	e8 9e d6 ff ff       	call   80104185 <myproc>
80106ae7:	85 c0                	test   %eax,%eax
80106ae9:	74 23                	je     80106b0e <trap+0x212>
80106aeb:	e8 95 d6 ff ff       	call   80104185 <myproc>
80106af0:	8b 40 24             	mov    0x24(%eax),%eax
80106af3:	85 c0                	test   %eax,%eax
80106af5:	74 17                	je     80106b0e <trap+0x212>
80106af7:	8b 45 08             	mov    0x8(%ebp),%eax
80106afa:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106afe:	0f b7 c0             	movzwl %ax,%eax
80106b01:	83 e0 03             	and    $0x3,%eax
80106b04:	83 f8 03             	cmp    $0x3,%eax
80106b07:	75 05                	jne    80106b0e <trap+0x212>
    exit();
80106b09:	e8 24 db ff ff       	call   80104632 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106b0e:	e8 72 d6 ff ff       	call   80104185 <myproc>
80106b13:	85 c0                	test   %eax,%eax
80106b15:	74 1d                	je     80106b34 <trap+0x238>
80106b17:	e8 69 d6 ff ff       	call   80104185 <myproc>
80106b1c:	8b 40 0c             	mov    0xc(%eax),%eax
80106b1f:	83 f8 04             	cmp    $0x4,%eax
80106b22:	75 10                	jne    80106b34 <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
80106b24:	8b 45 08             	mov    0x8(%ebp),%eax
80106b27:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106b2a:	83 f8 20             	cmp    $0x20,%eax
80106b2d:	75 05                	jne    80106b34 <trap+0x238>
    yield();
80106b2f:	e8 0c df ff ff       	call   80104a40 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106b34:	e8 4c d6 ff ff       	call   80104185 <myproc>
80106b39:	85 c0                	test   %eax,%eax
80106b3b:	74 23                	je     80106b60 <trap+0x264>
80106b3d:	e8 43 d6 ff ff       	call   80104185 <myproc>
80106b42:	8b 40 24             	mov    0x24(%eax),%eax
80106b45:	85 c0                	test   %eax,%eax
80106b47:	74 17                	je     80106b60 <trap+0x264>
80106b49:	8b 45 08             	mov    0x8(%ebp),%eax
80106b4c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106b50:	0f b7 c0             	movzwl %ax,%eax
80106b53:	83 e0 03             	and    $0x3,%eax
80106b56:	83 f8 03             	cmp    $0x3,%eax
80106b59:	75 05                	jne    80106b60 <trap+0x264>
    exit();
80106b5b:	e8 d2 da ff ff       	call   80104632 <exit>
}
80106b60:	83 c4 3c             	add    $0x3c,%esp
80106b63:	5b                   	pop    %ebx
80106b64:	5e                   	pop    %esi
80106b65:	5f                   	pop    %edi
80106b66:	5d                   	pop    %ebp
...
80106b6b:	83 ec 14             	sub    $0x14,%esp
80106b6e:	8b 45 08             	mov    0x8(%ebp),%eax
80106b71:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106b75:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106b79:	89 c2                	mov    %eax,%edx
80106b7b:	ec                   	in     (%dx),%al
80106b7c:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106b7f:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106b83:	c9                   	leave  
80106b84:	c3                   	ret    
...
80106b8b:	8b 55 08             	mov    0x8(%ebp),%edx
80106b8e:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b91:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
80106ba6:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106ba9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bb0:	00 
80106bb1:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106bb8:	e8 c8 ff ff ff       	call   80106b85 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106bbd:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106bc4:	00 
80106bc5:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106bcc:	e8 b4 ff ff ff       	call   80106b85 <outb>
  outb(COM1+0, 115200/9600);
80106bd1:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106bd8:	00 
80106bd9:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106be0:	e8 a0 ff ff ff       	call   80106b85 <outb>
  outb(COM1+1, 0);
80106be5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bec:	00 
80106bed:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106bf4:	e8 8c ff ff ff       	call   80106b85 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106bf9:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106c00:	00 
80106c01:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106c08:	e8 78 ff ff ff       	call   80106b85 <outb>
  outb(COM1+4, 0);
80106c0d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c14:	00 
80106c15:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106c1c:	e8 64 ff ff ff       	call   80106b85 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106c21:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106c28:	00 
80106c29:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106c30:	e8 50 ff ff ff       	call   80106b85 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106c35:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c3c:	e8 27 ff ff ff       	call   80106b68 <inb>
80106c41:	3c ff                	cmp    $0xff,%al
80106c43:	75 02                	jne    80106c47 <uartinit+0xa4>
    return;
80106c45:	eb 5e                	jmp    80106ca5 <uartinit+0x102>
  uart = 1;
80106c47:	c7 05 44 b6 10 80 01 	movl   $0x1,0x8010b644
80106c4e:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106c51:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106c58:	e8 0b ff ff ff       	call   80106b68 <inb>
  inb(COM1+0);
80106c5d:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c64:	e8 ff fe ff ff       	call   80106b68 <inb>
  ioapicenable(IRQ_COM1, 0);
80106c69:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c70:	00 
80106c71:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106c78:	e8 c2 bd ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106c7d:	c7 45 f4 98 8b 10 80 	movl   $0x80108b98,-0xc(%ebp)
80106c84:	eb 15                	jmp    80106c9b <uartinit+0xf8>
    uartputc(*p);
...
80106c92:	e8 10 00 00 00       	call   80106ca7 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106c97:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c9e:	0f b6 00             	movzbl (%eax),%eax
80106ca1:	84 c0                	test   %al,%al
80106ca3:	75 e1                	jne    80106c86 <uartinit+0xe3>
}
80106ca5:	c9                   	leave  
80106ca6:	c3                   	ret    
...
80106caa:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106cad:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80106cb2:	85 c0                	test   %eax,%eax
80106cb4:	75 02                	jne    80106cb8 <uartputc+0x11>
    return;
80106cb6:	eb 4b                	jmp    80106d03 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106cb8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106cbf:	eb 10                	jmp    80106cd1 <uartputc+0x2a>
    microdelay(10);
80106cc1:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106cc8:	e8 a9 c2 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106ccd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106cd1:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106cd5:	7f 16                	jg     80106ced <uartputc+0x46>
80106cd7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106cde:	e8 85 fe ff ff       	call   80106b68 <inb>
80106ce3:	0f b6 c0             	movzbl %al,%eax
80106ce6:	83 e0 20             	and    $0x20,%eax
80106ce9:	85 c0                	test   %eax,%eax
80106ceb:	74 d4                	je     80106cc1 <uartputc+0x1a>
  outb(COM1+0, c);
80106ced:	8b 45 08             	mov    0x8(%ebp),%eax
80106cf0:	0f b6 c0             	movzbl %al,%eax
80106cf3:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cf7:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106cfe:	e8 82 fe ff ff       	call   80106b85 <outb>
}
80106d03:	c9                   	leave  
80106d04:	c3                   	ret    
...
80106d08:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106d0b:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80106d10:	85 c0                	test   %eax,%eax
80106d12:	75 07                	jne    80106d1b <uartgetc+0x16>
    return -1;
80106d14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d19:	eb 2c                	jmp    80106d47 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106d1b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106d22:	e8 41 fe ff ff       	call   80106b68 <inb>
80106d27:	0f b6 c0             	movzbl %al,%eax
80106d2a:	83 e0 01             	and    $0x1,%eax
80106d2d:	85 c0                	test   %eax,%eax
80106d2f:	75 07                	jne    80106d38 <uartgetc+0x33>
    return -1;
80106d31:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d36:	eb 0f                	jmp    80106d47 <uartgetc+0x42>
  return inb(COM1+0);
80106d38:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106d3f:	e8 24 fe ff ff       	call   80106b68 <inb>
80106d44:	0f b6 c0             	movzbl %al,%eax
}
80106d47:	c9                   	leave  
80106d48:	c3                   	ret    
...
80106d4c:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106d4f:	c7 04 24 05 6d 10 80 	movl   $0x80106d05,(%esp)
80106d56:	e8 8e 9a ff ff       	call   801007e9 <consoleintr>
}
80106d5b:	c9                   	leave  
80106d5c:	c3                   	ret    
...
80106d5f:	6a 00                	push   $0x0
  jmp alltraps
80106d61:	e9 a9 f9 ff ff       	jmp    8010670f <alltraps>
...
80106d66:	6a 00                	push   $0x0
  pushl $1
80106d68:	6a 01                	push   $0x1
  jmp alltraps
80106d6a:	e9 a0 f9 ff ff       	jmp    8010670f <alltraps>
...
80106d6f:	6a 00                	push   $0x0
  pushl $2
80106d71:	6a 02                	push   $0x2
  jmp alltraps
80106d73:	e9 97 f9 ff ff       	jmp    8010670f <alltraps>
...
80106d7a:	6a 03                	push   $0x3
  jmp alltraps
80106d7c:	e9 8e f9 ff ff       	jmp    8010670f <alltraps>
...
80106d81:	6a 00                	push   $0x0
  pushl $4
80106d83:	6a 04                	push   $0x4
  jmp alltraps
80106d85:	e9 85 f9 ff ff       	jmp    8010670f <alltraps>
...
80106d8a:	6a 00                	push   $0x0
  pushl $5
80106d8c:	6a 05                	push   $0x5
  jmp alltraps
80106d8e:	e9 7c f9 ff ff       	jmp    8010670f <alltraps>
...
80106d95:	6a 06                	push   $0x6
  jmp alltraps
80106d97:	e9 73 f9 ff ff       	jmp    8010670f <alltraps>
...
80106d9c:	6a 00                	push   $0x0
  pushl $7
80106d9e:	6a 07                	push   $0x7
  jmp alltraps
80106da0:	e9 6a f9 ff ff       	jmp    8010670f <alltraps>

80106da5 <vector8>:
.globl vector8
vector8:
  pushl $8
80106da5:	6a 08                	push   $0x8
  jmp alltraps
80106da7:	e9 63 f9 ff ff       	jmp    8010670f <alltraps>
...
80106dac:	6a 00                	push   $0x0
  pushl $9
80106dae:	6a 09                	push   $0x9
  jmp alltraps
80106db0:	e9 5a f9 ff ff       	jmp    8010670f <alltraps>

80106db5 <vector10>:
.globl vector10
vector10:
  pushl $10
80106db5:	6a 0a                	push   $0xa
  jmp alltraps
80106db7:	e9 53 f9 ff ff       	jmp    8010670f <alltraps>

80106dbc <vector11>:
.globl vector11
vector11:
  pushl $11
80106dbc:	6a 0b                	push   $0xb
  jmp alltraps
80106dbe:	e9 4c f9 ff ff       	jmp    8010670f <alltraps>

80106dc3 <vector12>:
.globl vector12
vector12:
  pushl $12
80106dc3:	6a 0c                	push   $0xc
  jmp alltraps
80106dc5:	e9 45 f9 ff ff       	jmp    8010670f <alltraps>

80106dca <vector13>:
.globl vector13
vector13:
  pushl $13
80106dca:	6a 0d                	push   $0xd
  jmp alltraps
80106dcc:	e9 3e f9 ff ff       	jmp    8010670f <alltraps>

80106dd1 <vector14>:
.globl vector14
vector14:
  pushl $14
80106dd1:	6a 0e                	push   $0xe
  jmp alltraps
80106dd3:	e9 37 f9 ff ff       	jmp    8010670f <alltraps>
...
80106dd8:	6a 00                	push   $0x0
  pushl $15
80106dda:	6a 0f                	push   $0xf
  jmp alltraps
80106ddc:	e9 2e f9 ff ff       	jmp    8010670f <alltraps>
...
80106de1:	6a 00                	push   $0x0
  pushl $16
80106de3:	6a 10                	push   $0x10
  jmp alltraps
80106de5:	e9 25 f9 ff ff       	jmp    8010670f <alltraps>

80106dea <vector17>:
.globl vector17
vector17:
  pushl $17
80106dea:	6a 11                	push   $0x11
  jmp alltraps
80106dec:	e9 1e f9 ff ff       	jmp    8010670f <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $18
80106df3:	6a 12                	push   $0x12
  jmp alltraps
80106df5:	e9 15 f9 ff ff       	jmp    8010670f <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $19
80106dfc:	6a 13                	push   $0x13
  jmp alltraps
80106dfe:	e9 0c f9 ff ff       	jmp    8010670f <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $20
80106e05:	6a 14                	push   $0x14
  jmp alltraps
80106e07:	e9 03 f9 ff ff       	jmp    8010670f <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $21
80106e0e:	6a 15                	push   $0x15
  jmp alltraps
80106e10:	e9 fa f8 ff ff       	jmp    8010670f <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $22
80106e17:	6a 16                	push   $0x16
  jmp alltraps
80106e19:	e9 f1 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $23
80106e20:	6a 17                	push   $0x17
  jmp alltraps
80106e22:	e9 e8 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $24
80106e29:	6a 18                	push   $0x18
  jmp alltraps
80106e2b:	e9 df f8 ff ff       	jmp    8010670f <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $25
80106e32:	6a 19                	push   $0x19
  jmp alltraps
80106e34:	e9 d6 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $26
80106e3b:	6a 1a                	push   $0x1a
  jmp alltraps
80106e3d:	e9 cd f8 ff ff       	jmp    8010670f <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $27
80106e44:	6a 1b                	push   $0x1b
  jmp alltraps
80106e46:	e9 c4 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $28
80106e4d:	6a 1c                	push   $0x1c
  jmp alltraps
80106e4f:	e9 bb f8 ff ff       	jmp    8010670f <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $29
80106e56:	6a 1d                	push   $0x1d
  jmp alltraps
80106e58:	e9 b2 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $30
80106e5f:	6a 1e                	push   $0x1e
  jmp alltraps
80106e61:	e9 a9 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $31
80106e68:	6a 1f                	push   $0x1f
  jmp alltraps
80106e6a:	e9 a0 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $32
80106e71:	6a 20                	push   $0x20
  jmp alltraps
80106e73:	e9 97 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $33
80106e7a:	6a 21                	push   $0x21
  jmp alltraps
80106e7c:	e9 8e f8 ff ff       	jmp    8010670f <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $34
80106e83:	6a 22                	push   $0x22
  jmp alltraps
80106e85:	e9 85 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $35
80106e8c:	6a 23                	push   $0x23
  jmp alltraps
80106e8e:	e9 7c f8 ff ff       	jmp    8010670f <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $36
80106e95:	6a 24                	push   $0x24
  jmp alltraps
80106e97:	e9 73 f8 ff ff       	jmp    8010670f <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $37
80106e9e:	6a 25                	push   $0x25
  jmp alltraps
80106ea0:	e9 6a f8 ff ff       	jmp    8010670f <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $38
80106ea7:	6a 26                	push   $0x26
  jmp alltraps
80106ea9:	e9 61 f8 ff ff       	jmp    8010670f <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $39
80106eb0:	6a 27                	push   $0x27
  jmp alltraps
80106eb2:	e9 58 f8 ff ff       	jmp    8010670f <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $40
80106eb9:	6a 28                	push   $0x28
  jmp alltraps
80106ebb:	e9 4f f8 ff ff       	jmp    8010670f <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $41
80106ec2:	6a 29                	push   $0x29
  jmp alltraps
80106ec4:	e9 46 f8 ff ff       	jmp    8010670f <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $42
80106ecb:	6a 2a                	push   $0x2a
  jmp alltraps
80106ecd:	e9 3d f8 ff ff       	jmp    8010670f <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $43
80106ed4:	6a 2b                	push   $0x2b
  jmp alltraps
80106ed6:	e9 34 f8 ff ff       	jmp    8010670f <alltraps>
...
80106edb:	6a 00                	push   $0x0
  pushl $44
80106edd:	6a 2c                	push   $0x2c
  jmp alltraps
80106edf:	e9 2b f8 ff ff       	jmp    8010670f <alltraps>
...
80106ee4:	6a 00                	push   $0x0
  pushl $45
80106ee6:	6a 2d                	push   $0x2d
  jmp alltraps
80106ee8:	e9 22 f8 ff ff       	jmp    8010670f <alltraps>
...
80106eed:	6a 00                	push   $0x0
  pushl $46
80106eef:	6a 2e                	push   $0x2e
  jmp alltraps
80106ef1:	e9 19 f8 ff ff       	jmp    8010670f <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $47
80106ef8:	6a 2f                	push   $0x2f
  jmp alltraps
80106efa:	e9 10 f8 ff ff       	jmp    8010670f <alltraps>
...
80106eff:	6a 00                	push   $0x0
  pushl $48
80106f01:	6a 30                	push   $0x30
  jmp alltraps
80106f03:	e9 07 f8 ff ff       	jmp    8010670f <alltraps>
...
80106f08:	6a 00                	push   $0x0
  pushl $49
80106f0a:	6a 31                	push   $0x31
  jmp alltraps
80106f0c:	e9 fe f7 ff ff       	jmp    8010670f <alltraps>
...
80106f11:	6a 00                	push   $0x0
  pushl $50
80106f13:	6a 32                	push   $0x32
  jmp alltraps
80106f15:	e9 f5 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $51
80106f1c:	6a 33                	push   $0x33
  jmp alltraps
80106f1e:	e9 ec f7 ff ff       	jmp    8010670f <alltraps>
...
80106f23:	6a 00                	push   $0x0
  pushl $52
80106f25:	6a 34                	push   $0x34
  jmp alltraps
80106f27:	e9 e3 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f2c:	6a 00                	push   $0x0
  pushl $53
80106f2e:	6a 35                	push   $0x35
  jmp alltraps
80106f30:	e9 da f7 ff ff       	jmp    8010670f <alltraps>
...
80106f35:	6a 00                	push   $0x0
  pushl $54
80106f37:	6a 36                	push   $0x36
  jmp alltraps
80106f39:	e9 d1 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $55
80106f40:	6a 37                	push   $0x37
  jmp alltraps
80106f42:	e9 c8 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f47:	6a 00                	push   $0x0
  pushl $56
80106f49:	6a 38                	push   $0x38
  jmp alltraps
80106f4b:	e9 bf f7 ff ff       	jmp    8010670f <alltraps>
...
80106f50:	6a 00                	push   $0x0
  pushl $57
80106f52:	6a 39                	push   $0x39
  jmp alltraps
80106f54:	e9 b6 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f59:	6a 00                	push   $0x0
  pushl $58
80106f5b:	6a 3a                	push   $0x3a
  jmp alltraps
80106f5d:	e9 ad f7 ff ff       	jmp    8010670f <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $59
80106f64:	6a 3b                	push   $0x3b
  jmp alltraps
80106f66:	e9 a4 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f6b:	6a 00                	push   $0x0
  pushl $60
80106f6d:	6a 3c                	push   $0x3c
  jmp alltraps
80106f6f:	e9 9b f7 ff ff       	jmp    8010670f <alltraps>
...
80106f74:	6a 00                	push   $0x0
  pushl $61
80106f76:	6a 3d                	push   $0x3d
  jmp alltraps
80106f78:	e9 92 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f7d:	6a 00                	push   $0x0
  pushl $62
80106f7f:	6a 3e                	push   $0x3e
  jmp alltraps
80106f81:	e9 89 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $63
80106f88:	6a 3f                	push   $0x3f
  jmp alltraps
80106f8a:	e9 80 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f8f:	6a 00                	push   $0x0
  pushl $64
80106f91:	6a 40                	push   $0x40
  jmp alltraps
80106f93:	e9 77 f7 ff ff       	jmp    8010670f <alltraps>
...
80106f98:	6a 00                	push   $0x0
  pushl $65
80106f9a:	6a 41                	push   $0x41
  jmp alltraps
80106f9c:	e9 6e f7 ff ff       	jmp    8010670f <alltraps>
...
80106fa1:	6a 00                	push   $0x0
  pushl $66
80106fa3:	6a 42                	push   $0x42
  jmp alltraps
80106fa5:	e9 65 f7 ff ff       	jmp    8010670f <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $67
80106fac:	6a 43                	push   $0x43
  jmp alltraps
80106fae:	e9 5c f7 ff ff       	jmp    8010670f <alltraps>
...
80106fb3:	6a 00                	push   $0x0
  pushl $68
80106fb5:	6a 44                	push   $0x44
  jmp alltraps
80106fb7:	e9 53 f7 ff ff       	jmp    8010670f <alltraps>
...
80106fbc:	6a 00                	push   $0x0
  pushl $69
80106fbe:	6a 45                	push   $0x45
  jmp alltraps
80106fc0:	e9 4a f7 ff ff       	jmp    8010670f <alltraps>
...
80106fc5:	6a 00                	push   $0x0
  pushl $70
80106fc7:	6a 46                	push   $0x46
  jmp alltraps
80106fc9:	e9 41 f7 ff ff       	jmp    8010670f <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $71
80106fd0:	6a 47                	push   $0x47
  jmp alltraps
80106fd2:	e9 38 f7 ff ff       	jmp    8010670f <alltraps>
...
80106fd7:	6a 00                	push   $0x0
  pushl $72
80106fd9:	6a 48                	push   $0x48
  jmp alltraps
80106fdb:	e9 2f f7 ff ff       	jmp    8010670f <alltraps>
...
80106fe0:	6a 00                	push   $0x0
  pushl $73
80106fe2:	6a 49                	push   $0x49
  jmp alltraps
80106fe4:	e9 26 f7 ff ff       	jmp    8010670f <alltraps>
...
80106fe9:	6a 00                	push   $0x0
  pushl $74
80106feb:	6a 4a                	push   $0x4a
  jmp alltraps
80106fed:	e9 1d f7 ff ff       	jmp    8010670f <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $75
80106ff4:	6a 4b                	push   $0x4b
  jmp alltraps
80106ff6:	e9 14 f7 ff ff       	jmp    8010670f <alltraps>
...
80106ffb:	6a 00                	push   $0x0
  pushl $76
80106ffd:	6a 4c                	push   $0x4c
  jmp alltraps
80106fff:	e9 0b f7 ff ff       	jmp    8010670f <alltraps>
...
80107004:	6a 00                	push   $0x0
  pushl $77
80107006:	6a 4d                	push   $0x4d
  jmp alltraps
80107008:	e9 02 f7 ff ff       	jmp    8010670f <alltraps>
...
8010700d:	6a 00                	push   $0x0
  pushl $78
8010700f:	6a 4e                	push   $0x4e
  jmp alltraps
80107011:	e9 f9 f6 ff ff       	jmp    8010670f <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $79
80107018:	6a 4f                	push   $0x4f
  jmp alltraps
8010701a:	e9 f0 f6 ff ff       	jmp    8010670f <alltraps>
...
8010701f:	6a 00                	push   $0x0
  pushl $80
80107021:	6a 50                	push   $0x50
  jmp alltraps
80107023:	e9 e7 f6 ff ff       	jmp    8010670f <alltraps>
...
80107028:	6a 00                	push   $0x0
  pushl $81
8010702a:	6a 51                	push   $0x51
  jmp alltraps
8010702c:	e9 de f6 ff ff       	jmp    8010670f <alltraps>
...
80107031:	6a 00                	push   $0x0
  pushl $82
80107033:	6a 52                	push   $0x52
  jmp alltraps
80107035:	e9 d5 f6 ff ff       	jmp    8010670f <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $83
8010703c:	6a 53                	push   $0x53
  jmp alltraps
8010703e:	e9 cc f6 ff ff       	jmp    8010670f <alltraps>
...
80107043:	6a 00                	push   $0x0
  pushl $84
80107045:	6a 54                	push   $0x54
  jmp alltraps
80107047:	e9 c3 f6 ff ff       	jmp    8010670f <alltraps>
...
8010704c:	6a 00                	push   $0x0
  pushl $85
8010704e:	6a 55                	push   $0x55
  jmp alltraps
80107050:	e9 ba f6 ff ff       	jmp    8010670f <alltraps>
...
80107055:	6a 00                	push   $0x0
  pushl $86
80107057:	6a 56                	push   $0x56
  jmp alltraps
80107059:	e9 b1 f6 ff ff       	jmp    8010670f <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $87
80107060:	6a 57                	push   $0x57
  jmp alltraps
80107062:	e9 a8 f6 ff ff       	jmp    8010670f <alltraps>
...
80107067:	6a 00                	push   $0x0
  pushl $88
80107069:	6a 58                	push   $0x58
  jmp alltraps
8010706b:	e9 9f f6 ff ff       	jmp    8010670f <alltraps>
...
80107070:	6a 00                	push   $0x0
  pushl $89
80107072:	6a 59                	push   $0x59
  jmp alltraps
80107074:	e9 96 f6 ff ff       	jmp    8010670f <alltraps>
...
80107079:	6a 00                	push   $0x0
  pushl $90
8010707b:	6a 5a                	push   $0x5a
  jmp alltraps
8010707d:	e9 8d f6 ff ff       	jmp    8010670f <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $91
80107084:	6a 5b                	push   $0x5b
  jmp alltraps
80107086:	e9 84 f6 ff ff       	jmp    8010670f <alltraps>
...
8010708b:	6a 00                	push   $0x0
  pushl $92
8010708d:	6a 5c                	push   $0x5c
  jmp alltraps
8010708f:	e9 7b f6 ff ff       	jmp    8010670f <alltraps>
...
80107094:	6a 00                	push   $0x0
  pushl $93
80107096:	6a 5d                	push   $0x5d
  jmp alltraps
80107098:	e9 72 f6 ff ff       	jmp    8010670f <alltraps>
...
8010709d:	6a 00                	push   $0x0
  pushl $94
8010709f:	6a 5e                	push   $0x5e
  jmp alltraps
801070a1:	e9 69 f6 ff ff       	jmp    8010670f <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $95
801070a8:	6a 5f                	push   $0x5f
  jmp alltraps
801070aa:	e9 60 f6 ff ff       	jmp    8010670f <alltraps>
...
801070af:	6a 00                	push   $0x0
  pushl $96
801070b1:	6a 60                	push   $0x60
  jmp alltraps
801070b3:	e9 57 f6 ff ff       	jmp    8010670f <alltraps>
...
801070b8:	6a 00                	push   $0x0
  pushl $97
801070ba:	6a 61                	push   $0x61
  jmp alltraps
801070bc:	e9 4e f6 ff ff       	jmp    8010670f <alltraps>
...
801070c1:	6a 00                	push   $0x0
  pushl $98
801070c3:	6a 62                	push   $0x62
  jmp alltraps
801070c5:	e9 45 f6 ff ff       	jmp    8010670f <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $99
801070cc:	6a 63                	push   $0x63
  jmp alltraps
801070ce:	e9 3c f6 ff ff       	jmp    8010670f <alltraps>
...
801070d3:	6a 00                	push   $0x0
  pushl $100
801070d5:	6a 64                	push   $0x64
  jmp alltraps
801070d7:	e9 33 f6 ff ff       	jmp    8010670f <alltraps>
...
801070dc:	6a 00                	push   $0x0
  pushl $101
801070de:	6a 65                	push   $0x65
  jmp alltraps
801070e0:	e9 2a f6 ff ff       	jmp    8010670f <alltraps>
...
801070e5:	6a 00                	push   $0x0
  pushl $102
801070e7:	6a 66                	push   $0x66
  jmp alltraps
801070e9:	e9 21 f6 ff ff       	jmp    8010670f <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $103
801070f0:	6a 67                	push   $0x67
  jmp alltraps
801070f2:	e9 18 f6 ff ff       	jmp    8010670f <alltraps>
...
801070f7:	6a 00                	push   $0x0
  pushl $104
801070f9:	6a 68                	push   $0x68
  jmp alltraps
801070fb:	e9 0f f6 ff ff       	jmp    8010670f <alltraps>
...
80107100:	6a 00                	push   $0x0
  pushl $105
80107102:	6a 69                	push   $0x69
  jmp alltraps
80107104:	e9 06 f6 ff ff       	jmp    8010670f <alltraps>
...
80107109:	6a 00                	push   $0x0
  pushl $106
8010710b:	6a 6a                	push   $0x6a
  jmp alltraps
8010710d:	e9 fd f5 ff ff       	jmp    8010670f <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $107
80107114:	6a 6b                	push   $0x6b
  jmp alltraps
80107116:	e9 f4 f5 ff ff       	jmp    8010670f <alltraps>
...
8010711b:	6a 00                	push   $0x0
  pushl $108
8010711d:	6a 6c                	push   $0x6c
  jmp alltraps
8010711f:	e9 eb f5 ff ff       	jmp    8010670f <alltraps>
...
80107124:	6a 00                	push   $0x0
  pushl $109
80107126:	6a 6d                	push   $0x6d
  jmp alltraps
80107128:	e9 e2 f5 ff ff       	jmp    8010670f <alltraps>
...
8010712d:	6a 00                	push   $0x0
  pushl $110
8010712f:	6a 6e                	push   $0x6e
  jmp alltraps
80107131:	e9 d9 f5 ff ff       	jmp    8010670f <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $111
80107138:	6a 6f                	push   $0x6f
  jmp alltraps
8010713a:	e9 d0 f5 ff ff       	jmp    8010670f <alltraps>
...
8010713f:	6a 00                	push   $0x0
  pushl $112
80107141:	6a 70                	push   $0x70
  jmp alltraps
80107143:	e9 c7 f5 ff ff       	jmp    8010670f <alltraps>
...
80107148:	6a 00                	push   $0x0
  pushl $113
8010714a:	6a 71                	push   $0x71
  jmp alltraps
8010714c:	e9 be f5 ff ff       	jmp    8010670f <alltraps>
...
80107151:	6a 00                	push   $0x0
  pushl $114
80107153:	6a 72                	push   $0x72
  jmp alltraps
80107155:	e9 b5 f5 ff ff       	jmp    8010670f <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $115
8010715c:	6a 73                	push   $0x73
  jmp alltraps
8010715e:	e9 ac f5 ff ff       	jmp    8010670f <alltraps>
...
80107163:	6a 00                	push   $0x0
  pushl $116
80107165:	6a 74                	push   $0x74
  jmp alltraps
80107167:	e9 a3 f5 ff ff       	jmp    8010670f <alltraps>
...
8010716c:	6a 00                	push   $0x0
  pushl $117
8010716e:	6a 75                	push   $0x75
  jmp alltraps
80107170:	e9 9a f5 ff ff       	jmp    8010670f <alltraps>
...
80107175:	6a 00                	push   $0x0
  pushl $118
80107177:	6a 76                	push   $0x76
  jmp alltraps
80107179:	e9 91 f5 ff ff       	jmp    8010670f <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $119
80107180:	6a 77                	push   $0x77
  jmp alltraps
80107182:	e9 88 f5 ff ff       	jmp    8010670f <alltraps>
...
80107187:	6a 00                	push   $0x0
  pushl $120
80107189:	6a 78                	push   $0x78
  jmp alltraps
8010718b:	e9 7f f5 ff ff       	jmp    8010670f <alltraps>
...
80107190:	6a 00                	push   $0x0
  pushl $121
80107192:	6a 79                	push   $0x79
  jmp alltraps
80107194:	e9 76 f5 ff ff       	jmp    8010670f <alltraps>
...
80107199:	6a 00                	push   $0x0
  pushl $122
8010719b:	6a 7a                	push   $0x7a
  jmp alltraps
8010719d:	e9 6d f5 ff ff       	jmp    8010670f <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $123
801071a4:	6a 7b                	push   $0x7b
  jmp alltraps
801071a6:	e9 64 f5 ff ff       	jmp    8010670f <alltraps>
...
801071ab:	6a 00                	push   $0x0
  pushl $124
801071ad:	6a 7c                	push   $0x7c
  jmp alltraps
801071af:	e9 5b f5 ff ff       	jmp    8010670f <alltraps>
...
801071b4:	6a 00                	push   $0x0
  pushl $125
801071b6:	6a 7d                	push   $0x7d
  jmp alltraps
801071b8:	e9 52 f5 ff ff       	jmp    8010670f <alltraps>
...
801071bd:	6a 00                	push   $0x0
  pushl $126
801071bf:	6a 7e                	push   $0x7e
  jmp alltraps
801071c1:	e9 49 f5 ff ff       	jmp    8010670f <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $127
801071c8:	6a 7f                	push   $0x7f
  jmp alltraps
801071ca:	e9 40 f5 ff ff       	jmp    8010670f <alltraps>
...
801071cf:	6a 00                	push   $0x0
  pushl $128
801071d1:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801071d6:	e9 34 f5 ff ff       	jmp    8010670f <alltraps>
...
801071db:	6a 00                	push   $0x0
  pushl $129
801071dd:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801071e2:	e9 28 f5 ff ff       	jmp    8010670f <alltraps>
...
801071e7:	6a 00                	push   $0x0
  pushl $130
801071e9:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801071ee:	e9 1c f5 ff ff       	jmp    8010670f <alltraps>
...
801071f3:	6a 00                	push   $0x0
  pushl $131
801071f5:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801071fa:	e9 10 f5 ff ff       	jmp    8010670f <alltraps>
...
801071ff:	6a 00                	push   $0x0
  pushl $132
80107201:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107206:	e9 04 f5 ff ff       	jmp    8010670f <alltraps>
...
8010720b:	6a 00                	push   $0x0
  pushl $133
8010720d:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107212:	e9 f8 f4 ff ff       	jmp    8010670f <alltraps>
...
80107217:	6a 00                	push   $0x0
  pushl $134
80107219:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010721e:	e9 ec f4 ff ff       	jmp    8010670f <alltraps>
...
80107223:	6a 00                	push   $0x0
  pushl $135
80107225:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010722a:	e9 e0 f4 ff ff       	jmp    8010670f <alltraps>
...
8010722f:	6a 00                	push   $0x0
  pushl $136
80107231:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107236:	e9 d4 f4 ff ff       	jmp    8010670f <alltraps>
...
8010723b:	6a 00                	push   $0x0
  pushl $137
8010723d:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107242:	e9 c8 f4 ff ff       	jmp    8010670f <alltraps>
...
80107247:	6a 00                	push   $0x0
  pushl $138
80107249:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010724e:	e9 bc f4 ff ff       	jmp    8010670f <alltraps>
...
80107253:	6a 00                	push   $0x0
  pushl $139
80107255:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010725a:	e9 b0 f4 ff ff       	jmp    8010670f <alltraps>
...
8010725f:	6a 00                	push   $0x0
  pushl $140
80107261:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107266:	e9 a4 f4 ff ff       	jmp    8010670f <alltraps>
...
8010726b:	6a 00                	push   $0x0
  pushl $141
8010726d:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107272:	e9 98 f4 ff ff       	jmp    8010670f <alltraps>
...
80107277:	6a 00                	push   $0x0
  pushl $142
80107279:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010727e:	e9 8c f4 ff ff       	jmp    8010670f <alltraps>
...
80107283:	6a 00                	push   $0x0
  pushl $143
80107285:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010728a:	e9 80 f4 ff ff       	jmp    8010670f <alltraps>
...
8010728f:	6a 00                	push   $0x0
  pushl $144
80107291:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107296:	e9 74 f4 ff ff       	jmp    8010670f <alltraps>
...
8010729b:	6a 00                	push   $0x0
  pushl $145
8010729d:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801072a2:	e9 68 f4 ff ff       	jmp    8010670f <alltraps>
...
801072a7:	6a 00                	push   $0x0
  pushl $146
801072a9:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801072ae:	e9 5c f4 ff ff       	jmp    8010670f <alltraps>
...
801072b3:	6a 00                	push   $0x0
  pushl $147
801072b5:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801072ba:	e9 50 f4 ff ff       	jmp    8010670f <alltraps>
...
801072bf:	6a 00                	push   $0x0
  pushl $148
801072c1:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801072c6:	e9 44 f4 ff ff       	jmp    8010670f <alltraps>
...
801072cb:	6a 00                	push   $0x0
  pushl $149
801072cd:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801072d2:	e9 38 f4 ff ff       	jmp    8010670f <alltraps>
...
801072d7:	6a 00                	push   $0x0
  pushl $150
801072d9:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801072de:	e9 2c f4 ff ff       	jmp    8010670f <alltraps>
...
801072e3:	6a 00                	push   $0x0
  pushl $151
801072e5:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801072ea:	e9 20 f4 ff ff       	jmp    8010670f <alltraps>
...
801072ef:	6a 00                	push   $0x0
  pushl $152
801072f1:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801072f6:	e9 14 f4 ff ff       	jmp    8010670f <alltraps>
...
801072fb:	6a 00                	push   $0x0
  pushl $153
801072fd:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107302:	e9 08 f4 ff ff       	jmp    8010670f <alltraps>
...
80107307:	6a 00                	push   $0x0
  pushl $154
80107309:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010730e:	e9 fc f3 ff ff       	jmp    8010670f <alltraps>
...
80107313:	6a 00                	push   $0x0
  pushl $155
80107315:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010731a:	e9 f0 f3 ff ff       	jmp    8010670f <alltraps>
...
8010731f:	6a 00                	push   $0x0
  pushl $156
80107321:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107326:	e9 e4 f3 ff ff       	jmp    8010670f <alltraps>
...
8010732b:	6a 00                	push   $0x0
  pushl $157
8010732d:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107332:	e9 d8 f3 ff ff       	jmp    8010670f <alltraps>
...
80107337:	6a 00                	push   $0x0
  pushl $158
80107339:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010733e:	e9 cc f3 ff ff       	jmp    8010670f <alltraps>
...
80107343:	6a 00                	push   $0x0
  pushl $159
80107345:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010734a:	e9 c0 f3 ff ff       	jmp    8010670f <alltraps>
...
8010734f:	6a 00                	push   $0x0
  pushl $160
80107351:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107356:	e9 b4 f3 ff ff       	jmp    8010670f <alltraps>
...
8010735b:	6a 00                	push   $0x0
  pushl $161
8010735d:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107362:	e9 a8 f3 ff ff       	jmp    8010670f <alltraps>
...
80107367:	6a 00                	push   $0x0
  pushl $162
80107369:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010736e:	e9 9c f3 ff ff       	jmp    8010670f <alltraps>
...
80107373:	6a 00                	push   $0x0
  pushl $163
80107375:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010737a:	e9 90 f3 ff ff       	jmp    8010670f <alltraps>
...
8010737f:	6a 00                	push   $0x0
  pushl $164
80107381:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107386:	e9 84 f3 ff ff       	jmp    8010670f <alltraps>
...
8010738b:	6a 00                	push   $0x0
  pushl $165
8010738d:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107392:	e9 78 f3 ff ff       	jmp    8010670f <alltraps>
...
80107397:	6a 00                	push   $0x0
  pushl $166
80107399:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010739e:	e9 6c f3 ff ff       	jmp    8010670f <alltraps>
...
801073a3:	6a 00                	push   $0x0
  pushl $167
801073a5:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801073aa:	e9 60 f3 ff ff       	jmp    8010670f <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $168
801073b1:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801073b6:	e9 54 f3 ff ff       	jmp    8010670f <alltraps>
...
801073bb:	6a 00                	push   $0x0
  pushl $169
801073bd:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801073c2:	e9 48 f3 ff ff       	jmp    8010670f <alltraps>
...
801073c7:	6a 00                	push   $0x0
  pushl $170
801073c9:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801073ce:	e9 3c f3 ff ff       	jmp    8010670f <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $171
801073d5:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801073da:	e9 30 f3 ff ff       	jmp    8010670f <alltraps>
...
801073df:	6a 00                	push   $0x0
  pushl $172
801073e1:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801073e6:	e9 24 f3 ff ff       	jmp    8010670f <alltraps>
...
801073eb:	6a 00                	push   $0x0
  pushl $173
801073ed:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801073f2:	e9 18 f3 ff ff       	jmp    8010670f <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $174
801073f9:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801073fe:	e9 0c f3 ff ff       	jmp    8010670f <alltraps>
...
80107403:	6a 00                	push   $0x0
  pushl $175
80107405:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010740a:	e9 00 f3 ff ff       	jmp    8010670f <alltraps>
...
8010740f:	6a 00                	push   $0x0
  pushl $176
80107411:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107416:	e9 f4 f2 ff ff       	jmp    8010670f <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $177
8010741d:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107422:	e9 e8 f2 ff ff       	jmp    8010670f <alltraps>
...
80107427:	6a 00                	push   $0x0
  pushl $178
80107429:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010742e:	e9 dc f2 ff ff       	jmp    8010670f <alltraps>
...
80107433:	6a 00                	push   $0x0
  pushl $179
80107435:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010743a:	e9 d0 f2 ff ff       	jmp    8010670f <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $180
80107441:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107446:	e9 c4 f2 ff ff       	jmp    8010670f <alltraps>
...
8010744b:	6a 00                	push   $0x0
  pushl $181
8010744d:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107452:	e9 b8 f2 ff ff       	jmp    8010670f <alltraps>
...
80107457:	6a 00                	push   $0x0
  pushl $182
80107459:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010745e:	e9 ac f2 ff ff       	jmp    8010670f <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $183
80107465:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010746a:	e9 a0 f2 ff ff       	jmp    8010670f <alltraps>
...
8010746f:	6a 00                	push   $0x0
  pushl $184
80107471:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107476:	e9 94 f2 ff ff       	jmp    8010670f <alltraps>
...
8010747b:	6a 00                	push   $0x0
  pushl $185
8010747d:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107482:	e9 88 f2 ff ff       	jmp    8010670f <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $186
80107489:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010748e:	e9 7c f2 ff ff       	jmp    8010670f <alltraps>
...
80107493:	6a 00                	push   $0x0
  pushl $187
80107495:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010749a:	e9 70 f2 ff ff       	jmp    8010670f <alltraps>
...
8010749f:	6a 00                	push   $0x0
  pushl $188
801074a1:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801074a6:	e9 64 f2 ff ff       	jmp    8010670f <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $189
801074ad:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801074b2:	e9 58 f2 ff ff       	jmp    8010670f <alltraps>
...
801074b7:	6a 00                	push   $0x0
  pushl $190
801074b9:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801074be:	e9 4c f2 ff ff       	jmp    8010670f <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $191
801074c5:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801074ca:	e9 40 f2 ff ff       	jmp    8010670f <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $192
801074d1:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801074d6:	e9 34 f2 ff ff       	jmp    8010670f <alltraps>
...
801074db:	6a 00                	push   $0x0
  pushl $193
801074dd:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801074e2:	e9 28 f2 ff ff       	jmp    8010670f <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $194
801074e9:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801074ee:	e9 1c f2 ff ff       	jmp    8010670f <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $195
801074f5:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801074fa:	e9 10 f2 ff ff       	jmp    8010670f <alltraps>
...
801074ff:	6a 00                	push   $0x0
  pushl $196
80107501:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107506:	e9 04 f2 ff ff       	jmp    8010670f <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $197
8010750d:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107512:	e9 f8 f1 ff ff       	jmp    8010670f <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $198
80107519:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010751e:	e9 ec f1 ff ff       	jmp    8010670f <alltraps>
...
80107523:	6a 00                	push   $0x0
  pushl $199
80107525:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010752a:	e9 e0 f1 ff ff       	jmp    8010670f <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $200
80107531:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107536:	e9 d4 f1 ff ff       	jmp    8010670f <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $201
8010753d:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107542:	e9 c8 f1 ff ff       	jmp    8010670f <alltraps>
...
80107547:	6a 00                	push   $0x0
  pushl $202
80107549:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010754e:	e9 bc f1 ff ff       	jmp    8010670f <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $203
80107555:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010755a:	e9 b0 f1 ff ff       	jmp    8010670f <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $204
80107561:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107566:	e9 a4 f1 ff ff       	jmp    8010670f <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $205
8010756d:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107572:	e9 98 f1 ff ff       	jmp    8010670f <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $206
80107579:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010757e:	e9 8c f1 ff ff       	jmp    8010670f <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $207
80107585:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010758a:	e9 80 f1 ff ff       	jmp    8010670f <alltraps>
...
8010758f:	6a 00                	push   $0x0
  pushl $208
80107591:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107596:	e9 74 f1 ff ff       	jmp    8010670f <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $209
8010759d:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801075a2:	e9 68 f1 ff ff       	jmp    8010670f <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $210
801075a9:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801075ae:	e9 5c f1 ff ff       	jmp    8010670f <alltraps>
...
801075b3:	6a 00                	push   $0x0
  pushl $211
801075b5:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801075ba:	e9 50 f1 ff ff       	jmp    8010670f <alltraps>
...
801075bf:	6a 00                	push   $0x0
  pushl $212
801075c1:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801075c6:	e9 44 f1 ff ff       	jmp    8010670f <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $213
801075cd:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801075d2:	e9 38 f1 ff ff       	jmp    8010670f <alltraps>
...
801075d7:	6a 00                	push   $0x0
  pushl $214
801075d9:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801075de:	e9 2c f1 ff ff       	jmp    8010670f <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $215
801075e5:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801075ea:	e9 20 f1 ff ff       	jmp    8010670f <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $216
801075f1:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801075f6:	e9 14 f1 ff ff       	jmp    8010670f <alltraps>
...
801075fb:	6a 00                	push   $0x0
  pushl $217
801075fd:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107602:	e9 08 f1 ff ff       	jmp    8010670f <alltraps>
...
80107607:	6a 00                	push   $0x0
  pushl $218
80107609:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010760e:	e9 fc f0 ff ff       	jmp    8010670f <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $219
80107615:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010761a:	e9 f0 f0 ff ff       	jmp    8010670f <alltraps>
...
8010761f:	6a 00                	push   $0x0
  pushl $220
80107621:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107626:	e9 e4 f0 ff ff       	jmp    8010670f <alltraps>
...
8010762b:	6a 00                	push   $0x0
  pushl $221
8010762d:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107632:	e9 d8 f0 ff ff       	jmp    8010670f <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $222
80107639:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010763e:	e9 cc f0 ff ff       	jmp    8010670f <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $223
80107645:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010764a:	e9 c0 f0 ff ff       	jmp    8010670f <alltraps>
...
8010764f:	6a 00                	push   $0x0
  pushl $224
80107651:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107656:	e9 b4 f0 ff ff       	jmp    8010670f <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $225
8010765d:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107662:	e9 a8 f0 ff ff       	jmp    8010670f <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $226
80107669:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010766e:	e9 9c f0 ff ff       	jmp    8010670f <alltraps>
...
80107673:	6a 00                	push   $0x0
  pushl $227
80107675:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010767a:	e9 90 f0 ff ff       	jmp    8010670f <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $228
80107681:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107686:	e9 84 f0 ff ff       	jmp    8010670f <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $229
8010768d:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107692:	e9 78 f0 ff ff       	jmp    8010670f <alltraps>
...
80107697:	6a 00                	push   $0x0
  pushl $230
80107699:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010769e:	e9 6c f0 ff ff       	jmp    8010670f <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $231
801076a5:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801076aa:	e9 60 f0 ff ff       	jmp    8010670f <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $232
801076b1:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801076b6:	e9 54 f0 ff ff       	jmp    8010670f <alltraps>
...
801076bb:	6a 00                	push   $0x0
  pushl $233
801076bd:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801076c2:	e9 48 f0 ff ff       	jmp    8010670f <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $234
801076c9:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801076ce:	e9 3c f0 ff ff       	jmp    8010670f <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $235
801076d5:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801076da:	e9 30 f0 ff ff       	jmp    8010670f <alltraps>
...
801076df:	6a 00                	push   $0x0
  pushl $236
801076e1:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801076e6:	e9 24 f0 ff ff       	jmp    8010670f <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $237
801076ed:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801076f2:	e9 18 f0 ff ff       	jmp    8010670f <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $238
801076f9:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801076fe:	e9 0c f0 ff ff       	jmp    8010670f <alltraps>
...
80107703:	6a 00                	push   $0x0
  pushl $239
80107705:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010770a:	e9 00 f0 ff ff       	jmp    8010670f <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $240
80107711:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107716:	e9 f4 ef ff ff       	jmp    8010670f <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $241
8010771d:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107722:	e9 e8 ef ff ff       	jmp    8010670f <alltraps>
...
80107727:	6a 00                	push   $0x0
  pushl $242
80107729:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010772e:	e9 dc ef ff ff       	jmp    8010670f <alltraps>
...
80107733:	6a 00                	push   $0x0
  pushl $243
80107735:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010773a:	e9 d0 ef ff ff       	jmp    8010670f <alltraps>
...
8010773f:	6a 00                	push   $0x0
  pushl $244
80107741:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107746:	e9 c4 ef ff ff       	jmp    8010670f <alltraps>
...
8010774b:	6a 00                	push   $0x0
  pushl $245
8010774d:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107752:	e9 b8 ef ff ff       	jmp    8010670f <alltraps>
...
80107757:	6a 00                	push   $0x0
  pushl $246
80107759:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010775e:	e9 ac ef ff ff       	jmp    8010670f <alltraps>
...
80107763:	6a 00                	push   $0x0
  pushl $247
80107765:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010776a:	e9 a0 ef ff ff       	jmp    8010670f <alltraps>
...
8010776f:	6a 00                	push   $0x0
  pushl $248
80107771:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107776:	e9 94 ef ff ff       	jmp    8010670f <alltraps>
...
8010777b:	6a 00                	push   $0x0
  pushl $249
8010777d:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107782:	e9 88 ef ff ff       	jmp    8010670f <alltraps>
...
80107787:	6a 00                	push   $0x0
  pushl $250
80107789:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010778e:	e9 7c ef ff ff       	jmp    8010670f <alltraps>
...
80107793:	6a 00                	push   $0x0
  pushl $251
80107795:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010779a:	e9 70 ef ff ff       	jmp    8010670f <alltraps>
...
8010779f:	6a 00                	push   $0x0
  pushl $252
801077a1:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801077a6:	e9 64 ef ff ff       	jmp    8010670f <alltraps>
...
801077ab:	6a 00                	push   $0x0
  pushl $253
801077ad:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801077b2:	e9 58 ef ff ff       	jmp    8010670f <alltraps>
...
801077b7:	6a 00                	push   $0x0
  pushl $254
801077b9:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801077be:	e9 4c ef ff ff       	jmp    8010670f <alltraps>
...
801077c3:	6a 00                	push   $0x0
  pushl $255
801077c5:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801077ca:	e9 40 ef ff ff       	jmp    8010670f <alltraps>

801077cf <lgdt>:
{
801077cf:	55                   	push   %ebp
801077d0:	89 e5                	mov    %esp,%ebp
801077d2:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801077d5:	8b 45 0c             	mov    0xc(%ebp),%eax
801077d8:	83 e8 01             	sub    $0x1,%eax
801077db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801077df:	8b 45 08             	mov    0x8(%ebp),%eax
801077e2:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801077e6:	8b 45 08             	mov    0x8(%ebp),%eax
801077e9:	c1 e8 10             	shr    $0x10,%eax
801077ec:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801077f0:	8d 45 fa             	lea    -0x6(%ebp),%eax
801077f3:	0f 01 10             	lgdtl  (%eax)
}
801077f6:	c9                   	leave  
801077f7:	c3                   	ret    
...
801077fb:	83 ec 04             	sub    $0x4,%esp
801077fe:	8b 45 08             	mov    0x8(%ebp),%eax
80107801:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107805:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107809:	0f 00 d8             	ltr    %ax
}
8010780c:	c9                   	leave  
8010780d:	c3                   	ret    
...
seginit(void)
{
80107819:	55                   	push   %ebp
8010781a:	89 e5                	mov    %esp,%ebp
8010781c:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
8010781f:	e8 ca c8 ff ff       	call   801040ee <cpuid>
80107824:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
8010782a:	05 20 38 11 80       	add    $0x80113820,%eax
...
801078a3:	83 e2 df             	and    $0xffffffdf,%edx
...
801078c6:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801078ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078cd:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801078d4:	ff ff 
801078d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d9:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801078e0:	00 00 
801078e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e5:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801078ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ef:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078f6:	83 e2 f0             	and    $0xfffffff0,%edx
801078f9:	83 ca 02             	or     $0x2,%edx
...
8010792b:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107932:	83 ca 80             	or     $0xffffff80,%edx
80107935:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010793b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010793e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107945:	83 ca 0f             	or     $0xf,%edx
...
80107958:	83 e2 ef             	and    $0xffffffef,%edx
...
8010796b:	83 e2 df             	and    $0xffffffdf,%edx
...
8010797e:	83 ca 40             	or     $0x40,%edx
80107981:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107987:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798a:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107991:	83 ca 80             	or     $0xffffff80,%edx
80107994:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010799a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799d:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801079a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a7:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
801079ae:	ff ff 
801079b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b3:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
801079ba:	00 00 
801079bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079bf:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
801079c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c9:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801079d0:	83 e2 f0             	and    $0xfffffff0,%edx
801079d3:	83 ca 0a             	or     $0xa,%edx
801079d6:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801079dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079df:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801079e6:	83 ca 10             	or     $0x10,%edx
801079e9:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801079ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f2:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801079f9:	83 ca 60             	or     $0x60,%edx
801079fc:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
80107a02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a05:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
80107a0c:	83 ca 80             	or     $0xffffff80,%edx
80107a0f:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
80107a15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a18:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a1f:	83 ca 0f             	or     $0xf,%edx
80107a22:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a2b:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a32:	83 e2 ef             	and    $0xffffffef,%edx
80107a35:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a3e:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a45:	83 e2 df             	and    $0xffffffdf,%edx
80107a48:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a51:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a58:	83 ca 40             	or     $0x40,%edx
80107a5b:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a64:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a6b:	83 ca 80             	or     $0xffffff80,%edx
80107a6e:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a77:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a81:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107a88:	ff ff 
80107a8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a8d:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107a94:	00 00 
80107a96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a99:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107aa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aa3:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107aaa:	83 e2 f0             	and    $0xfffffff0,%edx
80107aad:	83 ca 02             	or     $0x2,%edx
...
80107ad3:	83 ca 60             	or     $0x60,%edx
80107ad6:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107adc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107adf:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107ae6:	83 ca 80             	or     $0xffffff80,%edx
80107ae9:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
...
80107b0c:	83 e2 ef             	and    $0xffffffef,%edx
...
80107b1f:	83 e2 df             	and    $0xffffffdf,%edx
...
80107b32:	83 ca 40             	or     $0x40,%edx
80107b35:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107b3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3e:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107b45:	83 ca 80             	or     $0xffffff80,%edx
80107b48:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107b4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b51:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107b58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b5b:	83 c0 70             	add    $0x70,%eax
80107b5e:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107b65:	00 
80107b66:	89 04 24             	mov    %eax,(%esp)
80107b69:	e8 61 fc ff ff       	call   801077cf <lgdt>
}
80107b6e:	c9                   	leave  
80107b6f:	c3                   	ret    
...
80107b79:	c1 e8 16             	shr    $0x16,%eax
80107b7c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107b83:	8b 45 08             	mov    0x8(%ebp),%eax
80107b86:	01 d0                	add    %edx,%eax
80107b88:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107b8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b8e:	8b 00                	mov    (%eax),%eax
80107b90:	83 e0 01             	and    $0x1,%eax
80107b93:	85 c0                	test   %eax,%eax
80107b95:	74 14                	je     80107bab <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107b97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b9a:	8b 00                	mov    (%eax),%eax
80107b9c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ba1:	05 00 00 00 80       	add    $0x80000000,%eax
80107ba6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ba9:	eb 48                	jmp    80107bf3 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107bab:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107baf:	74 0e                	je     80107bbf <walkpgdir+0x4f>
80107bb1:	e8 f3 af ff ff       	call   80102ba9 <kalloc>
80107bb6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107bb9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107bbd:	75 07                	jne    80107bc6 <walkpgdir+0x56>
      return 0;
80107bbf:	b8 00 00 00 00       	mov    $0x0,%eax
80107bc4:	eb 44                	jmp    80107c0a <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107bc6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107bcd:	00 
80107bce:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107bd5:	00 
80107bd6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd9:	89 04 24             	mov    %eax,(%esp)
80107bdc:	e8 1c d7 ff ff       	call   801052fd <memset>
...
80107be9:	83 c8 07             	or     $0x7,%eax
80107bec:	89 c2                	mov    %eax,%edx
80107bee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bf1:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107bf3:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bf6:	c1 e8 0c             	shr    $0xc,%eax
80107bf9:	25 ff 03 00 00       	and    $0x3ff,%eax
80107bfe:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107c05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c08:	01 d0                	add    %edx,%eax
}
80107c0a:	c9                   	leave  
80107c0b:	c3                   	ret    
...
80107c0f:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80107c12:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c15:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c1a:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
80107c30:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107c37:	00 
80107c38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c3b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c3f:	8b 45 08             	mov    0x8(%ebp),%eax
80107c42:	89 04 24             	mov    %eax,(%esp)
80107c45:	e8 26 ff ff ff       	call   80107b70 <walkpgdir>
80107c4a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107c4d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107c51:	75 07                	jne    80107c5a <mappages+0x4e>
      return -1;
80107c53:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107c58:	eb 48                	jmp    80107ca2 <mappages+0x96>
    if(*pte & PTE_P)
80107c5a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c5d:	8b 00                	mov    (%eax),%eax
80107c5f:	83 e0 01             	and    $0x1,%eax
80107c62:	85 c0                	test   %eax,%eax
80107c64:	74 0c                	je     80107c72 <mappages+0x66>
      panic("remap");
80107c66:	c7 04 24 a0 8b 10 80 	movl   $0x80108ba0,(%esp)
80107c6d:	e8 f0 88 ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
...
80107c88:	75 08                	jne    80107c92 <mappages+0x86>
      break;
80107c8a:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107ca8:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107cab:	e8 f9 ae ff ff       	call   80102ba9 <kalloc>
80107cb0:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107cb3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107cb7:	75 0a                	jne    80107cc3 <setupkvm+0x1f>
    return 0;
80107cb9:	b8 00 00 00 00       	mov    $0x0,%eax
80107cbe:	e9 84 00 00 00       	jmp    80107d47 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
80107cc3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107cca:	00 
80107ccb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107cd2:	00 
80107cd3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cd6:	89 04 24             	mov    %eax,(%esp)
80107cd9:	e8 1f d6 ff ff       	call   801052fd <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107cde:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107ce5:	eb 54                	jmp    80107d3b <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107ce7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cea:	8b 48 0c             	mov    0xc(%eax),%ecx
80107ced:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf0:	8b 50 04             	mov    0x4(%eax),%edx
80107cf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf6:	8b 58 08             	mov    0x8(%eax),%ebx
80107cf9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfc:	8b 40 04             	mov    0x4(%eax),%eax
80107cff:	29 c3                	sub    %eax,%ebx
80107d01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d04:	8b 00                	mov    (%eax),%eax
80107d06:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107d0a:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d0e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107d12:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d16:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d19:	89 04 24             	mov    %eax,(%esp)
80107d1c:	e8 eb fe ff ff       	call   80107c0c <mappages>
80107d21:	85 c0                	test   %eax,%eax
80107d23:	79 12                	jns    80107d37 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107d25:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d28:	89 04 24             	mov    %eax,(%esp)
80107d2b:	e8 26 05 00 00       	call   80108256 <freevm>
      return 0;
80107d30:	b8 00 00 00 00       	mov    $0x0,%eax
80107d35:	eb 10                	jmp    80107d47 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d37:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107d3b:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107d42:	72 a3                	jb     80107ce7 <setupkvm+0x43>
    }
  return pgdir;
...
80107d50:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107d53:	e8 4c ff ff ff       	call   80107ca4 <setupkvm>
80107d58:	a3 44 67 11 80       	mov    %eax,0x80116744
  switchkvm();
...
80107d6a:	a1 44 67 11 80       	mov    0x80116744,%eax
80107d6f:	05 00 00 00 80       	add    $0x80000000,%eax
80107d74:	89 04 24             	mov    %eax,(%esp)
80107d77:	e8 92 fa ff ff       	call   8010780e <lcr3>
}
80107d7c:	c9                   	leave  
80107d7d:	c3                   	ret    
...
80107d81:	57                   	push   %edi
80107d82:	56                   	push   %esi
80107d83:	53                   	push   %ebx
80107d84:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107d87:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107d8b:	75 0c                	jne    80107d99 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107d8d:	c7 04 24 a6 8b 10 80 	movl   $0x80108ba6,(%esp)
80107d94:	e8 c9 87 ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107d99:	8b 45 08             	mov    0x8(%ebp),%eax
80107d9c:	8b 40 08             	mov    0x8(%eax),%eax
80107d9f:	85 c0                	test   %eax,%eax
80107da1:	75 0c                	jne    80107daf <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107da3:	c7 04 24 bc 8b 10 80 	movl   $0x80108bbc,(%esp)
80107daa:	e8 b3 87 ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107daf:	8b 45 08             	mov    0x8(%ebp),%eax
80107db2:	8b 40 04             	mov    0x4(%eax),%eax
80107db5:	85 c0                	test   %eax,%eax
80107db7:	75 0c                	jne    80107dc5 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107db9:	c7 04 24 d1 8b 10 80 	movl   $0x80108bd1,(%esp)
80107dc0:	e8 9d 87 ff ff       	call   80100562 <panic>

  pushcli();
80107dc5:	e8 2e d4 ff ff       	call   801051f8 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107dca:	e8 40 c3 ff ff       	call   8010410f <mycpu>
80107dcf:	89 c3                	mov    %eax,%ebx
80107dd1:	e8 39 c3 ff ff       	call   8010410f <mycpu>
80107dd6:	83 c0 08             	add    $0x8,%eax
80107dd9:	89 c7                	mov    %eax,%edi
80107ddb:	e8 2f c3 ff ff       	call   8010410f <mycpu>
80107de0:	83 c0 08             	add    $0x8,%eax
80107de3:	c1 e8 10             	shr    $0x10,%eax
80107de6:	89 c6                	mov    %eax,%esi
80107de8:	e8 22 c3 ff ff       	call   8010410f <mycpu>
80107ded:	83 c0 08             	add    $0x8,%eax
80107df0:	c1 e8 18             	shr    $0x18,%eax
80107df3:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107dfa:	67 00 
80107dfc:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107e03:	89 f1                	mov    %esi,%ecx
80107e05:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107e0b:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107e12:	83 e2 f0             	and    $0xfffffff0,%edx
80107e15:	83 ca 09             	or     $0x9,%edx
80107e18:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107e1e:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107e25:	83 ca 10             	or     $0x10,%edx
...
80107e3e:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107e45:	83 ca 80             	or     $0xffffff80,%edx
80107e48:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
...
80107e75:	83 e2 df             	and    $0xffffffdf,%edx
...
80107e8e:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e95:	83 e2 7f             	and    $0x7f,%edx
80107e98:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e9e:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107ea4:	e8 66 c2 ff ff       	call   8010410f <mycpu>
80107ea9:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107eb0:	83 e2 ef             	and    $0xffffffef,%edx
80107eb3:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107eb9:	e8 51 c2 ff ff       	call   8010410f <mycpu>
80107ebe:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107ec4:	e8 46 c2 ff ff       	call   8010410f <mycpu>
80107ec9:	8b 55 08             	mov    0x8(%ebp),%edx
80107ecc:	8b 52 08             	mov    0x8(%edx),%edx
80107ecf:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107ed5:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107ed8:	e8 32 c2 ff ff       	call   8010410f <mycpu>
80107edd:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107ee3:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107eea:	e8 09 f9 ff ff       	call   801077f8 <ltr>
...
80107efd:	e8 0c f9 ff ff       	call   8010780e <lcr3>
  popcli();
80107f02:	e8 3d d3 ff ff       	call   80105244 <popcli>
}
80107f07:	83 c4 1c             	add    $0x1c,%esp
80107f0a:	5b                   	pop    %ebx
80107f0b:	5e                   	pop    %esi
80107f0c:	5f                   	pop    %edi
80107f0d:	5d                   	pop    %ebp
...
80107f12:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107f15:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107f1c:	76 0c                	jbe    80107f2a <inituvm+0x1b>
    panic("inituvm: more than a page");
80107f1e:	c7 04 24 e5 8b 10 80 	movl   $0x80108be5,(%esp)
80107f25:	e8 38 86 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107f2a:	e8 7a ac ff ff       	call   80102ba9 <kalloc>
80107f2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107f32:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f39:	00 
80107f3a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f41:	00 
80107f42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f45:	89 04 24             	mov    %eax,(%esp)
80107f48:	e8 b0 d3 ff ff       	call   801052fd <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f50:	05 00 00 00 80       	add    $0x80000000,%eax
80107f55:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f5c:	00 
80107f5d:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107f61:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f68:	00 
80107f69:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f70:	00 
80107f71:	8b 45 08             	mov    0x8(%ebp),%eax
80107f74:	89 04 24             	mov    %eax,(%esp)
80107f77:	e8 90 fc ff ff       	call   80107c0c <mappages>
  memmove(mem, init, sz);
80107f7c:	8b 45 10             	mov    0x10(%ebp),%eax
80107f7f:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107f90:	e8 37 d4 ff ff       	call   801053cc <memmove>
}
80107f95:	c9                   	leave  
80107f96:	c3                   	ret    
...
80107fa0:	25 ff 0f 00 00       	and    $0xfff,%eax
80107fa5:	85 c0                	test   %eax,%eax
80107fa7:	74 0c                	je     80107fb5 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107fa9:	c7 04 24 00 8c 10 80 	movl   $0x80108c00,(%esp)
80107fb0:	e8 ad 85 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107fb5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107fbc:	e9 a6 00 00 00       	jmp    80108067 <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107fc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc4:	8b 55 0c             	mov    0xc(%ebp),%edx
80107fc7:	01 d0                	add    %edx,%eax
80107fc9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107fd0:	00 
80107fd1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fd5:	8b 45 08             	mov    0x8(%ebp),%eax
80107fd8:	89 04 24             	mov    %eax,(%esp)
80107fdb:	e8 90 fb ff ff       	call   80107b70 <walkpgdir>
80107fe0:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107fe3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107fe7:	75 0c                	jne    80107ff5 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107fe9:	c7 04 24 23 8c 10 80 	movl   $0x80108c23,(%esp)
80107ff0:	e8 6d 85 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107ff5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107ff8:	8b 00                	mov    (%eax),%eax
80107ffa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fff:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108002:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108005:	8b 55 18             	mov    0x18(%ebp),%edx
80108008:	29 c2                	sub    %eax,%edx
8010800a:	89 d0                	mov    %edx,%eax
8010800c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108011:	77 0f                	ja     80108022 <loaduvm+0x8b>
      n = sz - i;
80108013:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108016:	8b 55 18             	mov    0x18(%ebp),%edx
80108019:	29 c2                	sub    %eax,%edx
8010801b:	89 d0                	mov    %edx,%eax
8010801d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108020:	eb 07                	jmp    80108029 <loaduvm+0x92>
    else
      n = PGSIZE;
80108022:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80108029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802c:	8b 55 14             	mov    0x14(%ebp),%edx
8010802f:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80108032:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108035:	05 00 00 00 80       	add    $0x80000000,%eax
8010803a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010803d:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108041:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80108045:	89 44 24 04          	mov    %eax,0x4(%esp)
80108049:	8b 45 10             	mov    0x10(%ebp),%eax
8010804c:	89 04 24             	mov    %eax,(%esp)
8010804f:	e8 a6 9d ff ff       	call   80101dfa <readi>
80108054:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108057:	74 07                	je     80108060 <loaduvm+0xc9>
      return -1;
80108059:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010805e:	eb 18                	jmp    80108078 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80108060:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108067:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806a:	3b 45 18             	cmp    0x18(%ebp),%eax
8010806d:	0f 82 4e ff ff ff    	jb     80107fc1 <loaduvm+0x2a>
  }
  return 0;
...
8010807d:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108085:	79 0a                	jns    80108091 <allocuvm+0x17>
    return 0;
80108087:	b8 00 00 00 00       	mov    $0x0,%eax
8010808c:	e9 fd 00 00 00       	jmp    8010818e <allocuvm+0x114>
  if(newsz < oldsz)
80108091:	8b 45 10             	mov    0x10(%ebp),%eax
80108094:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108097:	73 08                	jae    801080a1 <allocuvm+0x27>
    return oldsz;
80108099:	8b 45 0c             	mov    0xc(%ebp),%eax
8010809c:	e9 ed 00 00 00       	jmp    8010818e <allocuvm+0x114>
...
801080b1:	e9 c9 00 00 00       	jmp    8010817f <allocuvm+0x105>
    mem = kalloc();
801080b6:	e8 ee aa ff ff       	call   80102ba9 <kalloc>
801080bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801080be:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080c2:	75 2f                	jne    801080f3 <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
801080c4:	c7 04 24 41 8c 10 80 	movl   $0x80108c41,(%esp)
801080cb:	e8 f8 82 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801080d0:	8b 45 0c             	mov    0xc(%ebp),%eax
801080d3:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801080e4:	e8 a7 00 00 00       	call   80108190 <deallocuvm>
      return 0;
801080e9:	b8 00 00 00 00       	mov    $0x0,%eax
801080ee:	e9 9b 00 00 00       	jmp    8010818e <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
801080f3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080fa:	00 
801080fb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108102:	00 
80108103:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108106:	89 04 24             	mov    %eax,(%esp)
80108109:	e8 ef d1 ff ff       	call   801052fd <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
8010810e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108111:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80108117:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010811a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108121:	00 
80108122:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108126:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010812d:	00 
8010812e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108132:	8b 45 08             	mov    0x8(%ebp),%eax
80108135:	89 04 24             	mov    %eax,(%esp)
80108138:	e8 cf fa ff ff       	call   80107c0c <mappages>
8010813d:	85 c0                	test   %eax,%eax
8010813f:	79 37                	jns    80108178 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80108141:	c7 04 24 59 8c 10 80 	movl   $0x80108c59,(%esp)
80108148:	e8 7b 82 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010814d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108150:	89 44 24 08          	mov    %eax,0x8(%esp)
80108154:	8b 45 10             	mov    0x10(%ebp),%eax
80108157:	89 44 24 04          	mov    %eax,0x4(%esp)
8010815b:	8b 45 08             	mov    0x8(%ebp),%eax
8010815e:	89 04 24             	mov    %eax,(%esp)
80108161:	e8 2a 00 00 00       	call   80108190 <deallocuvm>
      kfree(mem);
80108166:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108169:	89 04 24             	mov    %eax,(%esp)
8010816c:	e8 a2 a9 ff ff       	call   80102b13 <kfree>
      return 0;
80108171:	b8 00 00 00 00       	mov    $0x0,%eax
80108176:	eb 16                	jmp    8010818e <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80108178:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010817f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108182:	3b 45 10             	cmp    0x10(%ebp),%eax
80108185:	0f 82 2b ff ff ff    	jb     801080b6 <allocuvm+0x3c>
    }
  }
  return newsz;
...
80108199:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010819c:	72 08                	jb     801081a6 <deallocuvm+0x16>
    return oldsz;
8010819e:	8b 45 0c             	mov    0xc(%ebp),%eax
801081a1:	e9 ae 00 00 00       	jmp    80108254 <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
801081a6:	8b 45 10             	mov    0x10(%ebp),%eax
801081a9:	05 ff 0f 00 00       	add    $0xfff,%eax
801081ae:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801081b6:	e9 8a 00 00 00       	jmp    80108245 <deallocuvm+0xb5>
...
801081d0:	e8 9b f9 ff ff       	call   80107b70 <walkpgdir>
801081d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801081d8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081dc:	75 16                	jne    801081f4 <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801081de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e1:	c1 e8 16             	shr    $0x16,%eax
801081e4:	83 c0 01             	add    $0x1,%eax
801081e7:	c1 e0 16             	shl    $0x16,%eax
801081ea:	2d 00 10 00 00       	sub    $0x1000,%eax
801081ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
801081f2:	eb 4a                	jmp    8010823e <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
801081f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081f7:	8b 00                	mov    (%eax),%eax
801081f9:	83 e0 01             	and    $0x1,%eax
801081fc:	85 c0                	test   %eax,%eax
801081fe:	74 3e                	je     8010823e <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
80108200:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108203:	8b 00                	mov    (%eax),%eax
80108205:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010820a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010820d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108211:	75 0c                	jne    8010821f <deallocuvm+0x8f>
        panic("kfree");
80108213:	c7 04 24 75 8c 10 80 	movl   $0x80108c75,(%esp)
8010821a:	e8 43 83 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
8010821f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108222:	05 00 00 00 80       	add    $0x80000000,%eax
80108227:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010822a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010822d:	89 04 24             	mov    %eax,(%esp)
80108230:	e8 de a8 ff ff       	call   80102b13 <kfree>
      *pte = 0;
80108235:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108238:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
8010823e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108248:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010824b:	0f 82 6a ff ff ff    	jb     801081bb <deallocuvm+0x2b>
    }
  }
  return newsz;
...
80108259:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
8010825c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108260:	75 0c                	jne    8010826e <freevm+0x18>
    panic("freevm: no pgdir");
80108262:	c7 04 24 7b 8c 10 80 	movl   $0x80108c7b,(%esp)
80108269:	e8 f4 82 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010826e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108275:	00 
80108276:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010827d:	80 
8010827e:	8b 45 08             	mov    0x8(%ebp),%eax
80108281:	89 04 24             	mov    %eax,(%esp)
80108284:	e8 07 ff ff ff       	call   80108190 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108289:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108290:	eb 45                	jmp    801082d7 <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
801082a8:	74 29                	je     801082d3 <freevm+0x7d>
      char * v = P2V(PTE_ADDR(pgdir[i]));
801082aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ad:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801082b4:	8b 45 08             	mov    0x8(%ebp),%eax
801082b7:	01 d0                	add    %edx,%eax
...
801082de:	76 b2                	jbe    80108292 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
801082e0:	8b 45 08             	mov    0x8(%ebp),%eax
801082e3:	89 04 24             	mov    %eax,(%esp)
801082e6:	e8 28 a8 ff ff       	call   80102b13 <kfree>
}
801082eb:	c9                   	leave  
801082ec:	c3                   	ret    
...
801082f0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801082f3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082fa:	00 
...
80108308:	e8 63 f8 ff ff       	call   80107b70 <walkpgdir>
8010830d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108310:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108314:	75 0c                	jne    80108322 <clearpteu+0x35>
    panic("clearpteu");
80108316:	c7 04 24 8c 8c 10 80 	movl   $0x80108c8c,(%esp)
8010831d:	e8 40 82 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
80108322:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108325:	8b 00                	mov    (%eax),%eax
80108327:	83 e0 fb             	and    $0xfffffffb,%eax
8010832a:	89 c2                	mov    %eax,%edx
8010832c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010832f:	89 10                	mov    %edx,(%eax)
}
80108331:	c9                   	leave  
80108332:	c3                   	ret    
...
80108336:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108339:	e8 66 f9 ff ff       	call   80107ca4 <setupkvm>
8010833e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108341:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108345:	75 0a                	jne    80108351 <copyuvm+0x1e>
    return 0;
80108347:	b8 00 00 00 00       	mov    $0x0,%eax
8010834c:	e9 03 01 00 00       	jmp    80108454 <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
80108351:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108358:	e9 d6 00 00 00       	jmp    80108433 <copyuvm+0x100>
...
80108372:	e8 f9 f7 ff ff       	call   80107b70 <walkpgdir>
80108377:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010837a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010837e:	75 0c                	jne    8010838c <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108380:	c7 04 24 96 8c 10 80 	movl   $0x80108c96,(%esp)
...
80108396:	75 0c                	jne    801083a4 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108398:	c7 04 24 b0 8c 10 80 	movl   $0x80108cb0,(%esp)
8010839f:	e8 be 81 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
...
801083bb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801083be:	e8 e6 a7 ff ff       	call   80102ba9 <kalloc>
801083c3:	89 45 e0             	mov    %eax,-0x20(%ebp)
801083c6:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801083ca:	75 02                	jne    801083ce <copyuvm+0x9b>
      goto bad;
801083cc:	eb 76                	jmp    80108444 <copyuvm+0x111>
    memmove(mem, (char*)P2V(pa), PGSIZE);
801083ce:	8b 45 e8             	mov    -0x18(%ebp),%eax
...
801083e2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083e5:	89 04 24             	mov    %eax,(%esp)
801083e8:	e8 df cf ff ff       	call   801053cc <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801083ed:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801083f0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083f3:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801083f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fc:	89 54 24 10          	mov    %edx,0x10(%esp)
80108400:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80108404:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010840b:	00 
8010840c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108410:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108413:	89 04 24             	mov    %eax,(%esp)
80108416:	e8 f1 f7 ff ff       	call   80107c0c <mappages>
8010841b:	85 c0                	test   %eax,%eax
8010841d:	79 0d                	jns    8010842c <copyuvm+0xf9>
      kfree(mem);
8010841f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108422:	89 04 24             	mov    %eax,(%esp)
80108425:	e8 e9 a6 ff ff       	call   80102b13 <kfree>
      goto bad;
8010842a:	eb 18                	jmp    80108444 <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
8010842c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108433:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108436:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108439:	0f 82 1e ff ff ff    	jb     8010835d <copyuvm+0x2a>
    }
  }
  return d;
8010843f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108442:	eb 10                	jmp    80108454 <copyuvm+0x121>

bad:
  freevm(d);
80108444:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108447:	89 04 24             	mov    %eax,(%esp)
8010844a:	e8 07 fe ff ff       	call   80108256 <freevm>
  return 0;
8010844f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108454:	c9                   	leave  
80108455:	c3                   	ret    
...
80108459:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
8010845c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108463:	00 
80108464:	8b 45 0c             	mov    0xc(%ebp),%eax
80108467:	89 44 24 04          	mov    %eax,0x4(%esp)
8010846b:	8b 45 08             	mov    0x8(%ebp),%eax
8010846e:	89 04 24             	mov    %eax,(%esp)
80108471:	e8 fa f6 ff ff       	call   80107b70 <walkpgdir>
80108476:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108479:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010847c:	8b 00                	mov    (%eax),%eax
8010847e:	83 e0 01             	and    $0x1,%eax
80108481:	85 c0                	test   %eax,%eax
80108483:	75 07                	jne    8010848c <uva2ka+0x36>
    return 0;
80108485:	b8 00 00 00 00       	mov    $0x0,%eax
8010848a:	eb 22                	jmp    801084ae <uva2ka+0x58>
  if((*pte & PTE_U) == 0)
8010848c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010848f:	8b 00                	mov    (%eax),%eax
80108491:	83 e0 04             	and    $0x4,%eax
80108494:	85 c0                	test   %eax,%eax
80108496:	75 07                	jne    8010849f <uva2ka+0x49>
    return 0;
80108498:	b8 00 00 00 00       	mov    $0x0,%eax
8010849d:	eb 0f                	jmp    801084ae <uva2ka+0x58>
  return (char*)P2V(PTE_ADDR(*pte));
8010849f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084a2:	8b 00                	mov    (%eax),%eax
801084a4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801084a9:	05 00 00 00 80       	add    $0x80000000,%eax
}
801084ae:	c9                   	leave  
801084af:	c3                   	ret    
...
801084b3:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
801084b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801084bc:	e9 87 00 00 00       	jmp    80108548 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
801084c1:	8b 45 0c             	mov    0xc(%ebp),%eax
801084c4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801084c9:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801084d9:	e8 78 ff ff ff       	call   80108456 <uva2ka>
801084de:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801084e1:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801084e5:	75 07                	jne    801084ee <copyout+0x3e>
      return -1;
801084e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084ec:	eb 69                	jmp    80108557 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801084ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801084f1:	8b 55 ec             	mov    -0x14(%ebp),%edx
801084f4:	29 c2                	sub    %eax,%edx
801084f6:	89 d0                	mov    %edx,%eax
801084f8:	05 00 10 00 00       	add    $0x1000,%eax
801084fd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108500:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108503:	3b 45 14             	cmp    0x14(%ebp),%eax
80108506:	76 06                	jbe    8010850e <copyout+0x5e>
      n = len;
80108508:	8b 45 14             	mov    0x14(%ebp),%eax
8010850b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010850e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108511:	8b 55 0c             	mov    0xc(%ebp),%edx
80108514:	29 c2                	sub    %eax,%edx
80108516:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108519:	01 c2                	add    %eax,%edx
8010851b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010851e:	89 44 24 08          	mov    %eax,0x8(%esp)
80108522:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108525:	89 44 24 04          	mov    %eax,0x4(%esp)
80108529:	89 14 24             	mov    %edx,(%esp)
8010852c:	e8 9b ce ff ff       	call   801053cc <memmove>
    len -= n;
80108531:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108534:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108537:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010853a:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010853d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108540:	05 00 10 00 00       	add    $0x1000,%eax
80108545:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108548:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010854c:	0f 85 6f ff ff ff    	jne    801084c1 <copyout+0x11>
  }
  return 0;
80108552:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108557:	c9                   	leave  
80108558:	c3                   	ret    
