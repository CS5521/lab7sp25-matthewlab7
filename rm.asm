...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 e2 09 00 	movl   $0x9e2,0x4(%esp)
  6d:	00 
...
ps()
{
 ...
 380:	c7 44 24 04 fb 09 00 	movl   $0x9fb,0x4(%esp)
 387:	00 
 ...
 3d2:	c7 44 24 04 14 0a 00 	movl   $0xa14,0x4(%esp)
 3d9:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 59b:	0f b6 80 a0 0c 00 00 	movzbl 0xca0(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6f8:	75 09                	jne    703 <printf+0x101>
          s = "(null)";
 6fa:	c7 45 f4 24 0a 00 00 	movl   $0xa24,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c4:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 ...
 88f:	a3 bc 0c 00 00       	mov    %eax,0xcbc
}
 894:	c9                   	leave  
 895:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8e2:	e8 ce fe ff ff       	call   7b5 <free>
  return freep;
 8e7:	a1 bc 0c 00 00       	mov    0xcbc,%eax
}
 8ec:	c9                   	leave  
 8ed:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 900:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 903:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 908:	89 45 f0             	mov    %eax,-0x10(%ebp)
 90b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 90f:	75 23                	jne    934 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 911:	c7 45 f0 b4 0c 00 00 	movl   $0xcb4,-0x10(%ebp)
 918:	8b 45 f0             	mov    -0x10(%ebp),%eax
 91b:	a3 bc 0c 00 00       	mov    %eax,0xcbc
 920:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 925:	a3 b4 0c 00 00       	mov    %eax,0xcb4
    base.s.size = 0;
 92a:	c7 05 b8 0c 00 00 00 	movl   $0x0,0xcb8
 931:	00 00 00 
  }
 ...
 987:	a3 bc 0c 00 00       	mov    %eax,0xcbc
      return (void*)(p + 1);
 ...
 992:	eb 38                	jmp    9cc <malloc+0xde>
    ...
    if(p == freep)
 994:	a1 bc 0c 00 00       	mov    0xcbc,%eax
