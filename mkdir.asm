...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 dd 09 00 	movl   $0x9dd,0x4(%esp)
  6d:	00 
...
ps()
{
 ...
 380:	c7 44 24 04 f9 09 00 	movl   $0x9f9,0x4(%esp)
 387:	00 
 ...
 3d2:	c7 44 24 04 12 0a 00 	movl   $0xa12,0x4(%esp)
 3d9:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 593:	0f b6 80 a0 0c 00 00 	movzbl 0xca0(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6f0:	75 09                	jne    6fb <printf+0x101>
          s = "(null)";
 6f2:	c7 45 f4 22 0a 00 00 	movl   $0xa22,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7bc:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 ...
 887:	a3 bc 0c 00 00       	mov    %eax,0xcbc
}
 88c:	c9                   	leave  
 88d:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8da:	e8 ce fe ff ff       	call   7ad <free>
  return freep;
 8df:	a1 bc 0c 00 00       	mov    0xcbc,%eax
}
 8e4:	c9                   	leave  
 8e5:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8f8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8fb:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 900:	89 45 f0             	mov    %eax,-0x10(%ebp)
 903:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 907:	75 23                	jne    92c <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 909:	c7 45 f0 b4 0c 00 00 	movl   $0xcb4,-0x10(%ebp)
 910:	8b 45 f0             	mov    -0x10(%ebp),%eax
 913:	a3 bc 0c 00 00       	mov    %eax,0xcbc
 918:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 91d:	a3 b4 0c 00 00       	mov    %eax,0xcb4
    base.s.size = 0;
 922:	c7 05 b8 0c 00 00 00 	movl   $0x0,0xcb8
 929:	00 00 00 
  }
 ...
 97f:	a3 bc 0c 00 00       	mov    %eax,0xcbc
      return (void*)(p + 1);
 ...
 98a:	eb 38                	jmp    9c4 <malloc+0xde>
    ...
    if(p == freep)
 98c:	a1 bc 0c 00 00       	mov    0xcbc,%eax
